...
- **Real interactive controls** — toggles, sliders, dropdowns, selectors, inputs,
...
in Mosaic's styling surface — please file an issue. Nobody should need `card_mod`.
