function c({pct:l,color:e,width:o,height:t}){const y=104*l/100,d=112-y;return`<svg viewBox="0 0 60 120" width="${o}" height="${t}"
    ...
    <!-- Liquid fill -->
    <rect x="3" y="${d}" width="54" height="${y}" style="fill:${e}" clip-path="url(#cyl-clip)"/>
  ...
  </svg>`}function b({pct:l,color:e,width:o,height:t}){const r=t-8,i=r*l/100,s=4+r-i;return`<svg viewBox="0 0 ${o} ${t}" width="${o}" height="${t}"
      xmlns="http://www.w3.org/2000/svg" style="display:block">
    <rect x="2" y="2" width="${o-4}" height="${t-4}"
      rx="4" fill="rgba(0,0,0,0.25)" stroke="rgba(255,255,255,0.2)" stroke-width="1.5"/>
    <rect x="4" y="${s}" width="${o-8}" height="${i}"
      rx="3" style="fill:${e}"/>
  </svg>`}function n({pct:l,color:e,width:o,height:t}){const i=(o-8)*l/100;return`<svg viewBox="0 0 ${o} ${t}" width="${o}" height="${t}"
      xmlns="http://www.w3.org/2000/svg" style="display:block">
    <rect x="2" y="2" width="${o-4}" height="${t-4}"
      rx="4" fill="rgba(0,0,0,0.25)" stroke="rgba(255,255,255,0.2)" stroke-width="1.5"/>
    <rect x="4" y="4" width="${i}" height="${t-8}"
      rx="3" style="fill:${e}"/>
