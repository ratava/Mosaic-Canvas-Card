import{C as Je,a as Ct,b as Et,s as Bt,i as q,M as Tt,c as Gt,d as r,A as _,e as Me,f as K,r as ue,g as $e,h as v,T as zt,j as lt,B as Ht,u as Wt,w as Ut,k as ct,v as ke,l as Ae,m as Vt,n as Yt,o as jt,p as Kt,q as Se,t as qt,H as Zt,x as dt,y as Ue,P as ae,z as Xt,D as Ve,E as Jt,F as Qt,G as ei,I as ti,J as w,K as ii,L as oi}from"./mosaic-canvas-card.js";const fe=(e,t=0,i=1)=>e>i?i:e<t?t:e,U=(e,t=0,i=Math.pow(10,t))=>Math.round(i*e)/i,si=e=>ci(Ye(e)),Ye=e=>(e[0]==="#"&&(e=e.substring(1)),e.length<6?{r:parseInt(e[0]+e[0],16),g:parseInt(e[1]+e[1],16),b:parseInt(e[2]+e[2],16),a:e.length===4?U(parseInt(e[3]+e[3],16)/255,2):1}:{r:parseInt(e.substring(0,2),16),g:parseInt(e.substring(2,4),16),b:parseInt(e.substring(4,6),16),a:e.length===8?U(parseInt(e.substring(6,8),16)/255,2):1}),ai=e=>li(ri(e)),ni=({h:e,s:t,v:i,a:o})=>{const s=(200-t)*i/100;return{h:U(e),s:U(s>0&&s<200?t*i/100/(s<=100?s:200-s)*100:0),l:U(s/2),a:U(o,2)}},je=e=>{const{h:t,s:i,l:o}=ni(e);return`hsl(${t}, ${i}%, ${o}%)`},ri=({h:e,s:t,v:i,a:o})=>{e=e/360*6,t=t/100,i=i/100;const s=Math.floor(e),a=i*(1-t),n=i*(1-(e-s)*t),l=i*(1-(1-e+s)*t),c=s%6;return{r:U([i,n,a,a,l,i][c]*255),g:U([l,i,i,n,a,a][c]*255),b:U([a,a,l,i,i,n][c]*255),a:U(o,2)}},Ce=e=>{const t=e.toString(16);return t.length<2?"0"+t:t},li=({r:e,g:t,b:i,a:o})=>{const s=o<1?Ce(U(o*255)):"";return"#"+Ce(e)+Ce(t)+Ce(i)+s},ci=({r:e,g:t,b:i,a:o})=>{const s=Math.max(e,t,i),a=s-Math.min(e,t,i),n=a?s===e?(t-i)/a:s===t?2+(i-e)/a:4+(e-t)/a:0;return{h:U(60*(n<0?n+6:n)),s:U(s?a/s*100:0),v:U(s/255*100),a:o}},Pt=(e,t)=>{if(e===t)return!0;for(const i in e)if(e[i]!==t[i])return!1;return!0},di=(e,t)=>e.toLowerCase()===t.toLowerCase()?!0:Pt(Ye(e),Ye(t)),ht={},Rt=e=>{let t=ht[e];return t||(t=document.createElement("template"),t.innerHTML=e,ht[e]=t),t},Qe=(e,t,i)=>{e.dispatchEvent(new CustomEvent(t,{bubbles:!0,detail:i}))};let ge=!1;const Ke=e=>"touches"in e,hi=e=>ge&&!Ke(e)?!1:(ge||(ge=Ke(e)),!0),pt=(e,t)=>{const i=Ke(t)?t.touches[0]:t,o=e.el.getBoundingClientRect();Qe(e.el,"move",e.getMove({x:fe((i.pageX-(o.left+window.pageXOffset))/o.width),y:fe((i.pageY-(o.top+window.pageYOffset))/o.height)}))},pi=(e,t)=>{const i=t.keyCode;i>40||e.xy&&i<37||i<33||(t.preventDefault(),Qe(e.el,"move",e.getMove({x:i===39?.01:i===37?-.01:i===34?.05:i===33?-.05:i===35?1:i===36?-1:0,y:i===40?.01:i===38?-.01:0},!0)))};class Ft{constructor(t,i,o,s){const a=Rt(`<div role="slider" tabindex="0" part="${i}" ${o}><div part="${i}-pointer"></div></div>`);t.appendChild(a.content.cloneNode(!0));const n=t.querySelector(`[part=${i}]`);n.addEventListener("mousedown",this),n.addEventListener("touchstart",this),n.addEventListener("keydown",this),this.el=n,this.xy=s,this.nodes=[n.firstChild,n]}set dragging(t){const i=t?document.addEventListener:document.removeEventListener;i(ge?"touchmove":"mousemove",this),i(ge?"touchend":"mouseup",this)}handleEvent(t){switch(t.type){case"mousedown":case"touchstart":if(t.preventDefault(),!hi(t)||!ge&&t.button!=0)return;this.el.focus(),pt(this,t),this.dragging=!0;break;case"mousemove":case"touchmove":t.preventDefault(),pt(this,t);break;case"mouseup":case"touchend":this.dragging=!1;break;case"keydown":pi(this,t);break}}style(t){t.forEach((i,o)=>{for(const s in i)this.nodes[o].style.setProperty(s,i[s])})}}class ui extends Ft{constructor(t){super(t,"hue",'aria-label="Hue" aria-valuemin="0" aria-valuemax="360"',!1)}update({h:t}){this.h=t,this.style([{left:`${t/360*100}%`,color:je({h:t,s:100,v:100,a:1})}]),this.el.setAttribute("aria-valuenow",`${U(t)}`)}getMove(t,i){return{h:i?fe(this.h+t.x*360,0,360):360*t.x}}}class _i extends Ft{constructor(t){super(t,"saturation",'aria-label="Color"',!0)}update(t){this.hsva=t,this.style([{top:`${100-t.v}%`,left:`${t.s}%`,color:je(t)},{"background-color":je({h:t.h,s:100,v:100,a:1})}]),this.el.setAttribute("aria-valuetext",`Saturation ${U(t.s)}%, Brightness ${U(t.v)}%`)}getMove(t,i){return{s:i?fe(this.hsva.s+t.x*100,0,100):t.x*100,v:i?fe(this.hsva.v-t.y*100,0,100):Math.round(100-t.y*100)}}}const gi=':host{display:flex;flex-direction:column;position:relative;width:200px;height:200px;user-select:none;-webkit-user-select:none;cursor:default}:host([hidden]){display:none!important}[role=slider]{position:relative;touch-action:none;user-select:none;-webkit-user-select:none;outline:0}[role=slider]:last-child{border-radius:0 0 8px 8px}[part$=pointer]{position:absolute;z-index:1;box-sizing:border-box;width:28px;height:28px;display:flex;place-content:center center;transform:translate(-50%,-50%);background-color:#fff;border:2px solid #fff;border-radius:50%;box-shadow:0 2px 4px rgba(0,0,0,.2)}[part$=pointer]::after{content:"";width:100%;height:100%;border-radius:inherit;background-color:currentColor}[role=slider]:focus [part$=pointer]{transform:translate(-50%,-50%) scale(1.1)}',mi="[part=hue]{flex:0 0 24px;background:linear-gradient(to right,red 0,#ff0 17%,#0f0 33%,#0ff 50%,#00f 67%,#f0f 83%,red 100%)}[part=hue-pointer]{top:50%;z-index:2}",bi="[part=saturation]{flex-grow:1;border-color:transparent;border-bottom:12px solid #000;border-radius:8px 8px 0 0;background-image:linear-gradient(to top,#000,transparent),linear-gradient(to right,#fff,rgba(255,255,255,0));box-shadow:inset 0 0 0 1px rgba(0,0,0,.05)}[part=saturation-pointer]{z-index:3}",Ee=Symbol("same"),Oe=Symbol("color"),ut=Symbol("hsva"),Ne=Symbol("update"),_t=Symbol("parts"),gt=Symbol("css"),mt=Symbol("sliders");class vi extends HTMLElement{static get observedAttributes(){return["color"]}get[gt](){return[gi,mi,bi]}get[mt](){return[_i,ui]}get color(){return this[Oe]}set color(t){if(!this[Ee](t)){const i=this.colorModel.toHsva(t);this[Ne](i),this[Oe]=t}}constructor(){super();const t=Rt(`<style>${this[gt].join("")}</style>`),i=this.attachShadow({mode:"open"});i.appendChild(t.content.cloneNode(!0)),i.addEventListener("move",this),this[_t]=this[mt].map(o=>new o(i))}connectedCallback(){if(this.hasOwnProperty("color")){const t=this.color;delete this.color,this.color=t}else this.color||(this.color=this.colorModel.defaultColor)}attributeChangedCallback(t,i,o){const s=this.colorModel.fromAttr(o);this[Ee](s)||(this.color=s)}handleEvent(t){const i=this[ut],o={...i,...t.detail};this[Ne](o);let s;!Pt(o,i)&&!this[Ee](s=this.colorModel.fromHsva(o))&&(this[Oe]=s,Qe(this,"color-changed",{value:s}))}[Ee](t){return this.color&&this.colorModel.equal(t,this.color)}[Ne](t){this[ut]=t,this[_t].forEach(i=>i.update(t))}}const fi={defaultColor:"#000",toHsva:si,fromHsva:({h:e,s:t,v:i})=>ai({h:e,s:t,v:i,a:1}),equal:di,fromAttr:e=>e};class yi extends vi{get colorModel(){return fi}}class wi extends yi{}customElements.define("hex-color-picker",wi);const qe=1,xi=/^(entity|entity_id|entities|device_id|area_id)$|_entity$/,Te=e=>typeof e=="string"&&e.startsWith("virtual:");function Ze(e){if(Array.isArray(e))return e.map(i=>Ze(i));if(typeof e!="object"||e===null)return e;const t={};for(const[i,o]of Object.entries(e))xi.test(i)?Te(o)?t[i]=o:Array.isArray(o)&&o.some(Te)&&(t[i]=o.filter(Te)):i==="inputs"&&Array.isArray(o)&&o.every(s=>typeof s=="string")?t[i]=o.filter(Te):t[i]=Ze(o);return t}function $i(e,t,i={}){const{type:o,...s}=e;return{ec_template:!0,version:qe,card_version:Je,name:t.trim()||"Mosaic Canvas Template",exported:new Date().toISOString(),config:i.includeEntities===!1?Ze(s):s}}function ki(e){const t=JSON.stringify(e,null,2),i=new Blob([t],{type:"application/json"}),o=URL.createObjectURL(i),s=document.createElement("a");s.href=o,s.download=`${e.name.replace(/[^a-z0-9]+/gi,"_").toLowerCase()}.json`,document.body.appendChild(s),s.click(),document.body.removeChild(s),URL.revokeObjectURL(o)}function Si(e){let t;try{t=JSON.parse(e)}catch{return{template:null,error:"Invalid JSON — could not parse file."}}if(typeof t!="object"||t===null||!t.ec_template)return{template:null,error:"Not a valid Mosaic Canvas template file."};const i=t;return typeof i.version!="number"?{template:null,error:"Template is missing a version number."}:i.version>qe?{template:null,error:`Template schema v${i.version} is newer than this card supports (v${qe}). Update the card first.`}:{template:i,error:null}}function Ci(e,t){return{type:t,...e.config}}const Dt=1;function Ei(e,t){return{mosaic_control_variants:!0,version:Dt,card_version:Je,name:t.trim()||"Mosaic Control Variants",exported:new Date().toISOString(),variants:e}}function Ti(e){const t=new Blob([JSON.stringify(e,null,2)],{type:"application/json"}),i=URL.createObjectURL(t),o=document.createElement("a");o.href=i,o.download=`${e.name.replace(/[^a-z0-9]+/gi,"_").toLowerCase()}.json`,document.body.appendChild(o),o.click(),document.body.removeChild(o),URL.revokeObjectURL(i)}function zi(e){let t;try{t=JSON.parse(e)}catch{return{pack:null,error:"File is not valid JSON."}}if(typeof t!="object"||t===null)return{pack:null,error:"File is not a control variant pack."};const i=t;return i.mosaic_control_variants!==!0?{pack:null,error:"File is not a control variant pack. (Card layouts use Import Template instead.)"}:typeof i.version!="number"||i.version>Dt?{pack:null,error:`Pack was made by a newer Mosaic version (schema ${String(i.version)}). Update the card first.`}:typeof i.variants!="object"||i.variants===null?{pack:null,error:"Pack contains no variants."}:{pack:{mosaic_control_variants:!0,version:i.version,card_version:i.card_version??"unknown",name:i.name?.trim()||"Imported variants",exported:i.exported??"",variants:i.variants},error:null}}function Pi(e){if(typeof e!="object"||e===null)return!1;const t=e;return typeof t.id=="string"&&t.id.length>0&&typeof t.label=="string"&&t.label.length>0}function Ri(e,t){const i={...e};let o=0,s=0;for(const a of Ct){const n=(t.variants[a]??[]).filter(Pi);if(!n.length)continue;const l=[...i[a]??[]],c=new Set([...Et(a).map(d=>d.id),...l.map(d=>d.id)]);for(const d of n){let h=d.id;if(c.has(h)){const u=Bt(d.id);let g=2;for(;c.has(`${u}_${g}`);)g++;h=`${u}_${g}`,s++}c.add(h),l.push({...d,id:h}),o++}i[a]=l}return{merged:i,added:o,renamed:s}}const It=[{id:"popover-ref",label:"Dangling popover actions",hint:"Open Popover pointing at a card that no longer exists",icon:"mdi:picture-in-picture-bottom-right"},{id:"flow-endpoint",label:"Broken flow endpoints",hint:"Flow point anchored to a removed card",icon:"mdi:chart-timeline-variant"},{id:"no-write-target",label:"Nowhere to write",hint:"A value is set, but there is no entity to write it to",icon:"mdi:pencil-off-outline"},{id:"entity",label:"Missing entities",hint:"Entity not present in Home Assistant",icon:"mdi:database-off-outline"},{id:"virtual-ref",label:"Dangling virtual entities",hint:"A virtual: reference with no matching virtual entity",icon:"mdi:memory"},{id:"unreachable-key",label:"Not editable here",hint:"Set in YAML — this editor offers no screen for it",icon:"mdi:code-braces"},{id:"unpickable-value",label:"Value not offered",hint:"Legal in YAML but absent from this editor's picker",icon:"mdi:format-list-bulleted-type"}],Fi=It.reduce((e,t)=>(e[t.id]=t.icon,e),{}),Di=["entity","attribute"],Le={card:["id","fields","position","group"],extCard:["id","fields"],field:["id","type","variant","svg","shape","display_name","column","column_end","time_until_layout",...Di],zone:["id"],flow:["id","points"],emb:["id","group"],virtual:["id","inputs"]},Ii=["tap_action","hold_action","double_tap_action"],Mi={tap_action:"Tap action",hold_action:"Hold action",double_tap_action:"Double-tap action"},Ai=Tt;function Oi(e,t){return e!=="field"?Le[e]:q(t.type)?[...Le.field,...Ai]:Le.field}const bt="virtual:";function he(e){return t=>{const i=e.get(t);return i?{key:t,label:i}:{key:t}}}function Ni(e,t,i){const o=[],s=[],a=["Global Defaults and the config root are not scanned for keys this editor cannot reach — their override badges cover that ground instead."],n=[...new Set(Object.values(i.offered).flatMap(m=>Object.keys(m??{})))].sort();if(n.length&&a.push(`Picker values are verified for ${n.join(", ")}. Other dropdowns build their option list inline and are not checked.`),!e)return{issues:o,skipped:s,coverage:a};const l=e.cards??[],c=e.extended_cards??[],d=e.embedded_cards??[],h=e.zones??[],u=e.flows??[],g=e.virtuals??[],b=new Set(l.map(m=>m.id)),f=new Set(c.map(m=>m.id)),P=new Set(g.map(m=>m.id)),T=new Set(e.health_ignore??[]),k=t?.states;k||s.push({check:"entity",reason:"Home Assistant state is not available to the editor yet, so entity references were not verified."});const x=m=>{const E=`${m.check}|${m.ref}|${m.slot}`;o.push({id:E,check:m.check,severity:m.severity,where:m.where,detail:m.detail,icon:Fi[m.check],ignored:T.has(E),...m.target?{target:m.target}:{},...m.removal?{removal:m.removal}:{}})},S=(m,E)=>{if(m){if(m.startsWith(bt)){const I=m.slice(bt.length);P.has(I)||x({check:"virtual-ref",severity:"error",ref:E.ref,slot:E.slot,where:E.where,detail:`${E.label} points at virtual entity “${I}”, which is not in the Virtual Entities list.`,target:E.target});return}k&&(k[m]||x({check:"entity",severity:"error",ref:E.ref,slot:E.slot,where:E.where,detail:`${E.label} is set to “${m}”, which does not exist in Home Assistant.`,target:E.target}))}},$=(m,E)=>{for(const I of Ii){const R=m[I];if(!R)continue;const D=Mi[I],L=`${E.slotPfx??""}${I}`;R.action==="open-extended"&&(R.extended_card_id?f.has(R.extended_card_id)||x({check:"popover-ref",severity:"error",ref:E.ref,slot:L,where:E.where,detail:`${D} opens popover card “${R.extended_card_id}”, which is not in the Popover Cards list.`,target:E.target}):x({check:"popover-ref",severity:"error",ref:E.ref,slot:L,where:E.where,detail:`${D} opens a popover card but names none.`,target:E.target}));const O=[];R.entity&&O.push(R.entity);const M=R.target?.entity_id;typeof M=="string"?O.push(M):Array.isArray(M)&&O.push(...M.filter(W=>typeof W=="string")),O.forEach((W,ce)=>S(W,{ref:E.ref,slot:`${L}.entity.${ce}`,label:`${D} entity`,where:E.where,target:E.target}))}},C=m=>{const E=Oi(m.kind,m.item),I=i.offered[m.kind],R=he(m.screens.labels);for(const[D,L]of Object.entries(m.item)){if(L===void 0)continue;const O=m.screens.slots.get(D);if(O===void 0){if(E.includes(D))continue;x({check:"unreachable-key",severity:"info",ref:m.ref,slot:D,where:m.where,detail:`“${D}” is set in the YAML but no screen in this editor can show or change it.`,target:m.base,removal:m.removal(D)});continue}const M=I?.[D];M&&typeof L=="string"&&L!==""&&!M.includes(L)&&x({check:"unpickable-value",severity:"info",ref:m.ref,slot:D,where:m.where,detail:`“${D}” is “${L}”, which this editor's picker does not offer — it can only be changed in YAML.`,target:{...m.base,path:[...m.base.path,R(O)]},removal:m.removal(D)})}},N=(m,E,I,R,D,L)=>{const O=m==="popover",M=O?"egs":"gs",W=O?"eopt":"opt",ce=O?"xfield":"field";L.forEach(A=>{const de=i.fieldName(A),Q=`${E} › ${D} › ${de}`,Z=`${ce}:${R}/${A.id}`,ot={key:`field:${A.id}`,label:de},st=i.screens("field",A),oe=he(st.labels),se=(...B)=>({tab:"cards",panel:m,path:[I,ot,...B]}),at=q(A.type),Lt=oe(at?"fsec:control":"fsec:source");S(A.entity,{ref:Z,slot:"entity",label:"Entity",where:Q,target:se(Lt)});for(const[B,V]of[["charging_entity","Charging entity"],["tank_pct_entity","Tank % entity"],["tank_volume_entity","Tank volume entity"],["tank_capacity_entity","Tank capacity entity"]])S(A[B],{ref:Z,slot:B,label:V,where:Q,target:se(oe("fsec:source"))});(A.graph_series??[]).forEach((B,V)=>{const X=B.label||B.entity||`Series ${V+1}`;S(B.entity,{ref:Z,slot:`graph_series.${V}.entity`,label:"Series entity",where:`${Q} › ${X}`,target:se(oe("fsec:series"),{key:`${M}:${V}`,label:X})})}),(A.options??[]).forEach((B,V)=>{const X=B.label||B.value||`Option ${V+1}`,nt=`${Q} › ${X}`,rt=se(oe("fsec:options"),{key:`${W}:${V}`,label:X});S(B.entity,{ref:Z,slot:`options.${V}.entity`,label:"Option entity",where:nt,target:rt}),$(B,{ref:Z,where:nt,target:rt,slotPfx:`options.${V}.`})});for(const B of["left","center","right"])S(A.slider_labels?.[B]?.entity,{ref:Z,slot:`slider_labels.${B}.entity`,label:`${B} track label entity`,where:Q,target:se(oe("fsec:sliderpoints"))});if($(A,{ref:Z,where:Q,target:se(oe(at?"fsec:control":"fsec:actions"))}),!A.entity){const B=(A.options??[]).filter(V=>(V.value??"")!==""&&(A.type==="dropdown"||!V.entity));if((A.type==="button_group"||A.type==="dropdown")&&B.length){const V=B.length,X=V===1;x({check:"no-write-target",severity:"error",ref:Z,slot:"entity",where:Q,detail:`${V} option${X?"":"s"} write${X?"s":""} a value to this field's entity, but the field has none — ${X?"it renders":"they render"} disabled and can do nothing. ${A.type==="dropdown"?"Set an entity on the field — a dropdown always writes to it and ignores an entity set on the option.":`Give ${X?"the option its own entity":"each option its own entity"}, or set one on the field.`}`,target:se(oe("fsec:options"))})}A.type==="button"&&(A.button_value??"")!==""&&x({check:"no-write-target",severity:"error",ref:Z,slot:"button_value",where:Q,detail:`Press writes “${A.button_value}” to this field's entity, but the field has none — the button renders disabled.`,target:se(oe("fsec:options"))})}C({kind:"field",item:A,screens:st,ref:Z,where:Q,base:{tab:"cards",panel:m,path:[I,ot]},removal:B=>({kind:"field",extended:O,cardId:R,itemId:A.id,key:B})})})},Y=i.screens("card"),j=he(Y.labels);l.forEach((m,E)=>{const I=m.name??`Card ${E+1}`,R=`Mosaic Cards › ${I}`,D=`card:${m.id}`,L={key:`card:${m.id}`,label:I},O=M=>({tab:"cards",panel:"mosaic",path:M?[L,j(M)]:[L]});S(m.visible_when?.entity,{ref:D,slot:"visible_when.entity",label:"Visibility condition entity",where:R,target:O("sec:visibility")}),$(m,{ref:D,where:R,target:O("sec:actions")}),C({kind:"card",item:m,screens:Y,ref:D,where:R,base:O(),removal:M=>({kind:"card",itemId:m.id,key:M})}),N("mosaic","Mosaic Cards",L,m.id,I,m.fields??[])});const De=i.screens("extCard");c.forEach((m,E)=>{const I=m.name??`Popover Card ${E+1}`,R={key:`card:${m.id}`,label:I};C({kind:"extCard",item:m,screens:De,ref:`xcard:${m.id}`,where:`Popover Cards › ${I}`,base:{tab:"cards",panel:"popover",path:[R]},removal:D=>({kind:"extCard",itemId:m.id,key:D})}),N("popover","Popover Cards",R,m.id,I,m.fields??[])});const Ie=i.screens("emb");d.forEach((m,E)=>{const I=m.name??m.id??`Embedded ${E+1}`;C({kind:"emb",item:m,screens:Ie,ref:`emb:${m.id}`,where:`Embedded External Cards › ${I}`,base:{tab:"cards",panel:"embedded",path:[{key:`emb:${m.id}`,label:I}]},removal:R=>({kind:"emb",itemId:m.id,key:R})})});const me=i.screens("zone"),we=he(me.labels);h.forEach((m,E)=>{const I=m.name??m.id??`Zone ${E+1}`,R=`Clickable Zones › ${I}`,D=`zone:${m.id}`,L={key:`zone:${m.id}`,label:I},O=M=>({tab:"elements",panel:"zones",path:M?[L,we(M)]:[L]});$(m,{ref:D,where:R,target:O("sec:actions")}),C({kind:"zone",item:m,screens:me,ref:D,where:R,base:O(),removal:M=>({kind:"zone",itemId:m.id,key:M})})});const xe=i.screens("flow"),Nt=he(xe.labels);u.forEach((m,E)=>{const I=m.name??m.id??`Flow ${E+1}`,R=`Animated Flow Lines › ${I}`,D=`flow:${m.id}`,L={key:`flow:${m.id}`,label:I},O=(...M)=>({tab:"elements",panel:"flows",path:[L,...M]});S(m.entity,{ref:D,slot:"entity",label:"Entity",where:R,target:O(Nt("sec:defaults"))}),(m.points??[]).forEach((M,W)=>{M.card&&!b.has(M.card)&&x({check:"flow-endpoint",severity:"error",ref:D,slot:`points.${W}`,where:R,detail:`Point ${W+1} is anchored to card “${M.card}”, which no longer exists — the point falls back to the canvas origin.`,target:O({key:`pt:${W}`,label:`Point ${W+1}`})})}),C({kind:"flow",item:m,screens:xe,ref:D,where:R,base:O(),removal:M=>({kind:"flow",itemId:m.id,key:M})})}),g.forEach((m,E)=>{const I=m.name||m.id||`Virtual ${E+1}`,R=`Virtual Entities › ${I}`,D=`virt:${m.id}`,L={key:`virt:${m.id}`,label:I},O=i.screens("virtual",m),M=he(O.labels),W=(...A)=>({tab:"elements",panel:"virtuals",path:[L,...A]});(m.inputs??[]).forEach((A,de)=>{S(A,{ref:D,slot:`inputs.${de}`,label:`Input ${de+1}`,where:R,target:W({key:`vin:${de}`,label:A||`Input ${de+1}`})})}),S(m.entity,{ref:D,slot:"entity",label:"Source entity",where:R,target:W(M("sec:value"))});const ce=M("sec:tu");S(m.value_entity??m.pct_entity,{ref:D,slot:"value_entity",label:"Value entity",where:R,target:W(ce)}),S(m.rate_entity??m.power_entity,{ref:D,slot:"rate_entity",label:"Rate entity",where:R,target:W(ce)}),S(m.capacity_entity,{ref:D,slot:"capacity_entity",label:"Capacity entity",where:R,target:W(ce)}),C({kind:"virtual",item:m,screens:O,ref:D,where:R,base:W(),removal:A=>({kind:"virtual",itemId:m.id,key:A})})});const pe=e.background;if(pe){const E={ref:"background",where:"Canvas › Background",target:{tab:"settings",panel:"canvas",path:[he(i.screens("canvas").labels)("sec:bg")]}};pe.source==="entity"?S(pe.mode_entity,{...E,slot:"mode_entity",label:"Mode entity"}):pe.source!=="day"&&pe.source!=="night"&&S(pe.sun_entity,{...E,slot:"sun_entity",label:"Sun entity"})}return e.canvas&&$(e.canvas,{ref:"canvas",where:"Canvas",target:{tab:"settings",panel:"canvas",path:[]}}),{issues:o,skipped:s,coverage:a}}function Li(e){return e.issues.reduce((t,i)=>t+(i.severity==="error"&&!i.ignored?1:0),0)}var Bi=Object.defineProperty,Gi=Object.getOwnPropertyDescriptor,y=(e,t,i,o)=>{for(var s=o>1?void 0:o?Gi(t,i):t,a=e.length-1,n;a>=0;a--)(n=e[a])&&(s=(o?n(t,i,s):n(s))||s);return o&&s&&Bi(t,i,s),s};const vt=Qt(zt);function ne(e){return Math.round(e*10)/10}function z(e){return Math.round(e*1e4)/1e4}function H(e,t){const i={...e??{},...t};for(const o of Object.keys(t))t[o]===void 0&&delete i[o];return i}function F(e,t){return t.map(i=>`${e}.${i}`)}function ee(e,t){return t.map(i=>`${e}${i}`)}function Hi(e,t){let i=e;for(const o of t.split(".")){if(i===null||typeof i!="object")return;i=i[o]}return i}function Be(e,t){if(!t)return 0;let i=0;for(const o of t)Hi(e,o)!==void 0&&i++;return i}function ze(e,t,i,o,s){const a=(e.split(".")[1]??"sensor").replace(/_/g," "),n=t.replace(/_/g," "),l=["# Add to configuration.yaml","sensor:","  - platform: statistics",`    name: "${a} ${n}"`,`    entity_id: ${e}`,`    state_characteristic: ${t}`];i&&(l.push("    max_age:"),l.push(`      hours: ${i}`)),o&&l.push(`    sampling_size: ${o}`),t==="percentile"&&s&&l.push(`    percentile: ${s}`);const c=`${e.split(".")[1]??"sensor"}_${t}`;return l.push(""),l.push("# Then set the field entity to:"),l.push(`# sensor.${c}`),l.join(`
`)}const Ge=[{value:"average_linear",label:"Average (linear)",group:"Averages"},{value:"average_step",label:"Average (step)",group:"Averages",binary:!0},{value:"average_timeless",label:"Average (timeless)",group:"Averages",binary:!0},{value:"mean",label:"Mean",group:"Averages",binary:!0},{value:"mean_circular",label:"Mean (circular)",group:"Averages"},{value:"median",label:"Median",group:"Averages"},{value:"value_max",label:"Value maximum",group:"Extremes"},{value:"value_min",label:"Value minimum",group:"Extremes"},{value:"distance_absolute",label:"Range (max − min)",group:"Extremes"},{value:"standard_deviation",label:"Standard deviation",group:"Spread"},{value:"variance",label:"Variance",group:"Spread"},{value:"noisiness",label:"Noisiness",group:"Spread"},{value:"percentile",label:"Percentile",group:"Spread"},{value:"distance_95_percent_of_values",label:"Distance 95% of values",group:"Spread"},{value:"distance_99_percent_of_values",label:"Distance 99% of values",group:"Spread"},{value:"change",label:"Change",group:"Change"},{value:"change_sample",label:"Change per sample",group:"Change"},{value:"change_second",label:"Change per second",group:"Change"},{value:"sum",label:"Sum",group:"Sums"},{value:"sum_differences",label:"Sum of differences",group:"Sums"},{value:"sum_differences_nonnegative",label:"Sum of differences (positive)",group:"Sums"},{value:"total",label:"Total",group:"Sums"},{value:"count",label:"Count (samples)",group:"Counts",binary:!0},{value:"count_on",label:"Count (on)",group:"Counts",binary:!0},{value:"count_off",label:"Count (off)",group:"Counts",binary:!0},{value:"datetime_newest",label:"Timestamp (newest)",group:"Timestamps"},{value:"datetime_oldest",label:"Timestamp (oldest)",group:"Timestamps",binary:!0},{value:"datetime_value_max",label:"Timestamp (at max)",group:"Timestamps"},{value:"datetime_value_min",label:"Timestamp (at min)",group:"Timestamps"}],Pe=["top-left","top","top-right","left","center","right","bottom-left","bottom","bottom-right"],He={"top-left":"Top Left",top:"Top Center","top-right":"Top Right",left:"Left Middle",center:"Center",right:"Right Middle","bottom-left":"Bottom Left",bottom:"Bottom Center","bottom-right":"Bottom Right"},be=["left","center","right"],Wi=[{name:"--primary-color",label:"Primary"},{name:"--text-primary-color",label:"Text on Primary"},{name:"--accent-color",label:"Accent"},{name:"--primary-text-color",label:"Primary text"},{name:"--secondary-text-color",label:"Secondary text"},{name:"--disabled-text-color",label:"Disabled text"},{name:"--primary-background-color",label:"Primary background"},{name:"--secondary-background-color",label:"Secondary background"},{name:"--card-background-color",label:"Card background"},{name:"--divider-color",label:"Divider"},{name:"--state-icon-color",label:"State icon"},{name:"--state-active-color",label:"State Active"},{name:"--state-inactive-color",label:"State Inactive"},{name:"--error-color",label:"Error"},{name:"--warning-color",label:"Warning"},{name:"--success-color",label:"Success"},{name:"--info-color",label:"Info"}],Mt=["value","label","icon","svg","blank","rule","embedded_card","toggle","slider","dropdown","button_group","input","spinbox","button"],_e={value:"Value",label:"Label",icon:"Icon",svg:"Element Library",graph:"Graph / Gauge",blank:"Blank",rule:"Horizontal Rule",embedded_card:"Embedded Card",toggle:"Toggle",slider:"Slider",dropdown:"Dropdown",button_group:"Button Group",input:"Input",spinbox:"Spin Box",button:"Button"},ft=[...Mt].sort((e,t)=>_e[e].localeCompare(_e[t])),ve={value:"mdi:function-variant",label:"mdi:format-title",icon:"mdi:image",svg:"mdi:shape-outline",graph:"mdi:chart-line",blank:"mdi:crop-square-outline",rule:"mdi:minus",embedded_card:"mdi:widgets",toggle:"mdi:toggle-switch-outline",slider:"mdi:tune-variant",dropdown:"mdi:form-dropdown",button_group:"mdi:view-dashboard-variant-outline",input:"mdi:form-textbox",spinbox:"mdi:numeric",button:"mdi:gesture-tap-button"},We=[{value:"stat-line",label:"Statistics — Line"},{value:"bar",label:"Statistics — Bar"},{value:"bar-stacked",label:"Statistics — Bar (stacked)"},{value:"line",label:"History — Line (with unit)"},{value:"area",label:"History — Area (with unit)"},{value:"state-timeline",label:"History — State timeline"},{value:"gauge",label:"Arc Gauge"},{value:"gauge-needle",label:"Arc Gauge (Needle)"}],le="background gradient angle opacity color border width radius padding glow blur css",ye="font size color weight family letter spacing css",Fe="tap hold double navigate url more info toggle service action perform assist popover expand dom event entity write override",At="entity operator value condition show hide visible",Ui="Raw CSS declarations applied to this element, e.g. box-shadow: 0 0 8px red;. Applied after everything above, so it wins.",Xe="tick minor major length thickness font size position grid line color temperature transparency opacity decimals value",G={tick_color:"Colour of the scale marks beside the tube.",tick_position:"Which side of the tube the scale sits on.",minor_tick_text:"Numbers the small ticks as well as the major ones.",tick_font_size:"Size of the numbers beside the ticks.",grid_color:"Colour of the lines running across the tube from each major tick. Leave blank for none.",decimals:"Decimal places on the temperature reading.",temp_color:"Colour of the temperature reading. Leave blank to follow the fill colour."},J=["background","background_alpha","background2","background_angle","color","border","border_width","radius","padding","glow","extra_css","blur"],ie=["font_size","color","font_weight","font_family","letter_spacing","extra_css"],Vi=J.filter(e=>e!=="extra_css"),Yi=ie.filter(e=>e!=="extra_css"),yt=!1,et=["tap_action","hold_action","double_tap_action"],ji=["icon_position","show_state","state_position","icon_style","label_style","state_style"],te={"sub:container":{sel:["button_group_text_size","button_group_icon_size","button_group_state_size"],btn:["button_border_color","button_border_width","button_radius","button_option_padding","button_text_size","button_icon_size","button_state_size"]},"sub:active":{sel:["button_group_selected_color","button_group_selected_color2","button_group_selected_angle","button_group_selected_text_color","button_group_selected_icon_color","button_group_selected_state_color"],btn:["button_selected_color","button_selected_color2","button_selected_angle","button_selected_text_color","button_selected_icon_color","button_selected_state_color"]},"sub:inactive":{sel:["button_group_bg","button_group_bg2","button_group_bg_angle","button_group_text_color","button_group_icon_color","button_group_state_color"],btn:["button_bg","button_bg2","button_bg_angle","button_text_color","button_icon_color","button_state_color"]}},tt=["button_group_option_gap","button_group_border_color","button_group_border_width","button_group_radius","button_group_option_padding","button_group_option_border","button_group_option_border_color","button_group_option_border_width","button_group_option_radius","button_group_option_extra_css"],it=["button_option_padding"],Ki=te["sub:container"].btn.filter(e=>!it.includes(e)),Ot=["major_tick_length","major_tick_width","minor_tick_length","minor_tick_width","show_minor_tick_text","tick_color","tick_font_size","text_position","grid_color","temp_color","temp_font_size","decimals","fill_opacity_above"],wt=[...Ot,"fill_color","fill_color2","fill_angle","extra_css"],Re=["fill_color","fill_color2","fill_angle","fill_direction","tank_color","extra_css"],xt=["fill_color","fill_color2","fill_angle","extra_css"],$t="Blank runs the gradient along the fill direction. An SVG that defines its own gradient stops keeps its own direction — the angle only applies to gradients the card draws.",re={accent:["accent_color","accent_color2","accent_angle"],toggle:["toggle_on_color","toggle_on_color2","toggle_on_angle","toggle_off_color","toggle_off_color2","toggle_off_angle","toggle_thumb_color","toggle_thumb_size","toggle_thumb_radius","toggle_thumb_padding","toggle_thumb_shadow"],slider:["slider_track_color","slider_track_color2","slider_track_angle","slider_fill_color","slider_fill_color2","slider_fill_angle","slider_height","slider_length","slider_radius","slider_border","slider_border_color","slider_border_width","slider_thumb_color","slider_thumb_size","slider_thumb_width","slider_thumb_radius","slider_thumb_padding","slider_thumb_shadow"],dropdown:["dropdown_border_color","dropdown_bg","dropdown_bg2","dropdown_bg_angle","dropdown_menu_bg","dropdown_menu_bg2","dropdown_menu_bg_angle","dropdown_menu_border_color","dropdown_selected_color","dropdown_selected_color2","dropdown_selected_angle","dropdown_radius","dropdown_text_size","dropdown_menu_radius","dropdown_menu_shadow","dropdown_option_radius","dropdown_option_text_color","dropdown_option_hover_color"],input:["input_border_color","input_bg","input_bg2","input_bg_angle","input_focus_color","input_placeholder_color","input_radius","input_text_size"],spinbox:["spinbox_border_color","spinbox_bg","spinbox_bg2","spinbox_bg_angle","spinbox_button_hover_color","spinbox_button_hover_color2","spinbox_button_hover_angle","spinbox_button_width","spinbox_button_font_size","spinbox_radius","spinbox_text_size"]},kt=(()=>{try{return new URL("./",import.meta.url).href}catch{return"/local/community/mosaic-canvas-card/"}})(),qi=[{type:"alarm-panel",name:"Alarm Panel"},{type:"button",name:"Button"},{type:"calendar",name:"Calendar"},{type:"entities",name:"Entities"},{type:"entity",name:"Entity"},{type:"entity-filter",name:"Entity Filter"},{type:"gauge",name:"Gauge"},{type:"glance",name:"Glance"},{type:"history-graph",name:"History Graph"},{type:"horizontal-stack",name:"Horizontal Stack"},{type:"humidifier",name:"Humidifier"},{type:"iframe",name:"iFrame"},{type:"light",name:"Light"},{type:"logbook",name:"Logbook"},{type:"map",name:"Map"},{type:"markdown",name:"Markdown"},{type:"media-control",name:"Media Control"},{type:"picture",name:"Picture"},{type:"picture-elements",name:"Picture Elements"},{type:"picture-entity",name:"Picture Entity"},{type:"picture-glance",name:"Picture Glance"},{type:"plant-status",name:"Plant Status"},{type:"sensor",name:"Sensor"},{type:"shopping-list",name:"Shopping List"},{type:"statistics-graph",name:"Statistics Graph"},{type:"thermostat",name:"Thermostat"},{type:"tile",name:"Tile"},{type:"todo-list",name:"To-do List"},{type:"vertical-stack",name:"Vertical Stack"},{type:"weather-forecast",name:"Weather Forecast"},{type:"webpage",name:"Webpage"}];function Zi(e){const t=(e??"").trim(),i=t.match(/^color-mix\(\s*in\s+srgb\s*,\s*(.+?)\s+([\d.]+)%\s*,\s*transparent\s*\)$/i);if(i)return{base:i[1].trim(),alpha:Math.max(0,Math.min(1,Number(i[2])/100))};const o=t.match(/^#([0-9a-f]{6})([0-9a-f]{2})$/i);if(o)return{base:`#${o[1]}`,alpha:parseInt(o[2],16)/255};const s=t.match(/^rgba?\(\s*([\d.]+)\s*,\s*([\d.]+)\s*,\s*([\d.]+)\s*[,/]\s*([\d.]+)\s*\)$/i);return s?{base:"#"+[s[1],s[2],s[3]].map(n=>Math.max(0,Math.min(255,Math.round(Number(n)))).toString(16).padStart(2,"0")).join(""),alpha:Math.max(0,Math.min(1,Number(s[4])))}:{base:t,alpha:1}}function St(e,t){return t>=1?e:`color-mix(in srgb, ${e} ${Number((t*100).toFixed(1))}%, transparent)`}function Xi(e,t){const i=t?.isConnected?t:document.body,o=document.createElement("div");try{o.style.color=e,o.style.display="none",i.appendChild(o);const a=getComputedStyle(o).color.match(/\d+/g)?.map(Number);return!a||a.length<3?"#000000":"#"+a.slice(0,3).map(n=>n.toString(16).padStart(2,"0")).join("")}catch{return"#000000"}finally{o.remove()}}let p=class extends Gt{constructor(){super(...arguments),this._selCard=0,this._selField=-1,this._selCards=new Set,this._selEmbCards=new Set,this._selFlow=-1,this._showAddFlowInput=!1,this._newFlowName="",this._pendingFlowIdx=-1,this._showFlowCompleteModal=!1,this._selPoint=-1,this._selSeries=-1,this._selOption=-1,this._selExtOption=-1,this._selExtSeries=-1,this._selVirtual=-1,this._selVirtualInput=-1,this._selTrigger=-1,this._selZone=-1,this._selExtCard=0,this._selExtField=-1,this._templateName="",this._templateIncludeEntities=!1,this._templateError="",this._previewBoxes={},this._previewExpanded=!1,this._barAtTop=localStorage.getItem("mc-expanded-bar-top")==="1",this._onWindowResize=()=>this._sizeExpandedCanvas(),this._pickerStyleScheduled=!1,this._pickerStyleRetries=0,this._mccustApplied=[],this._copiedFields=null,this._copySourceId=null,this._virtualClipboard=null,this._copiedField=null,this._copiedFieldSrc=null,this._copiedOption=null,this._dragSrc=null,this._cpOpenId=null,this._cpOpenAbove=!1,this._cpFocusedId=null,this._ggOpen=!1,this._ggTarget=null,this._wizStep=-1,this._wiz={cardType:"",source:"auto",sunEntity:"sun.sun",dayImg:"",nightImg:"",evCount:0,evImgs:[],bgCount:"single",bgSwitchMode:"sun",bgEntity:"",singleImg:""},this._wizardShown=!1,this._oneOwnerChecked=!1,this._dragCard=-1,this._startX=0,this._startY=0,this._dragMembers=[],this._embDragMembers=[],this._dragPoint=-1,this._pStartX=0,this._pStartY=0,this._pStartPos={x:0,y:0},this._snapAxis=null,this._snapAnchor=null,this._dragZone=-1,this._zStartX=0,this._zStartY=0,this._zStartPos={x:0,y:0},this._resizeZone=-1,this._resizeCorner="br",this._zResizeStartBox={x:0,y:0,w:0,h:0},this._bgSelected=!1,this._bgMode=null,this._bgStartX=0,this._bgStartY=0,this._bgStart={L:0,T:0,baseW:0,baseH:0,totalW:0,totalH:0},this._selEmbCard=-1,this._dragEmbCard=-1,this._ecStartX=0,this._ecStartY=0,this._embEditorOpen=!1,this._embEditorYaml="",this._embEditorYamlError="",this._embNativeEditor=null,this._embEditorTarget=null,this._embEditorConfig=null,this._embPickerOpen=!1,this._embPickerSearch="",this._embPickerTarget=null,this._variantOpen="",this._variantError="",this._saveVariantFor="",this._saveVariantLabel="",this._variantImportError="",this._navTab="cards",this._navPanel="",this._navPath=[],this._panelScroll=new Map,this._lastScrollKey="",this._lastScrollDepth=0,this._listFilter="",this._listFilterKey="",this._undoStack=[],this._redoStack=[],this._undoSrc=null,this._undoLastPush=0,this._restoring=!1,this._onUndoKeydown=e=>{if(!(e.ctrlKey||e.metaKey)||e.altKey)return;const t=e.key.toLowerCase(),i=t==="z"&&!e.shiftKey,o=t==="y"||t==="z"&&e.shiftKey;if(!i&&!o)return;const s=e.composedPath()[0];if(s instanceof HTMLElement){const a=s.tagName;if(a==="INPUT"||a==="TEXTAREA"||a==="SELECT"||s.isContentEditable)return}e.preventDefault(),e.stopPropagation(),i?this._undo():this._redo()},this._toastMsg="",this._tutorialStep=-1,this._ptrDrag=null,this._dropKey=null,this._dropBefore=!1,this._suppressClick=!1,this._searchQuery="",this._searchActive=0,this._healthShowIgnored=!1,this._optionLayoutOn=new Set,this._colorOverridesOn=new Set,this._gradientOn=new Set,this._resetToWizard=()=>{window.confirm(`Reset all configuration and restart the setup wizard?
...
It also resets Global Defaults to their starting values — including your saved custom control variants — and clears the popover card defaults and EV count.`)&&(this._wiz={cardType:"",source:"auto",sunEntity:"sun.sun",dayImg:"",nightImg:"",evCount:0,evImgs:[],bgCount:"single",bgSwitchMode:"sun",bgEntity:"",singleImg:""},this._wizStep=0,this._emit({type:this._config.type,background:{},canvas:{},defaults:{font_family:"sans-serif",card:{background:"rgba(8,18,28,0.55)",border:!0,color:"#00d4ff",radius:10,padding:8},label:{font_size:13,color:"#cccccc"},value:{font_size:22,color:"#ffffff",font_weight:600}},cards:[]}))},this._cpMode="rgb"}_navPush(e,t,i){this._navPath=[...this._navPath,{key:e,label:t,...i?{hint:i}:{}}]}_crumbIndex(e,t){if(!t)return-1;const i=e.slice(e.indexOf(":")+1),o=t.findIndex(a=>{const n=a&&typeof a=="object"?a.id:void 0;return n!==void 0&&String(n)===i});if(o>=0)return o;const s=Number(i);return Number.isInteger(s)&&s>=0&&s<t.length?s:-1}_navScrollKey(){return`${this._navTab}|${this._navPanel}|${this._navPath.map(e=>e.key).join("/")}`}_navDeadEnd(e="This item no longer exists — it may have been removed in the YAML editor."){return r`
    ...
    `}_renderWizard(){const e=this._wizStep,t=this._wiz,i=s=>{this._wiz={...t,...s}},o=s=>{this._wizStep=s};return r`
      <div class="ec-wizard">
        ${e===0?r`
        ...
        `:e===3?r`
          ...
          <div class="ec-wiz-field">
            ...
            <input class="ec-wiz-input ec-wiz-input--short" type="number" min="0" max="3"
              ...
              @input=${s=>{const a=Math.max(0,Math.min(3,parseInt(s.target.value)||0)),n=Array.from({length:a},(l,c)=>t.evImgs[c]??{day:"",night:""});i({evCount:a,evImgs:n})}}/>
          </div>
          ${t.evImgs.map((s,a)=>r`
              ...
              ${t.source!=="none"?r`
                <div class="ec-wiz-field">
                  ...
                  <input class="ec-wiz-input" type="text" .placeholder=${`/local/energy-day-${a+1}ev.jpg`}
                    .value=${s.day}
                    @input=${n=>{const l=t.evImgs.map((c,d)=>d===a?{...c,day:n.target.value}:c);i({evImgs:l})}}/>
                </div>
              `:_}
              ${t.source==="auto"?r`
                <div class="ec-wiz-field">
                  ...
                  <input class="ec-wiz-input" type="text" .placeholder=${`/local/energy-night-${a+1}ev.jpg`}
                    .value=${s.night}
                    @input=${n=>{const l=t.evImgs.map((c,d)=>d===a?{...c,night:n.target.value}:c);i({evImgs:l})}}/>
                </div>
              `:_}
            </div>
          `)}
    ...
    `}_updateCard(e,t){if(!this._config)return;const i=this._config.cards.map((o,s)=>s===e?H(o,t):o);this._emit({...this._config,cards:i})}_updateCardBox(e,t){if(!this._config)return;const i=this._config.cards[e];i&&this._updateCard(e,{box:H(i.box??{},t)})}_updateField(e,t,i){if(!this._config)return;const o=this._config.cards[e];if(!o)return;const s=o.fields.map((a,n)=>n===t?H(a,i):a);this._updateCard(e,{fields:s})}_updateDefaults(e){this._config&&this._emit({...this._config,defaults:H(this._config.defaults,e)})}_updateCanvas(e){this._config&&this._emit({...this._config,canvas:H(this._config.canvas,e)})}_gridGeom(){const e=this._config?.canvas;if(e?.layout_mode!=="grid"||!e.grid)return null;const{totalW:t,totalH:i}=K(this._config),o=Math.max(1,e.grid.columns||1),s=Math.max(1,e.grid.rows||1),a=e.grid.padding??0;return{cols:o,rows:s,padding:a,cellW:t/o,cellH:i/s,totalW:t,totalH:i}}_setLayoutMode(e){if(!this._config)return;const t={...this._config.canvas??{}};if(t.layout_mode=e,e==="grid"){t.grid||(t.grid={columns:10,rows:15,padding:0});const i=Math.max(1,t.grid.columns),o=Math.max(1,t.grid.rows),s=t.grid.padding??0,{totalW:a}=K(this._config),n=a/i,l=this._config.cards.map(h=>{const u=this._previewBoxes[h.id],g=u?u.x+u.w/2:h.position.x,b=u?u.y+u.h/2:h.position.y,f=Math.min(i,Math.max(0,Math.round(g*i))),P=Math.min(o,Math.max(0,Math.round(b*o))),T=h.grid_span??Math.max(1,Math.min(i,Math.round((u?.w??0)*i)||1)),k=Math.max(8,T*n-s);return{...h,anchor:"center",grid_span:T,width:k,position:{x:z(f/i),y:z(P/o)}}}),c=this._embCards().map(h=>{const u=this._previewBoxes[h.id],g=u?u.x+u.w/2:h.position.x,b=u?u.y+u.h/2:h.position.y,f=Math.min(i,Math.max(0,Math.round(g*i))),P=Math.min(o,Math.max(0,Math.round(b*o))),T=h.grid_span??Math.max(1,Math.min(i,Math.round((u?.w??0)*i)||1)),k=Math.max(8,T*n-s);return{...h,anchor:"center",grid_span:T,width:k,position:{x:z(f/i),y:z(P/o)}}});this._emit({...this._config,canvas:t,cards:l,embedded_cards:c});const d=l.length+c.length;d&&this._showUndoToast(`${d} card${d===1?"":"s"} re-laid out for Grid`)}else this._emit({...this._config,canvas:t})}_renderGridOverlay(){const e=this._gridGeom();if(!e)return _;const{cols:t,rows:i}=e,o=[];for(let s=0;s<=t;s++)for(let a=0;a<=i;a++)o.push(r`<div class="ec-grid-dot" style="left:${s/t*100}%;top:${a/i*100}%;"></div>`);return r`<div class="ec-grid-overlay">${o}</div>`}_renderBgOverlay(){if(!this._config)return _;const e=K(this._config),t=e.L/e.totalW*100,i=e.T/e.totalH*100,o=e.baseW/e.totalW*100,s=e.baseH/e.totalH*100;return r`
    ...
    `}_boxRows(e,t,i,o=!0){return r`
      ${this._gradientRows({id:`${e}-bg`,label:"Background",toLabel:"Gradient to",colorHint:"The box's fill colour. Leave blank for no fill, so whatever sits behind shows through.",color:t.background,color2:t.background2,angle:t.background_angle,setColor:s=>i({background:s}),setColor2:s=>i({background2:s}),setAngle:s=>i({background_angle:s}),clearGradient:()=>i({background2:void 0,background_angle:void 0}),onClearColor:()=>i({background:void 0,background_alpha:void 0})})}
      ...
      ${this._row("Color",this._colorPicker(`${e}-col`,t.color,s=>i({color:s})),"Colour of the border and the glow — not a fill. The fill is Background above.")}
      ...
      ${this._numRow("Border width (px)",{value:t.border_width,onChange:s=>i({border_width:s}),min:0,placeholder:"1",hint:"Only visible while Border is ticked."})}

      ${this._numRow("Radius (px)",{value:t.radius,onChange:s=>i({radius:s}),min:0,placeholder:"0",hint:"Rounds the corners of the box."})}

      ${this._numRow("Padding (px)",{value:t.padding,onChange:s=>i({padding:s}),min:0,placeholder:"0",hint:"Space between the edge of the box and its contents."})}
      ...
      ${this._numRow("Blur (px)",{value:t.blur,onChange:s=>i({blur:s}),min:0,placeholder:"0",hint:"Blurs what is behind the box — the background image, or the dashboard behind a popover. The box's own contents stay sharp."})}
    ...
    `}_cssRow(e,t,i="Additional CSS",o=Ui){return this._row(i,r`<textarea
    ...
    `}render(){if(!this._config)return _;if(this._wizStep>=0)return this._renderWizard();const{totalW:e,totalH:t}=K(this._config),i=this._config.cards??[];return r`
      <div class="ec-version-bar">
        <span class="ec-version">Mosaic Canvas Card v${Je} · build ${Ht}</span>
      </div>
        ...
        >
          ...
          ${this._flows().length>0?r`
            <svg class="ec-flow-paths-overlay" viewBox="0 0 1 1" preserveAspectRatio="none">
              ...
              ${this._flows().map((o,s)=>{const a=o.points.map(l=>ue(l,i,this._previewBoxes)).map(l=>`${l.x},${l.y}`).join(" "),n=s===this._selFlow;return Ut`
                  <polyline
                    class="ec-flow-hit"
                    points="${a}"
                    fill="none"
          ...
          ${this._selFlow>=0?(()=>{const o=this._flows()[this._selFlow];if(!o)return _;const s=["top","right","bottom","left"];return r`
              ...
              >
                ${this._selPoint>=0?i.map(a=>s.map(n=>{const l=this._previewBoxes[a.id];if(!l)return _;let c,d;switch(n){case"top":c=l.x+l.w/2,d=l.y;break;case"right":c=l.x+l.w,d=l.y+l.h/2;break;case"bottom":c=l.x+l.w/2,d=l.y+l.h;break;case"left":c=l.x,d=l.y+l.h/2;break;default:c=l.x+l.w/2,d=l.y+l.h/2;break}return r`<div
                  ...
                  ></div>`})):_}
                ${o.points.map((a,n)=>{const l=ue(a,i,this._previewBoxes);return r`<div
...
`)}`)}_itemCard(e){const{dragKey:t,icon:i,label:o,sub:s,selected:a,multi:n,onClick:l,actions:c}=e,d=this._dropKey===t;return r`
    ...
    `}_renderRibbon(){const e=[{key:"cards",icon:"mdi:view-grid",label:"Cards"},{key:"elements",icon:"mdi:shape",label:"Elements"},{key:"settings",icon:"mdi:cog",label:"Settings"}],t=this._searchQuery.trim(),i=t?this._searchResults(t):[],o=i.length?Math.min(this._searchActive,Math.min(i.length,p._SEARCH_LIMIT)-1):-1,s=Li(this._health());return r`
    ...
    `}_renderPanelBody(){switch(this._navPanel){case"mosaic":return this._renderMosaicPanel();case"popover":return this._renderPopoverPanel();case"embedded":return this._renderEmbeddedPanel();case"flows":return this._renderFlowsRibbonPanel();case"zones":return this._renderZonesRibbonPanel();case"virtuals":return this._renderVirtualsRibbonPanel();case"canvas":return this._renderCanvasRibbonPanel();case"defaults":return this._renderDefaultsRibbonPanel();case"templates":return this._renderTemplatesRibbonPanel();case"health":return this._renderHealthPanel();default:return r``}}static _slotMap(e){const t=new Map;for(const i of e)for(const o of i.paths??[]){const s=o.split(".")[0];t.has(s)||t.set(s,i.key)}return t}static _labelMap(e){return new Map(e.map(t=>[t.key,t.label]))}_fieldSlotDefs(e){const t=p,i=[...this._fieldSectionDefs(e)];return e.type==="button_group"&&i.push(t._OPTION_LAYOUT_DEF),(e.type==="button_group"||e.type==="button")&&i.push(...t._fscsDefs(e.type==="button")),(e.type==="blank"||e.type==="rule")&&i.push(t._BLANK_RULE_DEF),i}static _healthOffered(){const e=Pe,t=be;return{field:{type:[...Mt,"graph"],graph_type:We.map(i=>i.value),align:t,stat_characteristic:Ge.map(i=>i.value)},card:{anchor:e,align:t},extCard:{align:t},zone:{anchor:e},emb:{anchor:e},flow:{style:p._FLOW_STYLES},virtual:{op:p._VIRTUAL_OPS.map(i=>i.value)}}}_healthDefs(e,t){const i=p;switch(e){case"card":return i._CARD_SECTIONS;case"extCard":return i._POPOVER_CARD_SECTIONS;case"zone":return i._ZONE_SECTIONS;case"flow":return i._FLOW_SECTIONS;case"emb":return i._EMB_SECTIONS;case"canvas":return i._CANVAS_SECTIONS;case"field":return this._fieldSlotDefs(t);case"virtual":return this._virtualSectionDefs(t);default:return[]}}_healthContext(){const e=p;return{screens:(t,i)=>{const o=this._healthDefs(t,i);return{slots:e._slotMap(o),labels:e._labelMap(o)}},offered:e._healthOffered(),fieldName:t=>this._fieldName(t)}}_health(){const e=this._config,t=this.hass?.states,i=this._healthCache;if(i&&i.cfg===e&&i.states===t)return i.report;const o=Ni(e,this.hass,this._healthContext());return this._healthCache={cfg:e,states:t,report:o},o}_healthRemovalScope(e){const t=this._config;if(!t)return;const i=(o,s)=>(o??[]).findIndex(a=>a.id===s);switch(e.kind){case"card":{const o=i(t.cards,e.itemId);return o<0?void 0:this._cardScope(o)}case"extCard":{const o=i(this._extCards(),e.itemId);return o<0?void 0:this._extCardScope(o)}case"field":{const o=e.extended?this._extCards():t.cards??[],s=i(o,e.cardId??"");if(s<0)return;const a=i(o[s]?.fields,e.itemId);return a<0?void 0:this._fieldScope(s,a,!!e.extended)}case"zone":{const o=i(this._zones(),e.itemId);return o<0?void 0:this._zoneScope(o)}case"flow":{const o=i(this._flows(),e.itemId);return o<0?void 0:this._flowScope(o)}case"emb":{const o=i(this._embCards(),e.itemId);return o<0?void 0:this._embScope(o)}case"virtual":{const o=i(this._virtuals(),e.itemId);return o<0?void 0:this._virtualScope(o)}default:return}}_healthRemove(e){const t=e.removal;if(!t)return;const i=this._healthRemovalScope(t);if(!i){this._showUndoToast("That item no longer exists — nothing removed");return}const o=i.root?.[t.key];window.confirm(`Remove “${t.key}” from the YAML?
...
Undo (Ctrl+Z) reverses this.`)&&(i.apply({[t.key]:void 0}),this._showUndoToast(`“${t.key}” removed`))}_healthIgnore(e,t){const i=this._config;if(!i)return;const o=i.health_ignore??[],s=t?o.includes(e)?o:[...o,e]:o.filter(a=>a!==e);this._emit(H(i,{health_ignore:s.length?s:void 0})),this._showUndoToast(t?"Row ignored":"Row restored")}_renderHealthPanel(){const e=this._health(),t=e.issues.filter(s=>!s.ignored),i=e.issues.filter(s=>s.ignored),o=It.map(s=>({meta:s,rows:t.filter(a=>a.check===s.id)})).filter(s=>s.rows.length>0);return r`
    ...
    `}_renderMosaicPanel(){const e=this._config?.cards??[],t=this._navPath;if(t.length===0)return r`
      ...
      `;const s=t[1].key;if(s.startsWith("field:")){const a=this._crumbIndex(s,o.fields);this._selField=a;const n=o.fields[a];if(!n)return this._navDeadEnd();if(t.length===4&&t[2].key==="fsec:series"&&t[3].key.startsWith("gs:")){const l=this._crumbIndex(t[3].key,n.graph_series);return this._selSeries=l,this._fieldSecGraphSeriesItem(i,a,n,l)}if(t.length===4&&t[2].key==="fsec:options"){if(t[3].key.startsWith("opt:")){const l=this._crumbIndex(t[3].key,n.options);return this._selOption=l,this._fieldSecOptionItem(i,a,n,l)}if(t[3].key==="optlayout")return r`
          ...
          `}return t.length===4&&t[2].key==="fsec:controlstyle"&&t[3].key.startsWith("fscs:")?this._fieldControlStyleStateSection(i,a,n,t[3].key):t.length===3?this._fieldSection(i,a,n,t[2].key):this._renderFieldPanel(i,a,n)}return this._cardSection(i,o,s)}_cardScope(e){return{root:this._config?.cards[e],apply:t=>this._updateCard(e,t)}}_cardSectionMenu(e){return this._navMenu(p._CARD_SECTIONS,this._cardScope(e))}_cardSection(e,t,i){const o=this._clearOverridesBtn(p._findDef(p._CARD_SECTIONS,i),this._cardScope(e));return r`${o}${(()=>{switch(i){case"sec:defaults":return this._cardSecDefaults(e,t);case"sec:style":return this._cardSecStyle(e,t);case"sec:text":return this._cardSecText(e,t);case"sec:visibility":return this._cardSecVisibility(e,t);case"sec:actions":return this._cardSecActions(e,t);case"sec:bg":return this._cardSecBg(e,t);default:return r``}})()}`}_cardSecDefaults(e,t){return r`
      <div class="ec-section">
        ...
        ${this._row("Anchor",r`<select class="ec-select"
          ...
          >
            ${Pe.map(i=>r`<option value=${i} .selected=${(t.anchor??v("anchor")??"top-left")===i}>${He[i]}</option>`)}
        ...
        ${this._row("Align",r`<select class="ec-select"
          ...
          >
            ${be.map(i=>r`<option value=${i} .selected=${(t.align??v("align")??"left")===i}>${i}</option>`)}
        ...
        ${this._optRow("Field gap (px)","Vertical space between fields",t.field_gap===void 0,r`${this._numInput({value:t.field_gap??v("field_gap")??4,onChange:i=>this._updateCard(e,{field_gap:i}),min:0})}`,i=>this._updateCard(e,{field_gap:i?void 0:t.field_gap??v("field_gap")??4}))}
    ...
    `}_cardSecBg(e,t){return r`
      <div class="ec-section">
            ${this._row("URL",r`<input class="ec-input" type="text"
              ...
              />`,"An image drawn behind this card's fields, under the card box. Leave blank for none.")}
            ${t.bg?.url?r`
              ...
              ${this._numRow("Width (px)",{value:t.bg.width,onChange:i=>this._updateCard(e,{bg:{...t.bg,width:i}}),min:1,placeholder:"fill card",hint:"Unset sizes the image to the card."})}
              ${this._numRow("Height (px)",{value:t.bg.height,onChange:i=>this._updateCard(e,{bg:{...t.bg,height:i}}),min:1,placeholder:"fill card",hint:"Unset sizes the image to the card."})}
    ...
    `}_fieldName(e){return e.display_name??e.text??(e.entity?.startsWith("virtual:")?this._virtuals().find(t=>`virtual:${t.id}`===e.entity)?.name??e.entity:this.hass?.states[e.entity??""]?.attributes?.friendly_name??e.entity)??e.icon??"(untitled field)"}_fieldSub(e){const t=e.type==="graph"&&e.graph_type?e.graph_type:e.type==="svg"&&(e.shape||e.svg)?e.shape??e.svg.split("/").pop()?.replace(/\.svg$/i,"")??"":e.type==="embedded_card"&&e.embed_card_config?.type?String(e.embed_card_config.type):"";return`${e.column!=null?`C${e.column} · `:""}${_e[e.type]}${t?" · "+t:""}`}_renderFieldList(e,t){const i=t.fields;return r`
      <div class="ec-section ec-section--fields">
        ...
        ${i.length===0?this._emptyAdd("No fields yet — add one",()=>this._addField(e)):i.map((o,s)=>({f:o,fi:s})).filter(({f:o})=>{const s=this._currentListFilter();return!s||`${this._fieldName(o)} ${this._fieldSub(o)}`.toLowerCase().includes(s)}).map(({f:o,fi:s})=>this._itemCard({dragKey:`field:${e}:${s}`,icon:ve[o.type],label:this._fieldName(o),sub:this._fieldSub(o),selected:s===this._selField,onClick:()=>{this._selField=s,this._navPush(`field:${o.id}`,`Field ${s+1}`)},actions:r`
    ...
    `}_fieldHeader(e,t,i){return r`
        ${this._row("Type",r`<select class="ec-select"
            .value=${i.type==="graph"?"svg":i.type}
            @change=${o=>{const s=o.target.value;if(q(s)){const a=ct(s);if(a&&!this._confirmVariantOptionLoss(i,s,a)){o.target.value=i.type==="graph"?"svg":i.type;return}this._updateField(e,t,{type:s,...a?ke(s,a):{}})}else this._updateField(e,t,{type:s}),s==="svg"&&this._openGGPicker(e,t)}}
          >
            ${ft.map(o=>r`<option value=${o} .selected=${(i.type==="graph"?"svg":i.type)===o}>${_e[o]}</option>`)}
          </select>`,"What kind of field this is. Changing it keeps the entity and drops settings the new type has no use for.")}

        ${q(i.type)&&Ae(i.type).length>1?this._row("Variant",r`<select class="ec-select"
            .value=${i.variant??""}
            @change=${o=>{const s=o.target.value;if(!this._confirmVariantOptionLoss(i,i.type,s)){o.target.value=i.variant??"";return}this._updateField(e,t,ke(i.type,s))}}
          >
        ...
        ${this._row("Column",r`<div style="display:flex;gap:4px;align-items:center">
            ${this._numWrap(r`<input class="ec-input ec-input-num-small" type="number" min="1" max="8"
              ...
              placeholder="auto"
              title="The column this field sits in. Blank lets it flow into the next free one."
            ...
            ${this._numWrap(r`<input class="ec-input ec-input-num-small" type="number" min="2" max="8"
              ...
              placeholder="–"
              title="The last column this field reaches, to span several. Blank keeps it in one."
              @change=${o=>{const s=o.target.value;this._updateField(e,t,{column_end:s===""?void 0:Number(s)})}}
            />`)}
          </div>`,"Which of the card’s columns this field sits in, and how many it spans. Each box has its own note.")}
    `}_renderFieldPanel(e,t,i){return i.type==="blank"||i.type==="rule"?r`
        <div class="ec-section ec-section--fields">
    ...
    `}_idFor(e,t,i){const s=(i?this._extCards()[e]:this._config?.cards[e])?.fields[t]?.id,a=i?"e":"c";return s?`${a}${s}`:`${a}${e}f${t}`}_derivedService(e){const t=e.entity?.split(".")[0];if(!t)return"";const i=(...o)=>o.includes(t);switch(e.type){case"toggle":case"button":return"homeassistant.turn_on / turn_off";case"slider":case"spinbox":return i("input_number","number","counter")?`${t}.set_value`:"";case"dropdown":case"button_group":case"input":return i("input_select","select")?`${t}.select_option`:i("input_text","text")?`${t}.set_value`:"";default:return""}}_fieldSecControlSource(e,t,i,o=!1){const s=this._updFor(e,t,o),a=this._derivedService(i);return r`
      <div class="ec-section">
        ${this._entitySelector({entity:i.entity,onEntity:n=>s({entity:n}),attribute:i.read_attribute,onAttribute:n=>s({read_attribute:n}),attributePlaceholder:Vt(i.options_attribute)})}
    ...
    `}_saveAsVariantRows(e,t){if(!q(e.type))return r``;const i=e.type,o=Yt(i,e.variant)?jt(i,e.variant):void 0;if(!(this._saveVariantFor===t))return r`
      ...
      <p class="ec-hint">
        ...
        ${o?r`<b>Update</b> rewrites <b>${o.label}</b> under its existing id, so every field using it follows.
                 <b>Save as New</b> creates a separate variant with id <code>${l()?Se(i,l()):"…"}</code>.`:r`Id will be <code>${l()?Se(i,l()):"…"}</code>.`}
      </p>
      <p class="ec-hint">
    ...
    `}_confirmVariantOptionLoss(e,t,i){if(!qt(e,t,i))return!0;const o=e.options?.length??0;return window.confirm(`This variant brings no options of its own, so applying it will clear the ${o} option${o===1?"":"s"} on this field.
...
Undo restores them. Save the field as a variant first if you want to keep this list.`)}_numberEntityRange(e){if(!e||!e.startsWith("number.")&&!e.startsWith("input_number.")||!this.hass)return{};const t=this.hass.states[e]?.attributes;if(!t)return{};const i=o=>typeof o=="number"?o:void 0;return{min:i(t.min),max:i(t.max),step:i(t.step)}}_fieldSecSliderRange(e,t,i,o=!1){const s=this._updFor(e,t,o),a=this._numberEntityRange(i.entity),n=(l,c,d,h)=>this._numRow(l,{value:i[c],onChange:u=>s({[c]:u}),placeholder:a[c]?.toString()??d,hint:h});return r`
    ...
    `}_fieldSecControlLabels(e,t,i,o=!1){const s=this._updFor(e,t,o),a=i.control_labels??[],n=c=>s({control_labels:c.length?c:void 0}),l=i.control_labels_position??"above";return r`
      <div class="ec-section">
        ...
        ${this._row("Alignment",r`<select class="ec-select" .value=${i.align??"left"}
          ...
          >
            ${be.map(c=>r`<option value=${c} .selected=${(i.align??"left")===c}>${c}</option>`)}
          </select>`)}
    ...
    `}_fieldSecOptions(e,t,i,o=!1){const s=this._updFor(e,t,o),a=i.options_source??"entity",n=i.options??[],l=d=>s({options:d.length?d:void 0}),c=o?"eopt":"opt";return i.type==="button"?r`<div class="ec-section">
      ...
      <div class="ec-section">
        ...
        ${i.type==="button_group"?r`
          ...
          ${(()=>{const d=p._OPTION_LAYOUT_DEF;return this._navBtn(d.key,d.label,d.hint,d.icon,Be(i,d.paths))})()}
        `:_}
      </div>
    ...
    `}_fieldSecSvgThermo(e,t,i,o=!1){const s=this._updFor(e,t,o),a=o?`ext${e}-f${t}`:`c${e}-f${t}`;return r`
      <div class="ec-section">
            ${this._row("Tick color",this._colorPicker(`${a}-ttc`,i.thermo_tick_color,n=>s({thermo_tick_color:n||void 0}),{clearTitle:"Reset to default"}),G.tick_color)}
            ...
            ${this._row("Minor tick text",r`<input type="checkbox" class="ec-checkbox"
                ...
                @change=${n=>s({thermo_show_minor_tick_text:n.target.checked})} />`,G.minor_tick_text)}
            ${this._numRow("Tick font size",{hint:G.tick_font_size,value:i.thermo_tick_font_size,onChange:n=>s({thermo_tick_font_size:n}),min:1,max:20,step:.5,placeholder:"4"})}
            ...
            ${this._row("Grid line color",this._colorPicker(`${a}-tgc`,i.thermo_grid_color,n=>s({thermo_grid_color:n||void 0}),{clearTitle:"Reset to default"}),G.grid_color)}
            ...
            ${this._numRow("Decimals",{hint:G.decimals,value:i.thermo_decimals,onChange:n=>s({thermo_decimals:n}),min:0,max:4,step:1,placeholder:"1"})}
            ${this._row("Temperature value color",this._colorPicker(`${a}-tvc`,i.thermo_temp_color,n=>s({thermo_temp_color:n||void 0}),{clearTitle:"Reset to default"}),G.temp_color)}
    ...
    `}_fieldSecGraphSettings(e,t,i,o=!1){const s=this._updFor(e,t,o);return r`
      <div class="ec-section">
          ...
          ${this._row("Type",r`<select class="ec-select"
            ...
            >
              ${We.map(a=>r`<option value=${a.value} .selected=${(i.graph_type??v("graph_type")??"bar")===a.value}>${a.label}</option>`)}
        ...
        ${(i.graph_palette??v("graph_palette")??[]).map((l,c)=>r`
          <div class="ec-list-row" style="align-items:center;gap:6px;">
            ...
            <div style="flex:1;min-width:0;">
              ${this._colorPicker(`${a}-gp${c}`,l,d=>{const h=[...i.graph_palette??v("graph_palette")??[]];h[c]=d??"",s({graph_palette:h})},{clearable:!1})}
            </div>
    ...
    `}_fieldSecGraphSeriesItem(e,t,i,o,s=!1){const a=this._updFor(e,t,s),n=s?`ext${e}-f${t}`:`c${e}-f${t}`,l=(i.graph_series??[])[o];return l?r`
      <div class="ec-section">
              ...
              ${["last_n_minutes","last_n_hours","last_n_days","last_n_months"].includes(l.stat_period)?this._row(l.stat_period==="last_n_minutes"?"Number of minutes":l.stat_period==="last_n_hours"?"Number of hours":l.stat_period==="last_n_days"?"Number of days":"Number of months",this._numWrap(r`<input type="number" class="ec-input ec-input-num" min="1" step="1"
                ...
                />`)):_}
              ${(()=>{const c=!l.stat_period&&Zt.includes(i.graph_type??v("graph_type")??"bar"),d=l.stat_type??(c?v("stat_type_history")??"mean":v("stat_type")??"sum"),h=!c||d==="difference";return r`
            ...
            <div class="ec-stat-yaml">
              <div class="ec-stat-yaml-header">
                ...
                <button class="ec-btn-copy" title="Copy YAML"
                  @click=${()=>{const a=ze(i.entity,i.stat_characteristic,i.stat_max_age_hours,i.stat_sampling_size,i.stat_percentile);navigator.clipboard.writeText(a)}}>⎘ Copy</button>
              </div>
              <pre class="ec-stat-yaml-code">${ze(i.entity,i.stat_characteristic,i.stat_max_age_hours,i.stat_sampling_size,i.stat_percentile)}</pre>
            </div>
          `:_}
      </div>
    ...
    `}_fieldSecStyle(e,t,i,o=!1){const s=this._updFor(e,t,o),a=o?`ext${e}-f${t}`:`c${e}-f${t}`;return r`
      <div class="ec-section">
          ${q(i.type)?_:this._row("Align",r`<select class="ec-select"
              .value=${i.align??v("align")??"left"}
              @change=${n=>s({align:n.target.value})}
            >
              ${be.map(n=>r`<option value=${n} .selected=${(i.align??v("align")??"left")===n}>${n}</option>`)}
            </select>`,"Horizontal alignment of this field within its column.")}
          ...
          ${i.style!==void 0?r`
            ...
            ${this._textRows(`${a}-st`,i.style,n=>s({style:{...i.style,...n}}),yt)}
          `:_}
    ...
    `}_defaultsSecCard(e){const t=dt(e,Ue);return r`
      <div class="ec-section">
        ...
        ${this._row("Dimming",r`
          <select class="ec-select"
            @change=${i=>this._setPopupDimming(i.target.value,Ue)}
          >
            ${t===void 0?r`<option value="" selected>Custom</option>`:_}
            ${Object.keys(ae).map(i=>r`
              <option value=${i} .selected=${t===i}>${ae[i].label} — ${ae[i].hint}</option>`)}
          </select>`)}
    ...
    `}_setPopupDimming(e,t=Xt){if(!(e in ae))return;const i=ae[e].values,o={};for(const s of t)o[s]=v(s)===i[s]?void 0:i[s];this._updateDefaults(o)}static _custName(e){return e.trim().replace(/[^a-zA-Z0-9_-]/g,"_")}_custDuplicateNames(){const e=new Set,t=new Set;for(const[i]of lt(this._config?.defaults)){const o=i.slice(9);e.has(o)&&t.add(o),e.add(o)}return t}_custNameInput(e,t,i){const o=e!==""&&t.has(e);return r`
    ...
    `}_csNumRow(e,t,i,o,s,a=1,n){const l=v("control_style")?.[o];return this._controlNumRow(i,e[o],typeof l=="number"?String(l):s,c=>t({[o]:c}),a,n)}_csShadowRow(e,t,i,o,s){const a=v("control_style")?.[o];return this._row(i,r`<input class="ec-input" type="text" .value=${e[o]??""}
    ...
    </div>`}static _selectorDefaultsDefs(e){const t=e?"btn":"sel",i=e?"button_option_layout":"option_layout",o=[{key:"sub:container",label:"Field Container",hint:"Sizes, placement, text",icon:"mdi:card-outline",paths:[...F("control_style",te["sub:container"][t]),...F(i,ji)]},{key:"sub:active",label:"Active State",hint:"Colors when the option is active",icon:"mdi:circle-slice-8",paths:F("control_style",te["sub:active"][t])},{key:"sub:inactive",label:"Inactive State",hint:"Colors when the option is inactive",icon:"mdi:circle-outline",paths:F("control_style",te["sub:inactive"][t])}];return e?o:[...o,{key:"sub:separation",label:"Option Separation",hint:"Frame border, gap, per-option style",icon:"mdi:dots-grid",paths:F("control_style",tt)}]}_selectorDefaultsMenu(e){return this._navMenu(p._selectorDefaultsDefs(e==="cd:button"),this._defaultsScope())}_selectorDefaultsSection(e,t){return r`
    ...
    </div>`}_variantOptions(e,t){const i=s=>r`<option value=${s.id} .selected=${t===s.id}>${s.label}</option>`,o=Jt(e);return o.length?r`
      <optgroup label="Built-in">${Et(e).map(i)}</optgroup>
      <optgroup label="Custom">${o.map(i)}</optgroup>
    `:r`${Ae(e).map(i)}`}_updateVariants(e,t){const i=this._config?.defaults?.control_variants??{},o={...i,[e]:t([...i[e]??[]])};for(const a of Object.keys(o))o[a]?.length||delete o[a];const s=Object.keys(o).length?o:void 0;this._updateDefaults({control_variants:s}),Me(s)}_controlVariantsSection(){const e=this._config?.defaults?.control_variants??{},t=Ct.filter(o=>(e[o]??[]).length>0),i=t.reduce((o,s)=>o+(e[s]?.length??0),0);return r`
      <div class="ec-section">
        <p class="ec-hint">
        ...
        ${i===0?r`<p class="ec-empty">No custom variants yet.</p>`:t.map(o=>r`
              <div class="ec-subsection-title">${_e[o]}</div>
    ...
    `}_variantRow(e,t,i){const o=`${e}:${t.id}`,s=this._variantOpen===o,a=l=>this._updateVariants(e,c=>c.map((d,h)=>h===i?{...d,...l}:d)),n=Object.keys(t.preset??{}).length;return r`
      <div class="ec-list-row" style="flex-direction:column;align-items:stretch;gap:6px;">
        <div style="display:flex;align-items:center;gap:6px;">
          <ha-icon icon=${t.icon||ve[e]}></ha-icon>
          ...
          <button class="ec-btn-add" style="padding:2px 8px;" title="Duplicate"
            @click=${()=>{const l=Se(e,`${t.id}_copy`);this._updateVariants(e,c=>[...c,{...t,id:l,label:`${t.label} (copy)`}]),this._variantOpen=`${e}:${l}`}}
          >⧉</button>
...
Fields already using it keep their current settings — they just lose the link to this variant.`)&&this._updateVariants(e,l=>l.filter((c,d)=>d!==i))}}
        ...
        ${s?r`
          ...
          ${this._row("Icon",this._iconPicker(t.icon,l=>a({icon:l}),ve[e]))}
    ...
    `}_controlStyleUsesGlobal(e,t){const i=e.control_style,o=p._separationOnly(i);return i===void 0||!this._colorOverridesOn.has(t)&&o!==void 0&&Object.keys(i).length===Object.keys(o).length}static _fscsDefs(e){const t=e?"btn":"sel";return[{key:"fscs:container",label:"Field Container",hint:"Border, radius, font sizes",icon:"mdi:card-outline",paths:F("control_style",p._containerPathsForField(t))},{key:"fscs:active",label:"Active State",hint:"Colors when the option is active",icon:"mdi:circle-slice-8",paths:F("control_style",te["sub:active"][t])},{key:"fscs:inactive",label:"Inactive State",hint:"Colors when the option is inactive",icon:"mdi:circle-outline",paths:F("control_style",te["sub:inactive"][t])}]}_fieldSecControlStyle(e,t,i,o=!1){const s=this._updFor(e,t,o),a=this._idFor(e,t,o),n=i.control_style,l=u=>s({control_style:{...i.control_style,...u}}),c=p._separationOnly(n),d=this._controlStyleUsesGlobal(i,a),h=i.type==="button_group"||i.type==="button";return r`
      <div class="ec-section">
        ...
        ${i.control_box!==void 0?this._boxRows(`${a}-ctlbox`,i.control_box,u=>s({control_box:{...i.control_box,...u}}),yt):_}
    ...
    `}_defaultsSecLayout(){const e=this._config?.defaults??{};return r`
      <div class="ec-section">
          ...
          ${this._row("Card columns",r`<select class="ec-select"
            ...
            </select>`,"How many columns a card's fields flow into unless the card sets its own.")}

          ${this._numRow("Field gap (px)",{value:e.field_gap,onChange:t=>this._updateDefaults({field_gap:t}),min:0,placeholder:"4",hint:"Vertical space between fields, on every card that does not set its own."})}
          ${this._numRow("Column gap (px)",{value:e.column_gap,onChange:t=>this._updateDefaults({column_gap:t}),min:0,placeholder:"3",hint:"Horizontal space between field columns, on every card that does not set its own."})}
      </div>
    `}_elemLibMenu(){const e=p._ELEM_LIB_SECTIONS,t=this._currentListFilter(),i=this._config?.defaults;return r`
      ...
      ${e.filter(o=>!t||o.label.toLowerCase().includes(t)).map(o=>this._navBtn(o.key,o.label,o.hint,o.icon,Be(i,o.paths)))}
    `}_elemLibSection(e){let t;switch(e){case"el:thermo-v":t=this._elemThermoV();break;case"el:thermo-h":t=this._elemThermoH();break;case"el:bat-h":t=this._elemBatH();break;case"el:bat-v":t=this._elemBatV();break;case"el:tank-cyl":t=this._elemTankCyl();break;case"el:tank-water":t=this._elemTankWater();break;case"el:tank-ferm":t=this._elemTankFerm();break;case"el:tank-cone":t=this._elemTankCone();break;case"el:inverter":t=this._elemInverter();break;case"el:gauge-arc":t=this._elemGaugeArc();break;default:return r``}const i=p.ELEM_CSS_KEY[e],o=this._config?.defaults??{};return r`
      ...
      <div class="ec-section">
              ...
              ${this._row("Tick color",this._colorPicker("d-thermo-tc",e.thermo_tick_color,t=>this._updateDefaults({thermo_tick_color:t||void 0})),G.tick_color)}
              ${this._row("Tick position",r`<select class="ec-select"
              ...
              ${this._row("Minor tick text",r`<input type="checkbox" class="ec-checkbox"
                  ...
                  @change=${t=>this._updateDefaults({thermo_show_minor_tick_text:t.target.checked})} />`,G.minor_tick_text)}
              ${this._numRow("Tick font size",{hint:G.tick_font_size,value:e.thermo_tick_font_size,onChange:t=>this._updateDefaults({thermo_tick_font_size:t}),min:1,max:20,step:.5,placeholder:"4"})}
              ...
              ${this._row("Grid line color",this._colorPicker("d-thermo-gc",e.thermo_grid_color,t=>this._updateDefaults({thermo_grid_color:t||void 0})),G.grid_color)}
              ...
              <p class="ec-hint">How visible the tube is above the current reading — 0 hides the empty part
                entirely, 1 draws it in full.</p>
              ${this._numRow("Decimals",{hint:G.decimals,value:e.thermo_decimals,onChange:t=>this._updateDefaults({thermo_decimals:t}),min:0,max:4,step:1,placeholder:"1"})}
              ${this._row("Temperature value color",this._colorPicker("d-thermo-ttc",e.thermo_temp_color,t=>this._updateDefaults({thermo_temp_color:t||void 0})),G.temp_color)}
    ...
    `}_elemThermoH(){const e=this._config?.defaults??{};return r`
      <div class="ec-section">
              <div class="ec-subsection-title">…– ticks</div>
              ${this._row("Tick color",this._colorPicker("d-thermo-h-tc",e.thermo_h_tick_color,t=>this._updateDefaults({thermo_h_tick_color:t||void 0})),G.tick_color)}
              ${this._row("Tick position",r`<select class="ec-select"
              ...
              ${this._row("Minor tick text",r`<input type="checkbox" class="ec-checkbox"
                  ...
                  @change=${t=>this._updateDefaults({thermo_h_show_minor_tick_text:t.target.checked})} />`,G.minor_tick_text)}
              ${this._numRow("Tick font size",{hint:G.tick_font_size,value:e.thermo_h_tick_font_size,onChange:t=>this._updateDefaults({thermo_h_tick_font_size:t}),min:1,max:20,step:.5,placeholder:"4"})}
              ...
              ${this._row("Grid line color",this._colorPicker("d-thermo-h-gc",e.thermo_h_grid_color,t=>this._updateDefaults({thermo_h_grid_color:t||void 0})),G.grid_color)}
              <div class="ec-subsection-title">Fill &amp; temperature</div>
              ...
              <p class="ec-hint">How visible the tube is above the current reading — 0 hides the empty part
                entirely, 1 draws it in full.</p>
              ${this._numRow("Decimals",{hint:G.decimals,value:e.thermo_h_decimals,onChange:t=>this._updateDefaults({thermo_h_decimals:t}),min:0,max:4,step:1,placeholder:"1"})}
              ${this._row("Temperature value color",this._colorPicker("d-thermo-h-ttc",e.thermo_h_temp_color,t=>this._updateDefaults({thermo_h_temp_color:t||void 0})),G.temp_color)}
...
This overwrites those values on the popover defaults, and is a one-off — the two do not stay linked.`))return;const s={};for(const a of t)s[a]=e[a];this._updateExtDefaults({card:{...this._config?.extended_card_defaults?.card,...s}}),this._showUndoToast(`${o} value${o===1?"":"s"} copied from Mosaic Card Defaults`)}}>⧉ Copy styling from Mosaic Card Defaults</button>
    ...
    `:r`<p class="ec-hint">Nothing to copy — <b>Mosaic Card Defaults</b> has no box styling set.</p>`}_popoverDimmingRows(){const e=this._config?.defaults??{},t=dt(e,Ve);return r`
      ...
      ${this._row("Dimming",r`
        <select class="ec-select"
          @change=${i=>this._setPopupDimming(i.target.value,Ve)}
        >
          ${t===void 0?r`<option value="" selected>Custom</option>`:_}
          ${Object.keys(ae).map(i=>r`
            <option value=${i} .selected=${t===i}>${ae[i].label} — ${ae[i].hint}</option>`)}
    ...
    `}_renderExtFieldList(e,t){const i=t.fields;return r`
      <div class="ec-section ec-section--fields">
        ...
        ${this._listFilterBox(i.length)}
        ${i.length===0?this._emptyAdd("No fields yet — add one",()=>this._addExtField(e)):i.map((o,s)=>({f:o,efi:s})).filter(({f:o})=>{const s=this._currentListFilter();return!s||`${this._fieldName(o)} ${this._fieldSub(o)}`.toLowerCase().includes(s)}).map(({f:o,efi:s})=>this._itemCard({dragKey:`extfield:${e}:${s}`,icon:ve[o.type],label:this._fieldName(o),sub:this._fieldSub(o),selected:s===this._selExtField,onClick:()=>{this._selExtField=s,this._navPush(`field:${o.id}`,`Field ${s+1}`)},actions:r`
    ...
    `}_extFieldHeader(e,t,i){const o=s=>this._updateExtField(e,t,s);return r`
        ...
        ${this._row("Type",r`<select class="ec-select"
            .value=${i.type==="graph"?"svg":i.type}
            @change=${s=>{const a=s.target.value;if(q(a)){const n=ct(a);if(n&&!this._confirmVariantOptionLoss(i,a,n)){s.target.value=i.type==="graph"?"svg":i.type;return}o({type:a,...n?ke(a,n):{}})}else o({type:a}),a==="svg"&&this._openGGPicker(e,t,!0)}}
          >
            ${ft.map(s=>r`<option value=${s} .selected=${(i.type==="graph"?"svg":i.type)===s}>${_e[s]}</option>`)}
          </select>`)}

        ${q(i.type)&&Ae(i.type).length>1?this._row("Variant",r`<select class="ec-select"
            .value=${i.variant??""}
            @change=${s=>{const a=s.target.value;if(!this._confirmVariantOptionLoss(i,i.type,a)){s.target.value=i.variant??"";return}o(ke(i.type,a))}}
          >
            ${this._variantOptions(i.type,i.variant)}
          </select>`):_}
    ...
    `}_renderBackgroundControls(){if(!this._config)return r``;const e=this._config.background??{},t=e.source??"auto";return r`
          ...
          ${(()=>{const i=Math.max(0,this._config?.ev_count??0),o=Array.from({length:i+1},(s,a)=>String(a));return["day","night"].map(s=>r`
              <div class="ec-subsection-title ec-subsection-title--minor">${s}</div>
              ${o.map(a=>this._row(`${s} / ${a} EV`,r`<input class="ec-input" type="text"
                  .value=${e.images?.[s]?.[a]??""}
                  placeholder="https://…"
                  @change=${n=>this._setBgImage(s,a,n.target.value)}
                />`))}
            `)})()}
    `}_renderTemplatesRibbonPanel(){const e=this._navPath;return e.length===0?this._navMenu(p._TEMPLATE_SECTIONS):e[0].key==="sec:import"?this._templatesSecImport():e[0].key==="sec:varexport"?this._templatesSecVariantExport():e[0].key==="sec:varimport"?this._templatesSecVariantImport():e[0].key==="sec:export"?this._templatesSecExport():(console.warn(`[mosaic-canvas-card] Templates panel: unknown section key "${e[0].key}"`),this._navDeadEnd("This editor screen is unavailable — press Back to recover."))}_templatesSecVariantExport(){const e=this._config?.defaults?.control_variants??{},t=Object.values(e).reduce((i,o)=>i+(o?.length??0),0);return r`
      <div class="ec-section">
        ...
        ${t===0?r`<p class="ec-empty">No custom variants to export.</p>`:r`
            ...
            <button class="ec-btn-add" style="width:100%;"
              @click=${()=>Ti(Ei(e,this._templateName||"Mosaic Control Variants"))}
    ...
    `}_templatesSecVariantImport(){return this._config?r`
      <div class="ec-section">
        ...
        <input type="file" accept=".json,application/json" style="display:none" id="ec-variant-import"
          @change=${e=>{const t=e.target.files?.[0];if(e.target.value="",!t||!this._config)return;const i=new FileReader;i.onload=o=>{const{pack:s,error:a}=zi(o.target?.result);if(a||!s){this._variantImportError=a??"Unknown error.";return}const n=this._config?.defaults?.control_variants??{},{merged:l,added:c,renamed:d}=Ri(n,s);if(c===0){this._variantImportError="That file contained no control variants.";return}const h=d>0?`Import ${c} variant(s) from "${s.name}"?

${d} had an id already in use and will be imported under a new id.`:`Import ${c} variant(s) from "${s.name}"?`;window.confirm(h)&&(this._variantImportError="",this._updateDefaults({control_variants:l}),Me(l))},i.readAsText(t)}}
        />
        <button class="ec-btn-add" style="width:100%;"
    ...
    `:r``}_templatesSecExport(){return this._config?r`
      <div class="ec-section">
          ...
          <button class="ec-btn-add" style="width:100%;margin-bottom:12px;"
            @click=${()=>{if(!this._config)return;const e=$i(this._config,this._templateName||"Mosaic Canvas Template",{includeEntities:this._templateIncludeEntities});ki(e)}}
    ...
    `:r``}_templatesSecImport(){return this._config?r`
      <div class="ec-section">
          ...
          <input type="file" accept=".json,application/json"
            ...
            @change=${e=>{const t=e.target.files?.[0];if(!t||!this._config)return;const i=new FileReader;i.onload=o=>{const s=o.target?.result,{template:a,error:n}=Si(s);if(n||!a){this._templateError=n??"Unknown error.";return}window.confirm(`Import "${a.name}"?

This will replace your entire card configuration.`)&&(this._templateError="",this._emit(Ci(a,this._config.type)))},i.readAsText(t),e.target.value=""}}
          />
          <button class="ec-btn-add" style="width:100%;"
          ...
          ${t.stat_characteristic&&t.entity?r`
            <div class="ec-stat-yaml">
              <div class="ec-stat-yaml-header">
                <span>HA configuration.yaml</span>
                <button class="ec-btn-copy" title="Copy YAML"
                  @click=${()=>{const i=ze(t.entity,t.stat_characteristic,t.stat_max_age_hours,t.stat_sampling_size,t.stat_percentile);navigator.clipboard.writeText(i)}}>⎘ Copy</button>
              </div>
              <pre class="ec-stat-yaml-code">${ze(t.entity,t.stat_characteristic,t.stat_max_age_hours,t.stat_sampling_size,t.stat_percentile)}</pre>
            </div>
          `:_}
      </div>
    ...
    `}_zoneScope(e){return{root:this._zones()[e],apply:t=>this._updateZone(e,t)}}_renderZonesRibbonPanel(){const e=this._navPath,t=this._zones();if(e.length===0)return r`
        ...
        ${t.length===0?this._emptyAdd("No clickable zones yet — add one",()=>this._addZone()):t.map((a,n)=>this._itemCard({dragKey:`zone:${n}`,icon:"mdi:gesture-tap-box",label:a.name??a.id,sub:`${a.width}×${a.height}px`,selected:n===this._selZone,onClick:()=>{this._selZone=n,this._navPush(`zone:${a.id}`,a.name??a.id)},actions:r`
                ...
                <button class="ec-btn-remove"
                  ...
                  title="Remove">✕</button>
              `}))}
      `;const i=this._crumbIndex(e[0].key,t);this._selZone=i;const o=t[i];if(!o)return this._navDeadEnd();if(e.length===1)return this._navMenu(p._ZONE_SECTIONS,this._zoneScope(i));const s=this._clearOverridesBtn(p._findDef(p._ZONE_SECTIONS,e[1].key),this._zoneScope(i));return e[1].key==="sec:actions"?r`${s}${this._zoneSecActions(i,o)}`:r`${s}${this._zoneSecDefaults(i,o)}`}_zoneSecDefaults(e,t){const{totalW:i,totalH:o}=K(this._config);return r`
      <div class="ec-section">
              ${this._row("Name",r`<input class="ec-input" type="text" .value=${t.name??""}
              ...
              ${this._row("Anchor",r`<select class="ec-select"
                ...
                >
                  ${Pe.map(s=>r`<option value=${s} .selected=${(t.anchor??v("anchor")??"top-left")===s}>${He[s]}</option>`)}
    ...
    `}_embSecPos(e,t){const{totalW:i,totalH:o}=K(this._config);return r`
      <div class="ec-section">
        ${this._row("X (px)",r`${this._numWrap(r`<input class="ec-input ec-input-num" type="number"
            .value=${String(Math.round(t.position.x*i))}
    ...
    `}_renderGGModal(){if(!this._ggOpen)return _;const e=n=>r`<img class="ec-lib-preview" src="${kt+n}" alt=""
        ...
        <div class="ec-lib-grid">
          ${i.map(n=>r`
            <button class="ec-lib-item" title="${n.label}"
              @click=${()=>this._pickGG("svg",{svg:kt+n.file,fill_direction:n.fill_direction,width:n.width,height:n.height,...n.thresholds?{thresholds:n.thresholds}:{}})}>
              ${e(n.file)}
    ...
    `}_colorPicker(e,t,i,o){const s=t??"",a=this._cpOpenId===e,{base:n,alpha:l}=Zi(s),c=/^#[0-9a-fA-F]{6}$/.test(n)?n:n?Xi(n,this):"#000000",d=s||"transparent",h=o?.clearable!==!1&&t!=null,u=["#ff0000","#ff4500","#ff8800","#ffff00","#00ff00","#00ff7f","#00ffff","#0000ff","#9400d3","#ff00ff","#ffffff","#00d4ff","#22c55e","#888888","#333333","#000000"],g=parseInt(c.slice(1,3),16),b=parseInt(c.slice(3,5),16),f=parseInt(c.slice(5,7),16),P=($,C,N)=>`#${[$,C,N].map(Y=>Math.max(0,Math.min(255,Y)).toString(16).padStart(2,"0")).join("")}`,T=n!==""&&!/^#[0-9a-fA-F]{6}$/.test(n)&&!/^rgb/i.test(n),k=($,C)=>{if(C>=1){i($);return}const N=parseInt($.slice(1,3),16),Y=parseInt($.slice(3,5),16),j=parseInt($.slice(5,7),16);i(`rgba(${N},${Y},${j},${Number(C.toFixed(3))})`)},x=$=>{T?i(St(n,$)):k(c,$)};return r`
      <div class="ec-cp-wrap" @keydown=${$=>{$.key!=="Escape"||this._cpOpenId!==e||($.preventDefault(),$.stopPropagation(),this._cpOrigValue!==t&&i(this._cpOrigValue),this._cpOpenId=null)}}>
        <div class="ec-color-row">
          <button class="ec-color-swatch-btn" title="Open color picker"
            style="--mce-swatch:${d}"
            @click=${$=>{if($.stopPropagation(),!a){const C=$.currentTarget.getBoundingClientRect();this._cpOpenAbove=window.innerHeight-C.bottom<340,this._cpOrigValue=t}this._cpOpenId=a?null:e}}
          ></button>
          <input type="text" class="ec-color-text"
            .value=${s}
            placeholder="#rrggbb · rgb() · name"
            @change=${$=>{const C=$.target.value.trim();i(C||void 0)}}
          />
        ...
        ${a?r`
          ...
          <div class="ec-cp-popup${this._cpOpenAbove?" ec-cp-popup--above":""}"
            ...
            ></hex-color-picker>
            <div class="ec-cp-rgb">
              ${["R","G","B"].map(($,C)=>{const N=[g,b,f][C];return r`<label class="ec-cp-rgb-label">${$}
                  <input type="number" class="ec-cp-rgb-input" min="0" max="255"
                    .value=${String(N)}
                    @change=${Y=>{const j=Number(Y.target.value);k(P(C===0?j:g,C===1?j:b,C===2?j:f),l)}}
                  />
                </label>`})}
            </div>
            ...
            <div class="ec-cp-alpha">
              ...
              <div class="ec-opacity-row">
                <input type="range" min="0" max="1" step="0.01"
                  .value=${String(l)}
                  @input=${$=>x(parseFloat($.target.value))}
                />
    ...
    `}_renderCpVars(e,t=1){const i=this._config?.defaults?.custom_colors??[],o=s=>{e(St(s,t)),this._cpOpenId=null};return r`
...
--md-*/--mdc-* it maps to
    ...
    `];y([ti({attribute:!1})],p.prototype,"hass",2);y([w()],p.prototype,"_config",2);y([w()],p.prototype,"_selCard",2);y([w()],p.prototype,"_selField",2);y([w()],p.prototype,"_selCards",2);y([w()],p.prototype,"_selEmbCards",2);y([w()],p.prototype,"_groupColGap",2);y([w()],p.prototype,"_groupRowGap",2);y([w()],p.prototype,"_selFlow",2);y([w()],p.prototype,"_showAddFlowInput",2);y([w()],p.prototype,"_newFlowName",2);y([w()],p.prototype,"_pendingFlowIdx",2);y([w()],p.prototype,"_showFlowCompleteModal",2);y([w()],p.prototype,"_selPoint",2);y([w()],p.prototype,"_selSeries",2);y([w()],p.prototype,"_selOption",2);y([w()],p.prototype,"_selExtOption",2);y([w()],p.prototype,"_selExtSeries",2);y([w()],p.prototype,"_selVirtual",2);y([w()],p.prototype,"_selVirtualInput",2);y([w()],p.prototype,"_selTrigger",2);y([w()],p.prototype,"_selZone",2);y([w()],p.prototype,"_selExtCard",2);y([w()],p.prototype,"_selExtField",2);y([w()],p.prototype,"_templateName",2);y([w()],p.prototype,"_templateIncludeEntities",2);y([w()],p.prototype,"_templateError",2);y([w()],p.prototype,"_previewBoxes",2);y([w()],p.prototype,"_previewExpanded",2);y([w()],p.prototype,"_barAtTop",2);y([w()],p.prototype,"_copiedFields",2);y([w()],p.prototype,"_copySourceId",2);y([w()],p.prototype,"_virtualClipboard",2);y([w()],p.prototype,"_copiedField",2);y([w()],p.prototype,"_copiedFieldSrc",2);y([w()],p.prototype,"_copiedOption",2);y([w()],p.prototype,"_dragSrc",2);y([w()],p.prototype,"_cpOpenId",2);y([w()],p.prototype,"_cpOpenAbove",2);y([w()],p.prototype,"_ggOpen",2);y([w()],p.prototype,"_wizStep",2);y([w()],p.prototype,"_wiz",2);y([w()],p.prototype,"_bgSelected",2);y([w()],p.prototype,"_selEmbCard",2);y([w()],p.prototype,"_embEditorOpen",2);y([w()],p.prototype,"_embEditorYaml",2);y([w()],p.prototype,"_embEditorYamlError",2);y([w()],p.prototype,"_embNativeEditor",2);y([w()],p.prototype,"_embPickerOpen",2);y([w()],p.prototype,"_embPickerSearch",2);y([w()],p.prototype,"_variantOpen",2);y([w()],p.prototype,"_variantError",2);y([w()],p.prototype,"_saveVariantFor",2);y([w()],p.prototype,"_saveVariantLabel",2);y([w()],p.prototype,"_variantImportError",2);y([w()],p.prototype,"_navTab",2);y([w()],p.prototype,"_navPanel",2);y([w()],p.prototype,"_navPath",2);y([w()],p.prototype,"_listFilter",2);y([w()],p.prototype,"_toastMsg",2);y([w()],p.prototype,"_tutorialStep",2);y([w()],p.prototype,"_dropKey",2);y([w()],p.prototype,"_dropBefore",2);y([w()],p.prototype,"_searchQuery",2);y([w()],p.prototype,"_searchActive",2);y([w()],p.prototype,"_healthShowIgnored",2);y([w()],p.prototype,"_cpMode",2);p=y([ii(oi)],p);export{p as MosaicCanvasEditor};
