...
It also resets Global Defaults to their starting values — including your saved custom control variants — and clears the popover card defaults and EV count.`)&&(this._wiz={cardType:"",source:"auto",sunEntity:"sun.sun",dayImg:"",nightImg:"",evCount:0,evImgs:[],bgCount:"single",bgSwitchMode:"sun",bgEntity:"",singleImg:""},this._wizStep=0,this._emit({type:this._config.type,background:{},canvas:{},defaults:{font_family:"sans-serif",card:{background:"rgba(8,18,28,0.55)",border:!0,color:"#00d4ff",radius:10,padding:8},label:{font_size:13,color:"#cccccc"},value:{font_size:22,color:"#ffffff",font_weight:600}},cards:[]}))},this._cpMode="rgb"}_navPush(e,t,i){this._navPath=[...this._navPath,{key:e,label:t,...i?{hint:i}:{}}]}_crumbIndex(e,t){if(!t)return-1;const i=e.slice(e.indexOf(":")+1),o=t.findIndex(a=>{const n=a&&typeof a=="object"?a.id:void 0;return n!==void 0&&String(n)===i});if(o>=0)return o;const s=Number(i);return Number.isInteger(s)&&s>=0&&s<t.length?s:-1}_navScrollKey(){return`${this._navTab}|${this._navPanel}|${this._navPath.map(e=>e.key).join("/")}`}_navDeadEnd(e="This item no longer exists — it may have been removed in the YAML editor."){return r`
    ...
    `}_updateCard(e,t){if(!this._config)return;const i=this._config.cards.map((o,s)=>s===e?H(o,t):o);this._emit({...this._config,cards:i})}_updateCardBox(e,t){if(!this._config)return;const i=this._config.cards[e];i&&this._updateCard(e,{box:H(i.box??{},t)})}_updateField(e,t,i){if(!this._config)return;const o=this._config.cards[e];if(!o)return;const s=o.fields.map((a,n)=>n===t?H(a,i):a);this._updateCard(e,{fields:s})}_updateDefaults(e){this._config&&this._emit({...this._config,defaults:H(this._config.defaults,e)})}_updateCanvas(e){this._config&&this._emit({...this._config,canvas:H(this._config.canvas,e)})}_gridGeom(){const e=this._config?.canvas;if(e?.layout_mode!=="grid"||!e.grid)return null;const{totalW:t,totalH:i}=K(this._config),o=Math.max(1,e.grid.columns||1),s=Math.max(1,e.grid.rows||1),a=e.grid.padding??0;return{cols:o,rows:s,padding:a,cellW:t/o,cellH:i/s,totalW:t,totalH:i}}_setLayoutMode(e){if(!this._config)return;const t={...this._config.canvas??{}};if(t.layout_mode=e,e==="grid"){t.grid||(t.grid={columns:10,rows:15,padding:0});const i=Math.max(1,t.grid.columns),o=Math.max(1,t.grid.rows),s=t.grid.padding??0,{totalW:a}=K(this._config),n=a/i,l=this._config.cards.map(h=>{const u=this._previewBoxes[h.id],g=u?u.x+u.w/2:h.position.x,b=u?u.y+u.h/2:h.position.y,w=Math.min(i,Math.max(0,Math.round(g*i))),P=Math.min(o,Math.max(0,Math.round(b*o))),T=h.grid_span??Math.max(1,Math.min(i,Math.round((u?.w??0)*i)||1)),k=Math.max(8,T*n-s);return{...h,anchor:"center",grid_span:T,width:k,position:{x:z(w/i),y:z(P/o)}}}),c=this._embCards().map(h=>{const u=this._previewBoxes[h.id],g=u?u.x+u.w/2:h.position.x,b=u?u.y+u.h/2:h.position.y,w=Math.min(i,Math.max(0,Math.round(g*i))),P=Math.min(o,Math.max(0,Math.round(b*o))),T=h.grid_span??Math.max(1,Math.min(i,Math.round((u?.w??0)*i)||1)),k=Math.max(8,T*n-s);return{...h,anchor:"center",grid_span:T,width:k,position:{x:z(w/i),y:z(P/o)}}});this._emit({...this._config,canvas:t,cards:l,embedded_cards:c});const d=l.length+c.length;d&&this._showUndoToast(`${d} card${d===1?"":"s"} re-laid out for Grid`)}else this._emit({...this._config,canvas:t})}_renderGridOverlay(){const e=this._gridGeom();if(!e)return _;const{cols:t,rows:i}=e,o=[];for(let s=0;s<=t;s++)for(let a=0;a<=i;a++)o.push(r`<div class="ec-grid-dot" style="left:${s/t*100}%;top:${a/i*100}%;"></div>`);return r`<div class="ec-grid-overlay">${o}</div>`}_renderBgOverlay(){if(!this._config)return _;const e=K(this._config),t=e.L/e.totalW*100,i=e.T/e.totalH*100,o=e.baseW/e.totalW*100,s=e.baseH/e.totalH*100;return r`
        ...
        >
          ...
          ${this._flows().length>0?r`
            <svg class="ec-flow-paths-overlay" viewBox="0 0 1 1" preserveAspectRatio="none">
              ...
              ${this._flows().map((o,s)=>{const a=o.points.map(l=>ue(l,i,this._previewBoxes)).map(l=>`${l.x},${l.y}`).join(" "),n=s===this._selFlow;return Ht`
                  <polyline
                    class="ec-flow-hit"
                    points="${a}"
                    fill="none"
...
`)}`)}_itemCard(e){const{dragKey:t,icon:i,label:o,sub:s,selected:a,multi:n,onClick:l,actions:c}=e,d=this._dropKey===t;return r`
    ...
    `}_renderPanelBody(){switch(this._navPanel){case"mosaic":return this._renderMosaicPanel();case"popover":return this._renderPopoverPanel();case"embedded":return this._renderEmbeddedPanel();case"flows":return this._renderFlowsRibbonPanel();case"zones":return this._renderZonesRibbonPanel();case"virtuals":return this._renderVirtualsRibbonPanel();case"canvas":return this._renderCanvasRibbonPanel();case"defaults":return this._renderDefaultsRibbonPanel();case"templates":return this._renderTemplatesRibbonPanel();case"health":return this._renderHealthPanel();case"about":return this._renderAboutPanel();default:return r``}}_renderAboutPanel(){return r`
      <div class="ec-section ec-about">
        <div class="ec-about-version">Mosaic Canvas Card v${Je} · build ${Wt}</div>
      ...
      <div class="ec-cp-wrap" @keydown=${$=>{$.key!=="Escape"||this._cpOpenId!==e||($.preventDefault(),$.stopPropagation(),this._cpOrigValue!==t&&i(this._cpOrigValue),this._cpOpenId=null)}}>
        ...
        ${a?r`
          ...
          <div class="ec-cp-popup${this._cpOpenAbove?" ec-cp-popup--above":""}"
            ...
            ></hex-color-picker>
            <div class="ec-cp-rgb">
              ${["R","G","B"].map(($,C)=>{const N=[g,b,w][C];return r`<label class="ec-cp-rgb-label">${$}
                  <input type="number" class="ec-cp-rgb-input" min="0" max="255"
                    .value=${String(N)}
                    @change=${Y=>{const j=Number(Y.target.value);k(P(C===0?j:g,C===1?j:b,C===2?j:w),l)}}
                  />
                </label>`})}
            </div>
...
--md-*/--mdc-* it maps to
    ...
    `];f([ti({attribute:!1})],p.prototype,"hass",2);f([y()],p.prototype,"_config",2);f([y()],p.prototype,"_selCard",2);f([y()],p.prototype,"_selField",2);f([y()],p.prototype,"_selCards",2);f([y()],p.prototype,"_selEmbCards",2);f([y()],p.prototype,"_groupColGap",2);f([y()],p.prototype,"_groupRowGap",2);f([y()],p.prototype,"_selFlow",2);f([y()],p.prototype,"_showAddFlowInput",2);f([y()],p.prototype,"_newFlowName",2);f([y()],p.prototype,"_pendingFlowIdx",2);f([y()],p.prototype,"_showFlowCompleteModal",2);f([y()],p.prototype,"_selPoint",2);f([y()],p.prototype,"_selSeries",2);f([y()],p.prototype,"_selOption",2);f([y()],p.prototype,"_selExtOption",2);f([y()],p.prototype,"_selExtSeries",2);f([y()],p.prototype,"_selVirtual",2);f([y()],p.prototype,"_selVirtualInput",2);f([y()],p.prototype,"_selTrigger",2);f([y()],p.prototype,"_selZone",2);f([y()],p.prototype,"_selExtCard",2);f([y()],p.prototype,"_selExtField",2);f([y()],p.prototype,"_templateName",2);f([y()],p.prototype,"_templateIncludeEntities",2);f([y()],p.prototype,"_templateError",2);f([y()],p.prototype,"_previewBoxes",2);f([y()],p.prototype,"_previewExpanded",2);f([y()],p.prototype,"_barAtTop",2);f([y()],p.prototype,"_copiedFields",2);f([y()],p.prototype,"_copySourceId",2);f([y()],p.prototype,"_virtualClipboard",2);f([y()],p.prototype,"_copiedField",2);f([y()],p.prototype,"_copiedFieldSrc",2);f([y()],p.prototype,"_copiedOption",2);f([y()],p.prototype,"_dragSrc",2);f([y()],p.prototype,"_cpOpenId",2);f([y()],p.prototype,"_cpOpenAbove",2);f([y()],p.prototype,"_ggOpen",2);f([y()],p.prototype,"_wizStep",2);f([y()],p.prototype,"_wiz",2);f([y()],p.prototype,"_bgSelected",2);f([y()],p.prototype,"_selEmbCard",2);f([y()],p.prototype,"_embEditorOpen",2);f([y()],p.prototype,"_embEditorYaml",2);f([y()],p.prototype,"_embEditorYamlError",2);f([y()],p.prototype,"_embNativeEditor",2);f([y()],p.prototype,"_embPickerOpen",2);f([y()],p.prototype,"_embPickerSearch",2);f([y()],p.prototype,"_variantOpen",2);f([y()],p.prototype,"_variantError",2);f([y()],p.prototype,"_saveVariantFor",2);f([y()],p.prototype,"_saveVariantLabel",2);f([y()],p.prototype,"_variantImportError",2);f([y()],p.prototype,"_navTab",2);f([y()],p.prototype,"_navPanel",2);f([y()],p.prototype,"_navPath",2);f([y()],p.prototype,"_listFilter",2);f([y()],p.prototype,"_toastMsg",2);f([y()],p.prototype,"_tutorialStep",2);f([y()],p.prototype,"_dropKey",2);f([y()],p.prototype,"_dropBefore",2);f([y()],p.prototype,"_searchQuery",2);f([y()],p.prototype,"_searchActive",2);f([y()],p.prototype,"_healthShowIgnored",2);f([y()],p.prototype,"_cpMode",2);p=f([ii(oi)],p);export{p as MosaicCanvasEditor};
