import{C as at,a as Pt,b as It,s as Vt,i as J,c as Ae,d as b,M as Mt,e as Yt,f as r,A as _,g as Le,h as te,r as me,j as ke,k as jt,T as Ze,l as _t,u as Kt,w as qt,B as Zt,L as Be,m as gt,v as Se,n as Ge,o as Xt,p as Jt,q as Qt,t as ei,x as Ce,y as ti,z as mt,D as Xe,P as de,E as ii,F as Je,G as oi,H as si,I as ai,J as ni,K as ri,N as w,O as li,Q as ci}from"./mosaic-canvas-card.js";const we=(e,t=0,i=1)=>e>i?i:e<t?t:e,q=(e,t=0,i=Math.pow(10,t))=>Math.round(i*e)/i,di=e=>gi(Qe(e)),Qe=e=>(e[0]==="#"&&(e=e.substring(1)),e.length<6?{r:parseInt(e[0]+e[0],16),g:parseInt(e[1]+e[1],16),b:parseInt(e[2]+e[2],16),a:e.length===4?q(parseInt(e[3]+e[3],16)/255,2):1}:{r:parseInt(e.substring(0,2),16),g:parseInt(e.substring(2,4),16),b:parseInt(e.substring(4,6),16),a:e.length===8?q(parseInt(e.substring(6,8),16)/255,2):1}),hi=e=>_i(ui(e)),pi=({h:e,s:t,v:i,a:o})=>{const s=(200-t)*i/100;return{h:q(e),s:q(s>0&&s<200?t*i/100/(s<=100?s:200-s)*100:0),l:q(s/2),a:q(o,2)}},et=e=>{const{h:t,s:i,l:o}=pi(e);return`hsl(${t}, ${i}%, ${o}%)`},ui=({h:e,s:t,v:i,a:o})=>{e=e/360*6,t=t/100,i=i/100;const s=Math.floor(e),a=i*(1-t),n=i*(1-(e-s)*t),l=i*(1-(1-e+s)*t),c=s%6;return{r:q([i,n,a,a,l,i][c]*255),g:q([l,i,i,n,a,a][c]*255),b:q([a,a,l,i,i,n][c]*255),a:q(o,2)}},Ee=e=>{const t=e.toString(16);return t.length<2?"0"+t:t},_i=({r:e,g:t,b:i,a:o})=>{const s=o<1?Ee(q(o*255)):"";return"#"+Ee(e)+Ee(t)+Ee(i)+s},gi=({r:e,g:t,b:i,a:o})=>{const s=Math.max(e,t,i),a=s-Math.min(e,t,i),n=a?s===e?(t-i)/a:s===t?2+(i-e)/a:4+(e-t)/a:0;return{h:q(60*(n<0?n+6:n)),s:q(s?a/s*100:0),v:q(s/255*100),a:o}},At=(e,t)=>{if(e===t)return!0;for(const i in e)if(e[i]!==t[i])return!1;return!0},mi=(e,t)=>e.toLowerCase()===t.toLowerCase()?!0:At(Qe(e),Qe(t)),bt={},Ft=e=>{let t=bt[e];return t||(t=document.createElement("template"),t.innerHTML=e,bt[e]=t),t},nt=(e,t,i)=>{e.dispatchEvent(new CustomEvent(t,{bubbles:!0,detail:i}))};let be=!1;const tt=e=>"touches"in e,bi=e=>be&&!tt(e)?!1:(be||(be=tt(e)),!0),vt=(e,t)=>{const i=tt(t)?t.touches[0]:t,o=e.el.getBoundingClientRect();nt(e.el,"move",e.getMove({x:we((i.pageX-(o.left+window.pageXOffset))/o.width),y:we((i.pageY-(o.top+window.pageYOffset))/o.height)}))},vi=(e,t)=>{const i=t.keyCode;i>40||e.xy&&i<37||i<33||(t.preventDefault(),nt(e.el,"move",e.getMove({x:i===39?.01:i===37?-.01:i===34?.05:i===33?-.05:i===35?1:i===36?-1:0,y:i===40?.01:i===38?-.01:0},!0)))};class Dt{constructor(t,i,o,s){const a=Ft(`<div role="slider" tabindex="0" part="${i}" ${o}><div part="${i}-pointer"></div></div>`);t.appendChild(a.content.cloneNode(!0));const n=t.querySelector(`[part=${i}]`);n.addEventListener("mousedown",this),n.addEventListener("touchstart",this),n.addEventListener("keydown",this),this.el=n,this.xy=s,this.nodes=[n.firstChild,n]}set dragging(t){const i=t?document.addEventListener:document.removeEventListener;i(be?"touchmove":"mousemove",this),i(be?"touchend":"mouseup",this)}handleEvent(t){switch(t.type){case"mousedown":case"touchstart":if(t.preventDefault(),!bi(t)||!be&&t.button!=0)return;this.el.focus(),vt(this,t),this.dragging=!0;break;case"mousemove":case"touchmove":t.preventDefault(),vt(this,t);break;case"mouseup":case"touchend":this.dragging=!1;break;case"keydown":vi(this,t);break}}style(t){t.forEach((i,o)=>{for(const s in i)this.nodes[o].style.setProperty(s,i[s])})}}class fi extends Dt{constructor(t){super(t,"hue",'aria-label="Hue" aria-valuemin="0" aria-valuemax="360"',!1)}update({h:t}){this.h=t,this.style([{left:`${t/360*100}%`,color:et({h:t,s:100,v:100,a:1})}]),this.el.setAttribute("aria-valuenow",`${q(t)}`)}getMove(t,i){return{h:i?we(this.h+t.x*360,0,360):360*t.x}}}class yi extends Dt{constructor(t){super(t,"saturation",'aria-label="Color"',!0)}update(t){this.hsva=t,this.style([{top:`${100-t.v}%`,left:`${t.s}%`,color:et(t)},{"background-color":et({h:t.h,s:100,v:100,a:1})}]),this.el.setAttribute("aria-valuetext",`Saturation ${q(t.s)}%, Brightness ${q(t.v)}%`)}getMove(t,i){return{s:i?we(this.hsva.s+t.x*100,0,100):t.x*100,v:i?we(this.hsva.v-t.y*100,0,100):Math.round(100-t.y*100)}}}const wi=':host{display:flex;flex-direction:column;position:relative;width:200px;height:200px;user-select:none;-webkit-user-select:none;cursor:default}:host([hidden]){display:none!important}[role=slider]{position:relative;touch-action:none;user-select:none;-webkit-user-select:none;outline:0}[role=slider]:last-child{border-radius:0 0 8px 8px}[part$=pointer]{position:absolute;z-index:1;box-sizing:border-box;width:28px;height:28px;display:flex;place-content:center center;transform:translate(-50%,-50%);background-color:#fff;border:2px solid #fff;border-radius:50%;box-shadow:0 2px 4px rgba(0,0,0,.2)}[part$=pointer]::after{content:"";width:100%;height:100%;border-radius:inherit;background-color:currentColor}[role=slider]:focus [part$=pointer]{transform:translate(-50%,-50%) scale(1.1)}',xi="[part=hue]{flex:0 0 24px;background:linear-gradient(to right,red 0,#ff0 17%,#0f0 33%,#0ff 50%,#00f 67%,#f0f 83%,red 100%)}[part=hue-pointer]{top:50%;z-index:2}",$i="[part=saturation]{flex-grow:1;border-color:transparent;border-bottom:12px solid #000;border-radius:8px 8px 0 0;background-image:linear-gradient(to top,#000,transparent),linear-gradient(to right,#fff,rgba(255,255,255,0));box-shadow:inset 0 0 0 1px rgba(0,0,0,.05)}[part=saturation-pointer]{z-index:3}",Te=Symbol("same"),He=Symbol("color"),ft=Symbol("hsva"),We=Symbol("update"),yt=Symbol("parts"),wt=Symbol("css"),xt=Symbol("sliders");class ki extends HTMLElement{static get observedAttributes(){return["color"]}get[wt](){return[wi,xi,$i]}get[xt](){return[yi,fi]}get color(){return this[He]}set color(t){if(!this[Te](t)){const i=this.colorModel.toHsva(t);this[We](i),this[He]=t}}constructor(){super();const t=Ft(`<style>${this[wt].join("")}</style>`),i=this.attachShadow({mode:"open"});i.appendChild(t.content.cloneNode(!0)),i.addEventListener("move",this),this[yt]=this[xt].map(o=>new o(i))}connectedCallback(){if(this.hasOwnProperty("color")){const t=this.color;delete this.color,this.color=t}else this.color||(this.color=this.colorModel.defaultColor)}attributeChangedCallback(t,i,o){const s=this.colorModel.fromAttr(o);this[Te](s)||(this.color=s)}handleEvent(t){const i=this[ft],o={...i,...t.detail};this[We](o);let s;!At(o,i)&&!this[Te](s=this.colorModel.fromHsva(o))&&(this[He]=s,nt(this,"color-changed",{value:s}))}[Te](t){return this.color&&this.colorModel.equal(t,this.color)}[We](t){this[ft]=t,this[yt].forEach(i=>i.update(t))}}const Si={defaultColor:"#000",toHsva:di,fromHsva:({h:e,s:t,v:i})=>hi({h:e,s:t,v:i,a:1}),equal:mi,fromAttr:e=>e};class Ci extends ki{get colorModel(){return Si}}class Ei extends Ci{}customElements.define("hex-color-picker",Ei);const it=1,Ti=/^(entity|entity_id|entities|device_id|area_id)$|_entity$/,ze=e=>typeof e=="string"&&e.startsWith("virtual:");function ot(e){if(Array.isArray(e))return e.map(i=>ot(i));if(typeof e!="object"||e===null)return e;const t={};for(const[i,o]of Object.entries(e))Ti.test(i)?ze(o)?t[i]=o:Array.isArray(o)&&o.some(ze)&&(t[i]=o.filter(ze)):i==="inputs"&&Array.isArray(o)&&o.every(s=>typeof s=="string")?t[i]=o.filter(ze):t[i]=ot(o);return t}function zi(e,t,i={}){const{type:o,...s}=e;return{ec_template:!0,version:it,card_version:at,name:t.trim()||"Mosaic Canvas Template",exported:new Date().toISOString(),config:i.includeEntities===!1?ot(s):s}}function Ri(e){const t=JSON.stringify(e,null,2),i=new Blob([t],{type:"application/json"}),o=URL.createObjectURL(i),s=document.createElement("a");s.href=o,s.download=`${e.name.replace(/[^a-z0-9]+/gi,"_").toLowerCase()}.json`,document.body.appendChild(s),s.click(),document.body.removeChild(s),URL.revokeObjectURL(o)}function Pi(e){let t;try{t=JSON.parse(e)}catch{return{template:null,error:"Invalid JSON — could not parse file."}}if(typeof t!="object"||t===null||!t.ec_template)return{template:null,error:"Not a valid Mosaic Canvas template file."};const i=t;return typeof i.version!="number"?{template:null,error:"Template is missing a version number."}:i.version>it?{template:null,error:`Template schema v${i.version} is newer than this card supports (v${it}). Update the card first.`}:{template:i,error:null}}function Ii(e,t){return{type:t,...e.config}}const Nt=1;function Mi(e,t){return{mosaic_control_variants:!0,version:Nt,card_version:at,name:t.trim()||"Mosaic Control Variants",exported:new Date().toISOString(),variants:e}}function Ai(e){const t=new Blob([JSON.stringify(e,null,2)],{type:"application/json"}),i=URL.createObjectURL(t),o=document.createElement("a");o.href=i,o.download=`${e.name.replace(/[^a-z0-9]+/gi,"_").toLowerCase()}.json`,document.body.appendChild(o),o.click(),document.body.removeChild(o),URL.revokeObjectURL(i)}function Fi(e){let t;try{t=JSON.parse(e)}catch{return{pack:null,error:"File is not valid JSON."}}if(typeof t!="object"||t===null)return{pack:null,error:"File is not a control variant pack."};const i=t;return i.mosaic_control_variants!==!0?{pack:null,error:"File is not a control variant pack. (Card layouts use Import Template instead.)"}:typeof i.version!="number"||i.version>Nt?{pack:null,error:`Pack was made by a newer Mosaic version (schema ${String(i.version)}). Update the card first.`}:typeof i.variants!="object"||i.variants===null?{pack:null,error:"Pack contains no variants."}:{pack:{mosaic_control_variants:!0,version:i.version,card_version:i.card_version??"unknown",name:i.name?.trim()||"Imported variants",exported:i.exported??"",variants:i.variants},error:null}}function Di(e){if(typeof e!="object"||e===null)return!1;const t=e;return typeof t.id=="string"&&t.id.length>0&&typeof t.label=="string"&&t.label.length>0}function Ni(e,t){const i={...e};let o=0,s=0;for(const a of Pt){const n=(t.variants[a]??[]).filter(Di);if(!n.length)continue;const l=[...i[a]??[]],c=new Set([...It(a).map(d=>d.id),...l.map(d=>d.id)]);for(const d of n){let h=d.id;if(c.has(h)){const u=Vt(d.id);let g=2;for(;c.has(`${u}_${g}`);)g++;h=`${u}_${g}`,s++}c.add(h),l.push({...d,id:h}),o++}i[a]=l}return{merged:i,added:o,renamed:s}}const Ot=[{id:"popover-ref",label:"Dangling popover actions",hint:"Open Popover pointing at a card that no longer exists",icon:"mdi:picture-in-picture-bottom-right"},{id:"flow-endpoint",label:"Broken flow endpoints",hint:"Flow point anchored to a removed card",icon:"mdi:chart-timeline-variant"},{id:"no-write-target",label:"Nowhere to write",hint:"A value is set, but there is no entity to write it to",icon:"mdi:pencil-off-outline"},{id:"entity",label:"Missing entities",hint:"Entity not present in Home Assistant",icon:"mdi:database-off-outline"},{id:"virtual-ref",label:"Dangling virtual entities",hint:"A virtual: reference with no matching virtual entity",icon:"mdi:memory"},{id:"unreachable-key",label:"Not editable here",hint:"Set in YAML — this editor offers no screen for it",icon:"mdi:code-braces"},{id:"unpickable-value",label:"Value not offered",hint:"Legal in YAML but absent from this editor's picker",icon:"mdi:format-list-bulleted-type"},{id:"grid-placement",label:"Grid placement problems",hint:"A field outside its card's cells, or sharing one",icon:"mdi:view-grid-outline"}],Oi=Ot.reduce((e,t)=>(e[t.id]=t.icon,e),{}),Li=["entity","attribute"],Ue={card:["id","fields","position","group"],extCard:["id","fields"],field:["id","type","variant","svg","shape","display_name","column","column_end","row","row_end","time_until_layout",...Li],zone:["id"],flow:["id","points"],emb:["id","group"],virtual:["id","inputs"]},Bi=["tap_action","hold_action","double_tap_action"],Gi={tap_action:"Tap action",hold_action:"Hold action",double_tap_action:"Double-tap action"},Hi=Mt;function Lt(e,t){return e!=="field"?Ue[e]:J(t.type)?[...Ue.field,...Hi]:Ue.field}function Wi(e){return Lt("field",e)}const $t="virtual:";function _e(e){return t=>{const i=e.get(t);return i?{key:t,label:i}:{key:t}}}function Ui(e,t,i){const o=[],s=[],a=["Global Defaults and the config root are not scanned for keys this editor cannot reach — their override badges cover that ground instead.","Grid placement is checked for cells outside the card and for two fields sharing one. Whether a field is too big for its cell is not checked — that depends on the rendered text, which this screen cannot measure."],n=[...new Set(Object.values(i.offered).flatMap(f=>Object.keys(f??{})))].sort();if(n.length&&a.push(`Picker values are verified for ${n.join(", ")}. Other dropdowns build their option list inline and are not checked.`),!e)return{issues:o,skipped:s,coverage:a};const l=e.cards??[],c=e.extended_cards??[],d=e.embedded_cards??[],h=e.zones??[],u=e.flows??[],g=e.virtuals??[],v=new Set(l.map(f=>f.id)),m=new Set(c.map(f=>f.id)),z=new Set(g.map(f=>f.id)),R=new Set(e.health_ignore??[]),$=t?.states;$||s.push({check:"entity",reason:"Home Assistant state is not available to the editor yet, so entity references were not verified."});const x=f=>{const E=`${f.check}|${f.ref}|${f.slot}`;o.push({id:E,check:f.check,severity:f.severity,where:f.where,detail:f.detail,icon:Oi[f.check],ignored:R.has(E),...f.target?{target:f.target}:{},...f.removal?{removal:f.removal}:{}})},S=(f,E)=>{if(f){if(f.startsWith($t)){const N=f.slice($t.length);z.has(N)||x({check:"virtual-ref",severity:"error",ref:E.ref,slot:E.slot,where:E.where,detail:`${E.label} points at virtual entity “${N}”, which is not in the Virtual Entities list.`,target:E.target});return}$&&($[f]||x({check:"entity",severity:"error",ref:E.ref,slot:E.slot,where:E.where,detail:`${E.label} is set to “${f}”, which does not exist in Home Assistant.`,target:E.target}))}},k=(f,E)=>{for(const N of Bi){const I=f[N];if(!I)continue;const M=Gi[N],T=`${E.slotPfx??""}${N}`;I.action==="open-extended"&&(I.extended_card_id?m.has(I.extended_card_id)||x({check:"popover-ref",severity:"error",ref:E.ref,slot:T,where:E.where,detail:`${M} opens popover card “${I.extended_card_id}”, which is not in the Popover Cards list.`,target:E.target}):x({check:"popover-ref",severity:"error",ref:E.ref,slot:T,where:E.where,detail:`${M} opens a popover card but names none.`,target:E.target}));const O=[];I.entity&&O.push(I.entity);const L=I.target?.entity_id;typeof L=="string"?O.push(L):Array.isArray(L)&&O.push(...L.filter(W=>typeof W=="string")),O.forEach((W,ae)=>S(W,{ref:E.ref,slot:`${T}.entity.${ae}`,label:`${M} entity`,where:E.where,target:E.target}))}},C=f=>{const E=Lt(f.kind,f.item),N=i.offered[f.kind],I=_e(f.screens.labels);for(const[M,T]of Object.entries(f.item)){if(T===void 0)continue;const O=f.screens.slots.get(M);if(O===void 0){if(E.includes(M))continue;x({check:"unreachable-key",severity:"info",ref:f.ref,slot:M,where:f.where,detail:`“${M}” is set in the YAML but no screen in this editor can show or change it.`,target:f.base,removal:f.removal(M)});continue}const L=N?.[M];L&&typeof T=="string"&&T!==""&&!L.includes(T)&&x({check:"unpickable-value",severity:"info",ref:f.ref,slot:M,where:f.where,detail:`“${M}” is “${T}”, which this editor's picker does not offer — it can only be changed in YAML.`,target:{...f.base,path:[...f.base.path,I(O)]},removal:f.removal(M)})}},F=(f,E,N,I,M,T)=>{const O=f==="popover",L=O?"egs":"gs",W=O?"eopt":"opt",ae=O?"xfield":"field";T.forEach(D=>{const ne=i.fieldName(D),Q=`${E} › ${M} › ${ne}`,B=`${ae}:${I}/${D.id}`,j={key:`field:${D.id}`,label:ne},ee=i.screens("field",D),U=_e(ee.labels),X=(...G)=>({tab:"cards",panel:f,path:[N,j,...G]}),ht=J(D.type),Ut=U(ht?"fsec:control":"fsec:source");S(D.entity,{ref:B,slot:"entity",label:"Entity",where:Q,target:X(Ut)});for(const[G,K]of[["charging_entity","Charging entity"],["tank_pct_entity","Tank % entity"],["tank_volume_entity","Tank volume entity"],["tank_capacity_entity","Tank capacity entity"]])S(D[G],{ref:B,slot:G,label:K,where:Q,target:X(U("fsec:source"))});(D.graph_series??[]).forEach((G,K)=>{const oe=G.label||G.entity||`Series ${K+1}`;S(G.entity,{ref:B,slot:`graph_series.${K}.entity`,label:"Series entity",where:`${Q} › ${oe}`,target:X(U("fsec:series"),{key:`${L}:${K}`,label:oe})})}),(D.options??[]).forEach((G,K)=>{const oe=G.label||G.value||`Option ${K+1}`,pt=`${Q} › ${oe}`,ut=X(U("fsec:options"),{key:`${W}:${K}`,label:oe});S(G.entity,{ref:B,slot:`options.${K}.entity`,label:"Option entity",where:pt,target:ut}),k(G,{ref:B,where:pt,target:ut,slotPfx:`options.${K}.`})});for(const G of["left","center","right"])S(D.slider_labels?.[G]?.entity,{ref:B,slot:`slider_labels.${G}.entity`,label:`${G} track label entity`,where:Q,target:X(U("fsec:sliderpoints"))});if(k(D,{ref:B,where:Q,target:X(U(ht?"fsec:control":"fsec:actions"))}),!D.entity){const G=(D.options??[]).filter(K=>(K.value??"")!==""&&(D.type==="dropdown"||!K.entity)&&!(D.type==="button_group"&&K.tap_action?.action==="open-extended"));if((D.type==="button_group"||D.type==="dropdown")&&G.length){const K=G.length,oe=K===1;x({check:"no-write-target",severity:"error",ref:B,slot:"entity",where:Q,detail:`${K} option${oe?"":"s"} write${oe?"s":""} a value to this field's entity, but the field has none — ${oe?"it renders":"they render"} disabled and can do nothing. ${D.type==="dropdown"?"Set an entity on the field — a dropdown always writes to it and ignores an entity set on the option.":`Give ${oe?"the option its own entity":"each option its own entity"}, or set one on the field.`}`,target:X(U("fsec:options"))})}D.type==="button"&&(D.button_value??"")!==""&&x({check:"no-write-target",severity:"error",ref:B,slot:"button_value",where:Q,detail:`Press writes “${D.button_value}” to this field's entity, but the field has none — the button renders disabled.`,target:X(U("fsec:options"))})}C({kind:"field",item:D,screens:ee,ref:B,where:Q,base:{tab:"cards",panel:f,path:[N,j]},removal:G=>({kind:"field",extended:O,cardId:I,itemId:D.id,key:G})})})},Y=(f,E)=>{if(Ae(f,e.defaults)!=="grid")return;const N=f.grid?.columns??e.defaults?.card_grid_columns??b("card_grid_columns")??4,I=f.grid?.rows??e.defaults?.card_grid_rows??b("card_grid_rows")??4,M=new Map;(f.fields??[]).forEach(T=>{const O=i.fieldName(T),L=`field:${f.id}/${T.id}`,W=`${E.where} › ${O}`,ae={tab:"cards",panel:"mosaic",path:[E.crumb,{key:`field:${T.id}`,label:O}]},D=(B,j)=>x({check:"grid-placement",severity:"error",ref:L,slot:B,where:W,detail:j,target:ae});for(const[B,j,ee,U,X]of[["column",T.column,T.column_end,N,"Column"],["row",T.row,T.row_end,I,"Row"]])j!=null&&(j<1||j>U)&&D(B,`${X} ${j} is outside this card's grid, which is ${U} ${B}${U===1?"":"s"} — the field renders outside the cells the card sizes.`),ee!=null&&(ee>U?D(`${B}_end`,`${X} span ends at ${ee}, past this card's ${U} ${B}${U===1?"":"s"} — the field renders outside the cells the card sizes.`):j!=null&&ee<=j&&D(`${B}_end`,`${X} span ends at ${ee}, which is not past its start of ${j} — the span is ignored and the field occupies one cell.`));if(T.row==null||T.column==null)return;const ne=T.row_end!=null&&T.row_end>T.row?T.row_end:T.row,Q=T.column_end!=null&&T.column_end>T.column?T.column_end:T.column;for(let B=T.row;B<=ne;B++)for(let j=T.column;j<=Q;j++){const ee=`${B},${j}`,U=M.get(ee);if(U&&U!==O){D("row",`Shares row ${B}, column ${j} with “${U}” — both render, one on top of the other.`);return}M.set(ee,O)}})},Z=i.screens("card"),De=_e(Z.labels);l.forEach((f,E)=>{const N=f.name??`Card ${E+1}`,I=`Mosaic Cards › ${N}`,M=`card:${f.id}`,T={key:`card:${f.id}`,label:N},O=L=>({tab:"cards",panel:"mosaic",path:L?[T,De(L)]:[T]});S(f.visible_when?.entity,{ref:M,slot:"visible_when.entity",label:"Visibility condition entity",where:I,target:O("sec:visibility")}),f.bg?.rules?.length&&S(f.bg.entity,{ref:M,slot:"bg.entity",label:"Background image entity",where:I,target:O("sec:bg")}),k(f,{ref:M,where:I,target:O("sec:actions")}),C({kind:"card",item:f,screens:Z,ref:M,where:I,base:O(),removal:L=>({kind:"card",itemId:f.id,key:L})}),F("mosaic","Mosaic Cards",T,f.id,N,f.fields??[]),Y(f,{where:I,crumb:T})});const Ne=i.screens("extCard");c.forEach((f,E)=>{const N=f.name??`Popover Card ${E+1}`,I={key:`card:${f.id}`,label:N};C({kind:"extCard",item:f,screens:Ne,ref:`xcard:${f.id}`,where:`Popover Cards › ${N}`,base:{tab:"cards",panel:"popover",path:[I]},removal:M=>({kind:"extCard",itemId:f.id,key:M})}),F("popover","Popover Cards",I,f.id,N,f.fields??[])});const $e=i.screens("emb");d.forEach((f,E)=>{const N=f.name??f.id??`Embedded ${E+1}`;C({kind:"emb",item:f,screens:$e,ref:`emb:${f.id}`,where:`Embedded External Cards › ${N}`,base:{tab:"cards",panel:"embedded",path:[{key:`emb:${f.id}`,label:N}]},removal:I=>({kind:"emb",itemId:f.id,key:I})})});const ve=i.screens("zone"),Oe=_e(ve.labels);h.forEach((f,E)=>{const N=f.name??f.id??`Zone ${E+1}`,I=`Clickable Zones › ${N}`,M=`zone:${f.id}`,T={key:`zone:${f.id}`,label:N},O=L=>({tab:"elements",panel:"zones",path:L?[T,Oe(L)]:[T]});k(f,{ref:M,where:I,target:O("sec:actions")}),C({kind:"zone",item:f,screens:ve,ref:M,where:I,base:O(),removal:L=>({kind:"zone",itemId:f.id,key:L})})});const dt=i.screens("flow"),Wt=_e(dt.labels);u.forEach((f,E)=>{const N=f.name??f.id??`Flow ${E+1}`,I=`Animated Flow Lines › ${N}`,M=`flow:${f.id}`,T={key:`flow:${f.id}`,label:N},O=(...L)=>({tab:"elements",panel:"flows",path:[T,...L]});S(f.entity,{ref:M,slot:"entity",label:"Entity",where:I,target:O(Wt("sec:defaults"))}),(f.points??[]).forEach((L,W)=>{L.card&&!v.has(L.card)&&x({check:"flow-endpoint",severity:"error",ref:M,slot:`points.${W}`,where:I,detail:`Point ${W+1} is anchored to card “${L.card}”, which no longer exists — the point falls back to the canvas origin.`,target:O({key:`pt:${W}`,label:`Point ${W+1}`})})}),C({kind:"flow",item:f,screens:dt,ref:M,where:I,base:O(),removal:L=>({kind:"flow",itemId:f.id,key:L})})}),g.forEach((f,E)=>{const N=f.name||f.id||`Virtual ${E+1}`,I=`Virtual Entities › ${N}`,M=`virt:${f.id}`,T={key:`virt:${f.id}`,label:N},O=i.screens("virtual",f),L=_e(O.labels),W=(...D)=>({tab:"elements",panel:"virtuals",path:[T,...D]});(f.inputs??[]).forEach((D,ne)=>{S(D,{ref:M,slot:`inputs.${ne}`,label:`Input ${ne+1}`,where:I,target:W({key:`vin:${ne}`,label:D||`Input ${ne+1}`})})}),S(f.entity,{ref:M,slot:"entity",label:"Source entity",where:I,target:W(L("sec:value"))});const ae=L("sec:tu");S(f.value_entity??f.pct_entity,{ref:M,slot:"value_entity",label:"Value entity",where:I,target:W(ae)}),S(f.rate_entity??f.power_entity,{ref:M,slot:"rate_entity",label:"Rate entity",where:I,target:W(ae)}),S(f.capacity_entity,{ref:M,slot:"capacity_entity",label:"Capacity entity",where:I,target:W(ae)}),C({kind:"virtual",item:f,screens:O,ref:M,where:I,base:W(),removal:D=>({kind:"virtual",itemId:f.id,key:D})})});const ie=e.background;if(ie){const E={ref:"background",where:"Canvas › Background",target:{tab:"settings",panel:"canvas",path:[_e(i.screens("canvas").labels)("sec:bg")]}};ie.source==="state"?ie.rules?.length&&S(ie.entity,{...E,slot:"entity",label:"Background image entity"}):ie.source==="entity"?S(ie.mode_entity,{...E,slot:"mode_entity",label:"Mode entity"}):ie.source!=="day"&&ie.source!=="night"&&ie.source!=="single"&&S(ie.sun_entity,{...E,slot:"sun_entity",label:"Sun entity"})}return e.canvas&&k(e.canvas,{ref:"canvas",where:"Canvas",target:{tab:"settings",panel:"canvas",path:[]}}),{issues:o,skipped:s,coverage:a}}function Vi(e){return e.issues.reduce((t,i)=>t+(i.severity==="error"&&!i.ignored?1:0),0)}var Yi=Object.defineProperty,ji=Object.getOwnPropertyDescriptor,y=(e,t,i,o)=>{for(var s=o>1?void 0:o?ji(t,i):t,a=e.length-1,n;a>=0;a--)(n=e[a])&&(s=(o?n(t,i,s):n(s))||s);return o&&s&&Yi(t,i,s),s};const kt=si(Ze);function he(e){return Math.round(e*10)/10}function P(e){return Math.round(e*1e4)/1e4}function V(e,t){const i={...e??{},...t};for(const o of Object.keys(t))t[o]===void 0&&delete i[o];return i}function A(e,t){return t.map(i=>`${e}.${i}`)}function re(e,t){return t.map(i=>`${e}${i}`)}function Ki(e,t){let i=e;for(const o of t.split(".")){if(i===null||typeof i!="object")return;i=i[o]}return i}function Ve(e,t){if(!t)return 0;let i=0;for(const o of t)Ki(e,o)!==void 0&&i++;return i}function Re(e,t,i,o,s){const a=(e.split(".")[1]??"sensor").replace(/_/g," "),n=t.replace(/_/g," "),l=["# Add to configuration.yaml","sensor:","  - platform: statistics",`    name: "${a} ${n}"`,`    entity_id: ${e}`,`    state_characteristic: ${t}`];i&&(l.push("    max_age:"),l.push(`      hours: ${i}`)),o&&l.push(`    sampling_size: ${o}`),t==="percentile"&&s&&l.push(`    percentile: ${s}`);const c=`${e.split(".")[1]??"sensor"}_${t}`;return l.push(""),l.push("# Then set the field entity to:"),l.push(`# sensor.${c}`),l.join(`
`)}const Ye=[{value:"average_linear",label:"Average (linear)",group:"Averages"},{value:"average_step",label:"Average (step)",group:"Averages",binary:!0},{value:"average_timeless",label:"Average (timeless)",group:"Averages",binary:!0},{value:"mean",label:"Mean",group:"Averages",binary:!0},{value:"mean_circular",label:"Mean (circular)",group:"Averages"},{value:"median",label:"Median",group:"Averages"},{value:"value_max",label:"Value maximum",group:"Extremes"},{value:"value_min",label:"Value minimum",group:"Extremes"},{value:"distance_absolute",label:"Range (max − min)",group:"Extremes"},{value:"standard_deviation",label:"Standard deviation",group:"Spread"},{value:"variance",label:"Variance",group:"Spread"},{value:"noisiness",label:"Noisiness",group:"Spread"},{value:"percentile",label:"Percentile",group:"Spread"},{value:"distance_95_percent_of_values",label:"Distance 95% of values",group:"Spread"},{value:"distance_99_percent_of_values",label:"Distance 99% of values",group:"Spread"},{value:"change",label:"Change",group:"Change"},{value:"change_sample",label:"Change per sample",group:"Change"},{value:"change_second",label:"Change per second",group:"Change"},{value:"sum",label:"Sum",group:"Sums"},{value:"sum_differences",label:"Sum of differences",group:"Sums"},{value:"sum_differences_nonnegative",label:"Sum of differences (positive)",group:"Sums"},{value:"total",label:"Total",group:"Sums"},{value:"count",label:"Count (samples)",group:"Counts",binary:!0},{value:"count_on",label:"Count (on)",group:"Counts",binary:!0},{value:"count_off",label:"Count (off)",group:"Counts",binary:!0},{value:"datetime_newest",label:"Timestamp (newest)",group:"Timestamps"},{value:"datetime_oldest",label:"Timestamp (oldest)",group:"Timestamps",binary:!0},{value:"datetime_value_max",label:"Timestamp (at max)",group:"Timestamps"},{value:"datetime_value_min",label:"Timestamp (at min)",group:"Timestamps"}],Pe=["top-left","top","top-right","left","center","right","bottom-left","bottom","bottom-right"],je={"top-left":"Top Left",top:"Top Center","top-right":"Top Right",left:"Left Middle",center:"Center",right:"Right Middle","bottom-left":"Bottom Left",bottom:"Bottom Center","bottom-right":"Bottom Right"},fe=["left","center","right"],Ie={left:"Left",center:"Center",right:"Right"},qi=[{name:"--primary-color",label:"Primary"},{name:"--text-primary-color",label:"Text on Primary"},{name:"--accent-color",label:"Accent"},{name:"--primary-text-color",label:"Primary text"},{name:"--secondary-text-color",label:"Secondary text"},{name:"--disabled-text-color",label:"Disabled text"},{name:"--primary-background-color",label:"Primary background"},{name:"--secondary-background-color",label:"Secondary background"},{name:"--card-background-color",label:"Card background"},{name:"--divider-color",label:"Divider"},{name:"--state-icon-color",label:"State icon"},{name:"--state-active-color",label:"State Active"},{name:"--state-inactive-color",label:"State Inactive"},{name:"--error-color",label:"Error"},{name:"--warning-color",label:"Warning"},{name:"--success-color",label:"Success"},{name:"--info-color",label:"Info"}],Bt=["value","label","icon","svg","blank","rule","embedded_card","toggle","slider","dropdown","button_group","input","spinbox","button"],ge={value:"Value",label:"Label",icon:"Icon",svg:"Element Library",graph:"Graph / Gauge",blank:"Blank",rule:"Horizontal Rule",embedded_card:"Embedded Card",toggle:"Toggle",slider:"Slider",dropdown:"Dropdown",button_group:"Button Group",input:"Input",spinbox:"Spin Box",button:"Button"},St=[...Bt].sort((e,t)=>ge[e].localeCompare(ge[t])),ye={value:"mdi:function-variant",label:"mdi:format-title",icon:"mdi:image",svg:"mdi:shape-outline",graph:"mdi:chart-line",blank:"mdi:crop-square-outline",rule:"mdi:minus",embedded_card:"mdi:widgets",toggle:"mdi:toggle-switch-outline",slider:"mdi:tune-variant",dropdown:"mdi:form-dropdown",button_group:"mdi:view-dashboard-variant-outline",input:"mdi:form-textbox",spinbox:"mdi:numeric",button:"mdi:gesture-tap-button"};function Ke(e){const t=(...i)=>i.includes(e);return{history:ai.includes(e),stroke:t("stat-line","line","area"),range:!t("bar-stacked","state-timeline"),yTitle:t("bar","bar-stacked","stat-line","line","area"),bars:t("bar","bar-h"),legend:!0,gauge:t("gauge","gauge-needle"),timeline:t("state-timeline"),statType:!t("state-timeline")}}const Zi=[{value:"above",label:"Above the bar"},{value:"left",label:"Left of the bar"},{value:"none",label:"Hidden"}],Xi=[{value:"bottom",label:"Below the chart"},{value:"top",label:"Above the chart"},{value:"left",label:"Left of the chart"},{value:"right",label:"Right of the chart"}],Ji=[{value:"linear",label:"Straight"},{value:"smooth",label:"Smoothed"},{value:"step",label:"Stepped"}],qe=[{value:"stat-line",label:"Statistics — Line"},{value:"bar",label:"Statistics — Bar"},{value:"bar-h",label:"Statistics — Bar (horizontal)"},{value:"bar-stacked",label:"Statistics — Bar (stacked)"},{value:"line",label:"History — Line (with unit)"},{value:"area",label:"History — Area (with unit)"},{value:"state-timeline",label:"History — State timeline"},{value:"gauge",label:"Arc Gauge"},{value:"gauge-needle",label:"Arc Gauge (Needle)"}],ue="background gradient angle opacity color border width radius padding shadow drop box halo glow type offset spread blur css",xe="font size color weight family letter spacing css",Fe="tap hold double navigate url more info toggle service action perform assist popover expand dom event entity write override",Gt="entity operator value condition show hide visible",Qi="Raw CSS declarations applied to this element, e.g. outline: 1px dashed red;. Applied after everything above, so it wins.",st="tick minor major length thickness font size position grid line color temperature transparency opacity decimals value",H={tick_color:"Colour of the scale marks beside the tube.",tick_position:"Which side of the tube the scale sits on.",minor_tick_text:"Numbers the small ticks as well as the major ones.",tick_font_size:"Size of the numbers beside the ticks.",grid_color:"Colour of the lines running across the tube from each major tick. Leave blank for none.",decimals:"Decimal places on the temperature reading.",temp_color:"Colour of the temperature reading. Leave blank to follow the fill colour."},se=["background","background_alpha","background2","background_angle","color","border","border_width","radius","padding","shadow","shadow_mode","shadow_x","shadow_y","shadow_blur","shadow_spread","shadow_color","extra_css","blur"],ce=["font_size","color","font_weight","font_family","letter_spacing","extra_css"],eo=se.filter(e=>e!=="extra_css"),to=ce.filter(e=>e!=="extra_css"),Ct=!1,rt=["tap_action","hold_action","double_tap_action"],io=["icon_position","show_state","state_position","icon_style","label_style","state_style"],le={"sub:container":{sel:["button_group_text_size","button_group_icon_size","button_group_state_size"],btn:["button_border_color","button_border_width","button_radius","button_option_padding","button_text_size","button_icon_size","button_state_size"]},"sub:active":{sel:["button_group_selected_color","button_group_selected_color2","button_group_selected_angle","button_group_selected_text_color","button_group_selected_icon_color","button_group_selected_state_color"],btn:["button_selected_color","button_selected_color2","button_selected_angle","button_selected_text_color","button_selected_icon_color","button_selected_state_color"]},"sub:inactive":{sel:["button_group_bg","button_group_bg2","button_group_bg_angle","button_group_text_color","button_group_icon_color","button_group_state_color"],btn:["button_bg","button_bg2","button_bg_angle","button_text_color","button_icon_color","button_state_color"]}},lt=["button_group_option_gap","button_group_border_color","button_group_border_width","button_group_radius","button_group_option_padding","button_group_option_border","button_group_option_border_color","button_group_option_border_width","button_group_option_radius","button_group_option_extra_css"],ct=["button_option_padding"],oo=le["sub:container"].btn.filter(e=>!ct.includes(e)),Ht=["major_tick_length","major_tick_width","minor_tick_length","minor_tick_width","show_minor_tick_text","tick_color","tick_font_size","text_position","grid_color","temp_color","temp_font_size","decimals","fill_opacity_above"],Et=[...Ht,"fill_color","fill_color2","fill_angle","extra_css"],Me=["fill_color","fill_color2","fill_angle","fill_direction","tank_color","extra_css"],Tt=["fill_color","fill_color2","fill_angle","extra_css"],zt="Blank runs the gradient along the fill direction. An SVG that defines its own gradient stops keeps its own direction — the angle only applies to gradients the card draws.",pe={accent:["accent_color","accent_color2","accent_angle"],toggle:["toggle_on_color","toggle_on_color2","toggle_on_angle","toggle_off_color","toggle_off_color2","toggle_off_angle","toggle_thumb_color","toggle_thumb_size","toggle_thumb_radius","toggle_thumb_padding","toggle_thumb_shadow"],slider:["slider_track_color","slider_track_color2","slider_track_angle","slider_fill_color","slider_fill_color2","slider_fill_angle","slider_height","slider_length","slider_radius","slider_border","slider_border_color","slider_border_width","slider_thumb_color","slider_thumb_size","slider_thumb_width","slider_thumb_radius","slider_thumb_padding","slider_thumb_shadow"],dropdown:["dropdown_border_color","dropdown_bg","dropdown_bg2","dropdown_bg_angle","dropdown_menu_bg","dropdown_menu_bg2","dropdown_menu_bg_angle","dropdown_menu_border_color","dropdown_selected_color","dropdown_selected_color2","dropdown_selected_angle","dropdown_radius","dropdown_text_size","dropdown_menu_radius","dropdown_menu_shadow","dropdown_option_radius","dropdown_option_text_color","dropdown_option_hover_color"],input:["input_border_color","input_bg","input_bg2","input_bg_angle","input_focus_color","input_placeholder_color","input_radius","input_text_size"],spinbox:["spinbox_border_color","spinbox_bg","spinbox_bg2","spinbox_bg_angle","spinbox_button_hover_color","spinbox_button_hover_color2","spinbox_button_hover_angle","spinbox_button_width","spinbox_button_font_size","spinbox_radius","spinbox_text_size"]},so=[{type:"alarm-panel",name:"Alarm Panel"},{type:"button",name:"Button"},{type:"calendar",name:"Calendar"},{type:"entities",name:"Entities"},{type:"entity",name:"Entity"},{type:"entity-filter",name:"Entity Filter"},{type:"gauge",name:"Gauge"},{type:"glance",name:"Glance"},{type:"history-graph",name:"History Graph"},{type:"horizontal-stack",name:"Horizontal Stack"},{type:"humidifier",name:"Humidifier"},{type:"iframe",name:"iFrame"},{type:"light",name:"Light"},{type:"logbook",name:"Logbook"},{type:"map",name:"Map"},{type:"markdown",name:"Markdown"},{type:"media-control",name:"Media Control"},{type:"picture",name:"Picture"},{type:"picture-elements",name:"Picture Elements"},{type:"picture-entity",name:"Picture Entity"},{type:"picture-glance",name:"Picture Glance"},{type:"plant-status",name:"Plant Status"},{type:"sensor",name:"Sensor"},{type:"shopping-list",name:"Shopping List"},{type:"statistics-graph",name:"Statistics Graph"},{type:"thermostat",name:"Thermostat"},{type:"tile",name:"Tile"},{type:"todo-list",name:"To-do List"},{type:"vertical-stack",name:"Vertical Stack"},{type:"weather-forecast",name:"Weather Forecast"},{type:"webpage",name:"Webpage"}];function ao(e){const t=(e??"").trim(),i=t.match(/^color-mix\(\s*in\s+srgb\s*,\s*(.+?)\s+([\d.]+)%\s*,\s*transparent\s*\)$/i);if(i)return{base:i[1].trim(),alpha:Math.max(0,Math.min(1,Number(i[2])/100))};const o=t.match(/^#([0-9a-f]{6})([0-9a-f]{2})$/i);if(o)return{base:`#${o[1]}`,alpha:parseInt(o[2],16)/255};const s=t.match(/^rgba?\(\s*([\d.]+)\s*,\s*([\d.]+)\s*,\s*([\d.]+)\s*[,/]\s*([\d.]+)\s*\)$/i);return s?{base:"#"+[s[1],s[2],s[3]].map(n=>Math.max(0,Math.min(255,Math.round(Number(n)))).toString(16).padStart(2,"0")).join(""),alpha:Math.max(0,Math.min(1,Number(s[4])))}:{base:t,alpha:1}}function Rt(e,t){return t>=1?e:`color-mix(in srgb, ${e} ${Number((t*100).toFixed(1))}%, transparent)`}function no(e,t){const i=t?.isConnected?t:document.body,o=document.createElement("div");try{o.style.color=e,o.style.display="none",i.appendChild(o);const a=getComputedStyle(o).color.match(/\d+/g)?.map(Number);return!a||a.length<3?"#000000":"#"+a.slice(0,3).map(n=>n.toString(16).padStart(2,"0")).join("")}catch{return"#000000"}finally{o.remove()}}let p=class extends Yt{constructor(){super(...arguments),this._selCard=0,this._selField=-1,this._selCards=new Set,this._selEmbCards=new Set,this._selFlow=-1,this._showAddFlowInput=!1,this._newFlowName="",this._pendingFlowIdx=-1,this._showFlowCompleteModal=!1,this._selPoint=-1,this._selSeries=-1,this._selOption=-1,this._selBgRule=-1,this._selCanvasBgRule=-1,this._pickerLib=[],this._pickerTrail=[],this._pickerErr="",this._selExtOption=-1,this._selExtSeries=-1,this._selVirtual=-1,this._selVirtualInput=-1,this._selTrigger=-1,this._selZone=-1,this._selExtCard=0,this._selExtField=-1,this._templateName="",this._templateIncludeEntities=!1,this._templateError="",this._previewBoxes={},this._previewExpanded=!1,this._barAtTop=localStorage.getItem("mc-expanded-bar-top")==="1",this._onWindowResize=()=>this._sizeExpandedCanvas(),this._pickerStyleScheduled=!1,this._pickerStyleRetries=0,this._styledPickers=new WeakSet,this._mccustApplied=[],this._copiedFields=null,this._copySourceId=null,this._virtualClipboard=null,this._copiedField=null,this._copiedFieldSrc=null,this._copiedOption=null,this._dragSrc=null,this._cpOpenId=null,this._cpPos=null,this._cpFocusedId=null,this._ggOpen=!1,this._ggTarget=null,this._wizStep=-1,this._wiz={cardType:"",source:"auto",sunEntity:"sun.sun",dayImg:"",nightImg:"",evCount:0,evImgs:[],bgCount:"single",bgSwitchMode:"sun",bgEntity:"",singleImg:"",bgStateEntity:"",bgRules:[]},this._wizardShown=!1,this._oneOwnerChecked=!1,this._dragCard=-1,this._startX=0,this._startY=0,this._dragMembers=[],this._embDragMembers=[],this._dragPoint=-1,this._pStartX=0,this._pStartY=0,this._pStartPos={x:0,y:0},this._snapAxis=null,this._snapAnchor=null,this._dragZone=-1,this._zStartX=0,this._zStartY=0,this._zStartPos={x:0,y:0},this._resizeZone=-1,this._resizeCorner="br",this._zResizeStartBox={x:0,y:0,w:0,h:0},this._bgSelected=!1,this._bgMode=null,this._bgStartX=0,this._bgStartY=0,this._bgStart={L:0,T:0,baseW:0,baseH:0,totalW:0,totalH:0},this._selEmbCard=-1,this._dragEmbCard=-1,this._ecStartX=0,this._ecStartY=0,this._embEditorOpen=!1,this._embEditorYaml="",this._embEditorYamlError="",this._embNativeEditor=null,this._embEditorTarget=null,this._embEditorConfig=null,this._embPickerOpen=!1,this._embPickerSearch="",this._embPickerTarget=null,this._variantOpen="",this._variantError="",this._saveVariantFor="",this._saveVariantLabel="",this._variantImportError="",this._navTab="cards",this._navPanel="",this._navPath=[],this._panelScroll=new Map,this._lastScrollKey="",this._lastScrollDepth=0,this._listFilter="",this._listFilterKey="",this._undoStack=[],this._redoStack=[],this._undoSrc=null,this._undoLastPush=0,this._restoring=!1,this._onUndoKeydown=e=>{if(!(e.ctrlKey||e.metaKey)||e.altKey)return;const t=e.key.toLowerCase(),i=t==="z"&&!e.shiftKey,o=t==="y"||t==="z"&&e.shiftKey;if(!i&&!o)return;const s=e.composedPath()[0];if(s instanceof HTMLElement){const a=s.tagName;if(a==="INPUT"||a==="TEXTAREA"||a==="SELECT"||s.isContentEditable)return}e.preventDefault(),e.stopPropagation(),i?this._undo():this._redo()},this._toastMsg="",this._tutorialStep=-1,this._ptrDrag=null,this._dropKey=null,this._dropBefore=!1,this._suppressClick=!1,this._searchQuery="",this._searchActive=0,this._healthShowIgnored=!1,this._optionLayoutOn=new Set,this._colorOverridesOn=new Set,this._gradientOn=new Set,this._resetToWizard=()=>{window.confirm(`Reset all configuration and restart the setup wizard?
...
It also resets Global Defaults to their starting values — including your saved custom control variants — and clears the popover card defaults and EV count.`)&&(this._wiz={cardType:"",source:"auto",sunEntity:"sun.sun",dayImg:"",nightImg:"",evCount:0,evImgs:[],bgCount:"single",bgSwitchMode:"sun",bgEntity:"",singleImg:"",bgStateEntity:"",bgRules:[]},this._wizStep=0,this._emit({type:this._config.type,background:{},canvas:{},defaults:{font_family:"sans-serif",card:{background:"rgba(8,18,28,0.55)",border:!0,color:"#00d4ff",radius:10,padding:8},label:{font_size:13,color:"#cccccc"},value:{font_size:22,color:"#ffffff",font_weight:600}},cards:[]}))},this._cpMode="rgb"}_navPush(e,t,i){this._navPath=[...this._navPath,{key:e,label:t,...i?{hint:i}:{}}]}_crumbIndex(e,t){if(!t)return-1;const i=e.slice(e.indexOf(":")+1),o=t.findIndex(a=>{const n=a&&typeof a=="object"?a.id:void 0;return n!==void 0&&String(n)===i});if(o>=0)return o;const s=Number(i);return Number.isInteger(s)&&s>=0&&s<t.length?s:-1}_navScrollKey(){return`${this._navTab}|${this._navPanel}|${this._navPath.map(e=>e.key).join("/")}`}_navDeadEnd(e="This item no longer exists — it may have been removed in the YAML editor."){return r`
    ...
    `}_updateCard(e,t){if(!this._config)return;const i=this._config.cards.map((o,s)=>s===e?V(o,t):o);this._emit({...this._config,cards:i})}_updateCardBox(e,t){if(!this._config)return;const i=this._config.cards[e];i&&this._updateCard(e,{box:V(i.box??{},t)})}_updateField(e,t,i){if(!this._config)return;const o=this._config.cards[e];if(!o)return;const s=o.fields.map((a,n)=>n===t?V(a,i):a);this._updateCard(e,{fields:s})}_updateDefaults(e){this._config&&this._emit({...this._config,defaults:V(this._config.defaults,e)})}_updateCanvas(e){this._config&&this._emit({...this._config,canvas:V(this._config.canvas,e)})}_gridGeom(){const e=this._config?.canvas;if(e?.layout_mode!=="grid"||!e.grid)return null;const{totalW:t,totalH:i}=te(this._config),o=Math.max(1,e.grid.columns||1),s=Math.max(1,e.grid.rows||1),a=e.grid.padding??0;return{cols:o,rows:s,padding:a,cellW:t/o,cellH:i/s,totalW:t,totalH:i}}_setLayoutMode(e){if(!this._config)return;const t={...this._config.canvas??{}};if(t.layout_mode=e,e==="grid"){t.grid||(t.grid={columns:10,rows:15,padding:0});const i=Math.max(1,t.grid.columns),o=Math.max(1,t.grid.rows),s=t.grid.padding??0,{totalW:a}=te(this._config),n=a/i,l=this._config.cards.map(h=>{const u=this._previewBoxes[h.id],g=u?u.x+u.w/2:h.position.x,v=u?u.y+u.h/2:h.position.y,m=Math.min(i,Math.max(0,Math.round(g*i))),z=Math.min(o,Math.max(0,Math.round(v*o))),R=h.grid_span??Math.max(1,Math.min(i,Math.round((u?.w??0)*i)||1)),$=Math.max(8,R*n-s);return{...h,anchor:"center",grid_span:R,width:$,position:{x:P(m/i),y:P(z/o)}}}),c=this._embCards().map(h=>{const u=this._previewBoxes[h.id],g=u?u.x+u.w/2:h.position.x,v=u?u.y+u.h/2:h.position.y,m=Math.min(i,Math.max(0,Math.round(g*i))),z=Math.min(o,Math.max(0,Math.round(v*o))),R=h.grid_span??Math.max(1,Math.min(i,Math.round((u?.w??0)*i)||1)),$=Math.max(8,R*n-s);return{...h,anchor:"center",grid_span:R,width:$,position:{x:P(m/i),y:P(z/o)}}});this._emit({...this._config,canvas:t,cards:l,embedded_cards:c});const d=l.length+c.length;d&&this._showUndoToast(`${d} card${d===1?"":"s"} re-laid out for Grid`)}else this._emit({...this._config,canvas:t})}_renderGridOverlay(){const e=this._gridGeom();if(!e)return _;const{cols:t,rows:i}=e,o=[];for(let s=0;s<=t;s++)for(let a=0;a<=i;a++)o.push(r`<div class="ec-grid-dot" style="left:${s/t*100}%;top:${a/i*100}%;"></div>`);return r`<div class="ec-grid-overlay">${o}</div>`}_renderBgOverlay(){if(!this._config)return _;const e=te(this._config),t=e.L/e.totalW*100,i=e.T/e.totalH*100,o=e.baseW/e.totalW*100,s=e.baseH/e.totalH*100;return r`
    ...
    `,t.appendChild(i),!0}_findInShadow(e,t,i=6){let o=[e];for(let s=0;s<i&&o.length;s++){const a=[];for(const n of o){const l=n.shadowRoot;if(!l)continue;const c=l.querySelector(t);if(c)return c;l.querySelectorAll("*").forEach(d=>{d.shadowRoot&&a.push(d)})}o=a}return null}_styleWalkedPickers(){let e=!1;for(const t of p._WALKED_PICKERS){const i=this.renderRoot?.querySelectorAll(t);!i||i.length===0||i.forEach(o=>{if(this._styledPickers.has(o))return;const s=this._findInShadow(o,"ha-combo-box-item",8);this._injectPickerStyle(s)?this._styledPickers.add(o):e=!0})}return e}_styleEntityPickers(){const e=this.renderRoot?.querySelectorAll("ha-entity-picker");if(!e||e.length===0)return!1;let t=!1;return e.forEach(i=>{if(this._styledPickers.has(i))return;const o=i.shadowRoot?.querySelector("ha-generic-picker")?.shadowRoot?.querySelector("ha-picker-field")?.shadowRoot?.querySelector("ha-combo-box-item");this._injectPickerStyle(o)?this._styledPickers.add(i):t=!0}),t}_iconPicker(e,t,i){return r`<ha-icon-picker
      .hass=${this.hass}
      .value=${e??""}
      .placeholder=${i??""}
    ...
    `}_boxRows(e,t,i,o=!0,s="Rounds the corners of the box."){return r`
      ...
      ${t.shadow?r`
        ${this._row("Shadow type",r`<select class="ec-select"
            .value=${t.shadow_mode??b("box_shadow_mode")??"drop"}
        ...
        ${(t.shadow_mode??b("box_shadow_mode")??"drop")!=="box"?r`
    ...
    `}_cssRow(e,t,i="Additional CSS",o=Qi){return this._row(i,r`<textarea
    ...
    `}render(){if(!this._config)return _;if(this._wizStep>=0)return this._renderWizard();const{totalW:e,totalH:t}=te(this._config),i=this._config.cards??[];return r`
        ...
        >
          ...
          ${this._flows().length>0?r`
            <svg class="ec-flow-paths-overlay" viewBox="0 0 1 1" preserveAspectRatio="none">
              ...
              ${this._flows().map((o,s)=>{const a=o.points.map(l=>me(l,i,this._previewBoxes)).map(l=>`${l.x},${l.y}`).join(" "),n=s===this._selFlow;return qt`
                  <polyline
                    class="ec-flow-hit"
                    points="${a}"
                    fill="none"
          ...
          ${this._selFlow>=0?(()=>{const o=this._flows()[this._selFlow];if(!o)return _;const s=["top","right","bottom","left"];return r`
              ...
              >
                ${this._selPoint>=0?i.map(a=>s.map(n=>{const l=this._previewBoxes[a.id];if(!l)return _;let c,d;switch(n){case"top":c=l.x+l.w/2,d=l.y;break;case"right":c=l.x+l.w,d=l.y+l.h/2;break;case"bottom":c=l.x+l.w/2,d=l.y+l.h;break;case"left":c=l.x,d=l.y+l.h/2;break;default:c=l.x+l.w/2,d=l.y+l.h/2;break}return r`<div
                  ...
                  ></div>`})):_}
                ${o.points.map((a,n)=>{const l=me(a,i,this._previewBoxes);return r`<div
...
`)}`)}_itemCard(e){const{dragKey:t,icon:i,label:o,sub:s,selected:a,multi:n,onClick:l,actions:c}=e,d=t!=null&&this._dropKey===t;return r`
    ...
    `}_renderRibbon(){const e=[{key:"cards",icon:"mdi:view-grid",label:"Cards"},{key:"elements",icon:"mdi:shape",label:"Elements"},{key:"settings",icon:"mdi:cog",label:"Settings"}],t=this._searchQuery.trim(),i=t?this._searchResults(t):[],o=i.length?Math.min(this._searchActive,Math.min(i.length,p._SEARCH_LIMIT)-1):-1,s=Vi(this._health());return r`
    ...
    `}_renderPanelBody(){switch(this._navPanel){case"mosaic":return this._renderMosaicPanel();case"popover":return this._renderPopoverPanel();case"embedded":return this._renderEmbeddedPanel();case"flows":return this._renderFlowsRibbonPanel();case"zones":return this._renderZonesRibbonPanel();case"virtuals":return this._renderVirtualsRibbonPanel();case"canvas":return this._renderCanvasRibbonPanel();case"defaults":return this._renderDefaultsRibbonPanel();case"templates":return this._renderTemplatesRibbonPanel();case"health":return this._renderHealthPanel();case"about":return this._renderAboutPanel();default:return r``}}_renderAboutPanel(){return r`
      <div class="ec-section ec-about">
        <div class="ec-about-version">Mosaic Canvas Card v${at} · build ${Zt}</div>
...
Undo (Ctrl+Z) reverses this.`)&&(i.apply({[t.key]:void 0}),this._showUndoToast(`“${t.key}” removed`))}_healthIgnore(e,t){const i=this._config;if(!i)return;const o=i.health_ignore??[],s=t?o.includes(e)?o:[...o,e]:o.filter(a=>a!==e);this._emit(V(i,{health_ignore:s.length?s:void 0})),this._showUndoToast(t?"Row ignored":"Row restored")}_renderHealthPanel(){const e=this._health(),t=e.issues.filter(s=>!s.ignored),i=e.issues.filter(s=>s.ignored),o=Ot.map(s=>({meta:s,rows:t.filter(a=>a.check===s.id)})).filter(s=>s.rows.length>0);return r`
    ...
    `}_renderMosaicPanel(){const e=this._config?.cards??[],t=this._navPath;if(t.length===0)return r`
      ...
      <div class="ec-section">
        ...
        ${this._row("Field Alignment",r`<select class="ec-select"
          ...
          >
            ${fe.map(i=>r`<option value=${i} .selected=${(t.align??b("align")??"left")===i}>${Ie[i]}</option>`)}
    ...
    `}_mosaicFieldGap(){const e=this._config?.defaults;return e?.card_field_gap??b("card_field_gap")??e?.field_gap??b("field_gap")??4}_mosaicColumnGap(){const e=this._config?.defaults;return e?.card_column_gap??b("card_column_gap")??e?.column_gap??b("column_gap")??3}_cardLayoutMode(e){return Ae(e,this._config?.defaults)}_cardGridDefaults(e){const t=this._config?.defaults;return{cols:e.grid?.columns??t?.card_grid_columns??b("card_grid_columns")??4,rows:e.grid?.rows??t?.card_grid_rows??b("card_grid_rows")??4}}_patchCardGrid(e,t,i){const{cols:o,rows:s}=this._cardGridDefaults(t);this._updateCard(e,{grid:{columns:o,rows:s,...t.grid,...i}})}_cardPlacementRow(e,t){const i=this._cardLayoutMode(t),o=i==="grid",s=Ae(void 0,this._config?.defaults);return this._row("Field placement",r`<select class="ec-select"
      ...
      ${this._row("Grid rows",r`${this._numInput({value:o,onChange:s=>this._patchCardGrid(e,t,{rows:Math.max(1,Math.min(20,s??4))}),min:1,max:20})}`)}
    ...
    `}_fieldName(e){return e.display_name??e.text??(e.entity?.startsWith("virtual:")?this._virtuals().find(t=>`virtual:${t.id}`===e.entity)?.name??e.entity:this.hass?.states[e.entity??""]?.attributes?.friendly_name??e.entity)??e.icon??"(untitled field)"}_fieldSub(e,t=!1){const i=e.type==="graph"&&e.graph_type?e.graph_type:e.type==="svg"&&(e.shape||e.svg)?e.shape??e.svg.split("/").pop()?.replace(/\.svg$/i,"")??"":e.type==="embedded_card"&&e.embed_card_config?.type?String(e.embed_card_config.type):"",o=(n,l,c)=>l!=null?`${n}${l}${c!=null&&c>l?`-${c}`:""} · `:"",s=o("C",e.column,e.column_end),a=t?e.row!=null?o("R",e.row,e.row_end):"R auto · ":"";return`${s}${a}${ge[e.type]}${i?" · "+i:""}`}_renderFieldList(e,t){const i=t.fields,o=this._cardLayoutMode(t)==="grid";return r`
      <div class="ec-section ec-section--fields">
        ...
        ${i.length===0?this._emptyAdd("No fields yet — add one",()=>this._addField(e)):i.map((s,a)=>({f:s,fi:a})).filter(({f:s})=>{const a=this._currentListFilter();return!a||`${this._fieldName(s)} ${this._fieldSub(s,o)}`.toLowerCase().includes(a)}).map(({f:s,fi:a})=>this._itemCard({dragKey:`field:${e}:${a}`,icon:ye[s.type],label:this._fieldName(s),sub:this._fieldSub(s,o),selected:a===this._selField,onClick:()=>{this._selField=a,this._navPush(`field:${s.id}`,`Field ${a+1}`)},actions:r`
                  ${this._copiedFieldSrc?.isExt===!1&&this._copiedFieldSrc.cardId===t.id&&this._copiedFieldSrc.fieldId===s.id?r`<span class="ec-copy-badge">Copied</span>`:r`<button class="ec-btn-copy"
            ...
            >
              ...
              <span class="ec-list-label" style="flex:1;min-width:0;">
                ${h.type==="text"?r`<input class="ec-input" type="text" .value=${h.text??""}
                      ...
                      @input=${v=>c(u,{text:v.target.value})}
    ...
    `}_idFor(e,t,i){const s=(i?this._extCards()[e]:this._config?.cards[e])?.fields[t]?.id,a=i?"e":"c";return s?`${a}${s}`:`${a}${e}f${t}`}_derivedService(e){const t=e.entity?.split(".")[0];if(!t)return"";const i=(...o)=>o.includes(t);switch(e.type){case"toggle":case"button":return"homeassistant.turn_on / turn_off";case"slider":case"spinbox":return i("input_number","number","counter")?`${t}.set_value`:"";case"dropdown":case"button_group":case"input":return i("input_select","select")?`${t}.select_option`:i("input_text","text")?`${t}.set_value`:"";default:return""}}_fieldSecControlSource(e,t,i,o=!1){const s=this._updFor(e,t,o),a=this._derivedService(i);return r`
      <div class="ec-section">
        ${this._entitySelector({entity:i.entity,onEntity:n=>s({entity:n}),attribute:i.read_attribute,onAttribute:n=>s({read_attribute:n}),attributePlaceholder:Xt(i.options_attribute)})}
    ...
    `}_saveAsVariantRows(e,t){if(!J(e.type))return r``;const i=e.type,o=Jt(i,e.variant)?Qt(i,e.variant):void 0;if(!(this._saveVariantFor===t))return r`
    ...
    `}_confirmVariantOptionLoss(e,t,i){if(!ti(e,t,i))return!0;const o=e.options?.length??0;return window.confirm(`This variant brings no options of its own, so applying it will clear the ${o} option${o===1?"":"s"} on this field.

Undo restores them. Save the field as a variant first if you want to keep this list.`)}_typeChangePatch(e,t,i={}){const o=p,s=V(e,{type:t,...i}),a=new Set([...o._slotMap(this._fieldSlotDefs(s)).keys(),...Wi(s)]),n={type:t,...i};for(const l of Object.keys(e))!(l in n)&&!a.has(l)&&(n[l]=void 0);return n}_confirmTypeOptionLoss(e,t){if(J(t)||!e.options?.length)return!0;const i=e.options.length;return window.confirm(`A ${ge[t]??t} field has no options, so changing the type drops the ${i} option${i===1?"":"s"} on this field.
...
Undo restores them.`)}_numberEntityRange(e){if(!e||!e.startsWith("number.")&&!e.startsWith("input_number.")||!this.hass)return{};const t=this.hass.states[e]?.attributes;if(!t)return{};const i=o=>typeof o=="number"?o:void 0;return{min:i(t.min),max:i(t.max),step:i(t.step)}}_fieldSecSliderRange(e,t,i,o=!1){const s=this._updFor(e,t,o),a=this._numberEntityRange(i.entity),n=(l,c,d,h)=>this._numRow(l,{value:i[c],onChange:u=>s({[c]:u}),placeholder:a[c]?.toString()??d,hint:h});return r`
    ...
    `}_fieldSecControlLabels(e,t,i,o=!1){const s=this._updFor(e,t,o),a=i.control_labels??[],n=c=>s({control_labels:c.length?c:void 0}),l=i.control_labels_position??"above";return r`
      <div class="ec-section">
        ...
        ${this._row("Alignment",r`<select class="ec-select" .value=${i.align??"left"}
          ...
          >
            ${fe.map(c=>r`<option value=${c} .selected=${(i.align??"left")===c}>${Ie[c]}</option>`)}
          </select>`)}
    ...
    `}_fieldSecValueSource(e,t,i,o=!1){const s=this._updFor(e,t,o);return r`
      <div class="ec-section">
          ...
          ${this._isTimeUntilVirtual(i)?this._renderTuLayoutBuilder(e,t,i,o):_}
      </div>
    `}_fieldSecValueLabel(e,t,i,o=!1){const s=this._updFor(e,t,o);return r`
      <div class="ec-section">
          ...
          ${this._row("Icon",r`<select class="ec-select"
              ...
              @change=${a=>{const n=a.target.value;s({icon_position:n==="none"?void 0:n})}}
            >
          ...
          ${i.icon_position&&i.icon_position!=="none"?this._row("Icon (override)",this._iconPicker(i.icon,a=>s({icon:a}),"(entity icon)"),"A picked icon shown instead of the entity's own."):_}
      </div>
    `}_fieldSecLabelContent(e,t,i,o=!1){const s=this._updFor(e,t,o);return r`
      <div class="ec-section">
          ${this._row("Text",r`<input class="ec-input" type="text" .value=${i.text??""}
              ...
              />`)}
          ${this._row("Icon",this._iconPicker(i.icon,a=>s({icon:a})),"Optional icon shown with the text.")}
          ${i.icon?this._row("Icon position",r`<select class="ec-select"
              .value=${i.icon_position??b("icon_position")??"left"}
              @change=${a=>s({icon_position:a.target.value})}
            >
              <option value="left"  .selected=${(i.icon_position??b("icon_position")??"left")==="left"}>Left of text</option>
    ...
    `}_fieldSecIcon(e,t,i,o=!1){const s=this._updFor(e,t,o),a=i.icon_rules??[],n=l=>s({icon_rules:l.length?l:void 0});return r`
      <div class="ec-section">
          ${this._row("Icon",this._iconPicker(i.icon,l=>s({icon:l}),i.entity?"(entity icon)":""),i.entity?"Shown when no rule below matches. Leave blank to use the entity's own icon.":"An mdi icon name, e.g. mdi:lightbulb.")}

          <div class="ec-subsection-title">Icon by state</div>
          ${this._entitySelector({entity:i.entity,onEntity:l=>s({entity:l}),includeVirtuals:!1,attribute:i.attribute,onAttribute:l=>s({attribute:l})})}
    ...
    `}_fieldSecGraphStates(e,t,i,o=!1){const s=this._updFor(e,t,o),a=o?`ext${e}-f${t}`:`c${e}-f${t}`,n=i.graph_state_colors??[],l=c=>s({graph_state_colors:c.length?c:void 0});return r`
      <div class="ec-section">
            <p style="font-size:12px;color:#4a8aaa;margin:0 0 6px;">
    ...
    `}_fieldSecGraphBands(e,t,i,o=!1){const s=this._updFor(e,t,o),a=o?`ext${e}-f${t}`:`c${e}-f${t}`,n=i.graph_thresholds??i.thresholds??[],l=c=>s({graph_thresholds:c.length?c:void 0,thresholds:void 0});return r`
      <div class="ec-section">
            <p style="font-size:12px;color:#4a8aaa;margin:0 0 6px;">
    ...
    `}_fieldSecGraphSettings(e,t,i,o=!1){const s=this._updFor(e,t,o),a=i.graph_type??b("graph_type")??"bar",n=Ke(a),{history:l,stroke:c,range:d,yTitle:h,bars:u,gauge:g,timeline:v}=n;return r`
      <div class="ec-section">

          ${this._row("Type",r`<select class="ec-select"
              .value=${i.graph_type??b("graph_type")??"bar"}
              @change=${m=>s({graph_type:m.target.value})}
            >
              ${qe.map(m=>r`<option value=${m.value} .selected=${(i.graph_type??b("graph_type")??"bar")===m.value}>${m.label}</option>`)}
          ...
          ${this._row("Show axes",r`<input type="checkbox" .checked=${i.graph_show_axes??b("graph_show_axes")??!0}
              @change=${m=>s({graph_show_axes:m.target.checked||void 0})}
          ...
          ${this._row("Show legend",r`<input type="checkbox" .checked=${i.graph_show_legend??b("graph_show_legend")??!1}
              @change=${m=>s({graph_show_legend:m.target.checked||void 0})}
            />`,"Names each series beside the chart.")}
          ${i.graph_show_legend??b("graph_show_legend")??!1?this._row("Legend position",r`<select class="ec-select"
              .value=${i.graph_legend_position??b("graph_legend_position")??"bottom"}
              @change=${m=>s({graph_legend_position:m.target.value})}
            >
              ${Xi.map(m=>r`<option value=${m.value} .selected=${(i.graph_legend_position??b("graph_legend_position")??"bottom")===m.value}>${m.label}</option>`)}
            </select>`,"Left and right stack the names in a column and take their width from the chart."):_}
          ${u?this._row("Bar value labels",r`<input type="checkbox" .checked=${i.graph_bar_labels??b("graph_bar_labels")??!1}
              @change=${m=>s({graph_bar_labels:m.target.checked||void 0})}
            />`,"Prints each bar’s value at its end."):_}
          ${d?this._numRow("Min value",{value:i.graph_min,onChange:m=>s({graph_min:m}),placeholder:"auto",hint:"Unset scales the axis to the data, rounded to a whole gridline."}):_}
          ${d?this._numRow("Max value",{value:i.graph_max,onChange:m=>s({graph_max:m}),placeholder:"auto",hint:"Unset scales the axis to the data, rounded to a whole gridline."}):_}
          ${c?this._row("Start axis at zero",r`<input type="checkbox" .checked=${i.graph_include_zero??b("graph_include_zero")??!1}
              @change=${m=>s({graph_include_zero:m.target.checked||void 0})}
          ...
          ${d?this._numRow("Gridlines",{value:i.graph_tick_count,onChange:m=>s({graph_tick_count:m}),min:2,max:12,placeholder:"auto",hint:"Unset picks a count that suits the chart’s height and label size."}):_}
          ${this._numRow("Decimals",{value:i.graph_precision,onChange:m=>s({graph_precision:m}),min:0,max:6,placeholder:"from entity",hint:"Applies to axis labels, bar labels, gauge readouts and tooltips. Unset follows the entity’s own display precision."})}
          ${this._row("Unit",r`<input class="ec-input" type="text" .value=${i.graph_unit??""}
              placeholder="(from entity)"
              @change=${m=>s({graph_unit:m.target.value||void 0})}
          ...
          ${h?this._row("Y-axis title",r`<input class="ec-input" type="text" .value=${i.graph_y_title??""}
              placeholder="(none)"
              @change=${m=>s({graph_y_title:m.target.value||void 0})}
            />`,"Rotated label down the left of the plot."):_}
          ${this._numRow("Width (px)",{value:i.width,onChange:m=>s({width:m}),min:60,placeholder:"auto"})}
          ${this._numRow("Height (px)",{value:i.height,onChange:m=>s({height:m}),min:40,placeholder:"auto"})}
          ${l?this._numRow("History (hours)",{value:i.graph_hours,onChange:m=>s({graph_hours:m}),min:1,max:8760,placeholder:"24",hint:"How far back the chart reaches."}):_}
          ${c?this._numRow("Stroke width",{value:i.graph_stroke_width,onChange:m=>s({graph_stroke_width:m}),min:.5,max:10,step:.5,placeholder:"1.5"}):_}
          ${c?this._row("Line shape",r`<select class="ec-select"
              .value=${i.graph_curve??b("graph_curve")??"linear"}
              @change=${m=>s({graph_curve:m.target.value})}
            >
              ${Ji.map(m=>r`<option value=${m.value} .selected=${(i.graph_curve??b("graph_curve")??"linear")===m.value}>${m.label}</option>`)}
          ...
          ${c?this._row("Point markers",r`<input type="checkbox" .checked=${i.graph_points??b("graph_points")??!1}
              @change=${m=>s({graph_points:m.target.checked||void 0})}
            />`,"A dot at every reading. Dropped automatically when the readings are too close together to tell apart."):_}
          ${c?this._row("Label latest value",r`<input type="checkbox" .checked=${i.graph_last_point??b("graph_last_point")??!1}
              @change=${m=>s({graph_last_point:m.target.checked||void 0})}
            />`,"Marks the most recent reading of each series and prints its value beside it."):_}
          ${this._numRow("Refresh (min)",{value:i.graph_refresh_minutes,onChange:m=>s({graph_refresh_minutes:m}),min:1,max:1440,placeholder:"from dashboard",hint:"How often this graph re-queries Home Assistant. Unset follows the dashboard’s Graph refresh. A week-long chart has no reason to poll as often as a live gauge."})}
          ${v?this._row("Entity name",r`<select class="ec-select"
              .value=${i.graph_timeline_label??b("graph_timeline_label")??"above"}
              @change=${m=>s({graph_timeline_label:m.target.value})}
            >
              ${Zi.map(m=>r`<option value=${m.value} .selected=${(i.graph_timeline_label??b("graph_timeline_label")??"above")===m.value}>${m.label}</option>`)}
          ...
          ${v?this._row("Show state names",r`<input type="checkbox" .checked=${i.graph_show_state_names??b("graph_show_state_names")??!1}
              @change=${m=>s({graph_show_state_names:m.target.checked||void 0})}
            />`,"Prints the state inside each block wide enough to hold it."):_}
          ${v?this._row("Unavailable colour",this._colorPicker(`${o?`ext${e}-f${t}`:`c${e}-f${t}`}-unav`,i.graph_unavailable_color,m=>s({graph_unavailable_color:m}),{clearTitle:"Reset to default"}),"Used for unavailable and unknown, so a gap in the record does not read as a real state."):_}
          ${g?this._row("Tick marks",r`<input type="checkbox" .checked=${i.graph_gauge_ticks??b("graph_gauge_ticks")??!1}
              @change=${m=>s({graph_gauge_ticks:m.target.checked||void 0})}
            />`,"Marks around the arc at the same values a chart axis would label."):_}
          ${g?this._numRow("Sweep (degrees)",{value:i.graph_gauge_sweep,onChange:m=>s({graph_gauge_sweep:m}),min:30,max:350,step:5,placeholder:"270",hint:"How far the arc travels, centred on twelve o’clock. 180 gives a half circle."}):_}
          ${g?this._row("Caption",r`<input class="ec-input" type="text" .value=${i.graph_gauge_label??""}
              placeholder="(none)"
              @change=${m=>s({graph_gauge_label:m.target.value||void 0})}
            />`,"Printed under the gauge’s value."):_}
          ${a==="area"?this._numRow("Fill opacity",{value:i.graph_fill_opacity,onChange:m=>s({graph_fill_opacity:m}),min:0,max:1,step:.05,placeholder:"0.2",hint:"How solid the area under a line is. 0 leaves the line alone."}):_}
      </div>
    ...
    `}_fieldSecGraphSeriesItem(e,t,i,o,s=!1){const a=s?`ext${e}-f${t}`:`c${e}-f${t}`,n=(i.graph_series??[])[o];if(!n)return this._navDeadEnd();const l=c=>this._updSeries(e,t,o,i,c,s);return r`
      <div class="ec-section">
              ...
              ${this._row("Color",this._colorPicker(`${a}-s${o}-col`,n.color,c=>l({color:c}),{clearTitle:"Reset to palette color"}),"Unset takes the next colour from the palette in Graph Style.")}
              ...
              ${["last_n_minutes","last_n_hours","last_n_days","last_n_months"].includes(n.stat_period)?this._row(n.stat_period==="last_n_minutes"?"Number of minutes":n.stat_period==="last_n_hours"?"Number of hours":n.stat_period==="last_n_days"?"Number of days":"Number of months",this._numWrap(r`<input type="number" class="ec-input ec-input-num" min="1" step="1"
                ...
                />`)):_}
              ${(()=>{const c=i.graph_type??b("graph_type")??"bar",d=Ke(c);if(!d.statType)return _;const h=d.history,u=n.stat_type??(h?b("stat_type_history")??"mean":b("stat_type")??"sum"),g=!h||u==="difference";return r`
                  ${this._row("Stat type",r`<select class="ec-select"
                      .value=${u}
                      @change=${v=>l({stat_type:v.target.value})}
                    >
    ...
    `}_fieldSecStats(e,t,i,o=!1){const s=this._updFor(e,t,o);return r`
      <div class="ec-section">
    ...
    `}_fieldSecDisplay(e,t,i,o=!1){const s=this._updFor(e,t,o);return r`
      <div class="ec-section">
          ...
          ${this._numRow("Hide below",{value:i.hide_below,onChange:a=>s({hide_below:a}),min:0,placeholder:"(always show)",hint:"Hides the field while the value is under this, compared unsigned (applies to negative values too)."})}
    ...
    `}_fieldSecStyle(e,t,i,o=!1){const s=this._updFor(e,t,o),a=o?`ext${e}-f${t}`:`c${e}-f${t}`;return r`
      <div class="ec-section">
          ${J(i.type)?_:this._row("Align",r`<select class="ec-select"
              .value=${i.align??b("align")??"left"}
              @change=${n=>s({align:n.target.value})}
            >
              ${fe.map(n=>r`<option value=${n} .selected=${(i.align??b("align")??"left")===n}>${Ie[n]}</option>`)}
          ...
          ${i.style!==void 0?r`
            ...
            ${this._textRows(`${a}-st`,i.style,n=>s({style:{...i.style,...n}}),Ct)}
          `:_}
    ...
    `}_defaultsSecCard(e){const t=mt(e,Xe),i=Ae(void 0,e);return r`
      <div class="ec-section">
        ...
        ${this._row("Grid rows",r`${this._numInput({value:e.card_grid_rows??b("card_grid_rows")??4,onChange:o=>this._updateDefaults({card_grid_rows:o==null?void 0:Math.max(1,Math.min(20,o))}),min:1,max:20})}`,"How many cells down a card has in grid placement. The card divides its own height between them.")}
        ...
        ${this._row("Dimming",r`
          <select class="ec-select"
            @change=${o=>this._setPopupDimming(o.target.value,Xe)}
          >
    ...
    `}_setPopupDimming(e,t=ii){if(!(e in de))return;const i=de[e].values,o={};for(const s of t)o[s]=b(s)===i[s]?void 0:i[s];this._updateDefaults(o)}static _custName(e){return e.trim().replace(/[^a-zA-Z0-9_-]/g,"_")}_custDuplicateNames(){const e=new Set,t=new Set;for(const[i]of _t(this._config?.defaults)){const o=i.slice(9);e.has(o)&&t.add(o),e.add(o)}return t}_custNameInput(e,t,i){const o=e!==""&&t.has(e);return r`
    ...
    </div>`}static _selectorDefaultsDefs(e){const t=e?"btn":"sel",i=e?"button_option_layout":"option_layout",o=[{key:"sub:container",label:"Field Container",hint:"Sizes, placement, text",icon:"mdi:card-outline",paths:[...A("control_style",le["sub:container"][t]),...A(i,io)]},{key:"sub:active",label:"Active State",hint:"Colors when the option is active",icon:"mdi:circle-slice-8",paths:A("control_style",le["sub:active"][t])},{key:"sub:inactive",label:"Inactive State",hint:"Colors when the option is inactive",icon:"mdi:circle-outline",paths:A("control_style",le["sub:inactive"][t])}];return e?o:[...o,{key:"sub:separation",label:"Option Separation",hint:"Frame border, gap, per-option style",icon:"mdi:dots-grid",paths:A("control_style",lt)}]}_selectorDefaultsMenu(e){return this._navMenu(p._selectorDefaultsDefs(e==="cd:button"),this._defaultsScope())}_selectorDefaultsSection(e,t){return r`
    ...
    `:r`${Ge(e).map(i)}`}_updateVariants(e,t){const i=this._config?.defaults?.control_variants??{},o={...i,[e]:t([...i[e]??[]])};for(const a of Object.keys(o))o[a]?.length||delete o[a];const s=Object.keys(o).length?o:void 0;this._updateDefaults({control_variants:s}),Le(s)}_controlVariantsSection(){const e=this._config?.defaults?.control_variants??{},t=Pt.filter(o=>(e[o]??[]).length>0),i=t.reduce((o,s)=>o+(e[s]?.length??0),0);return r`
      <div class="ec-section">
        ...
        ${i===0?r`<p class="ec-empty">No custom variants yet.</p>`:t.map(o=>r`
              <div class="ec-subsection-title">${ge[o]}</div>
...
Fields already using it keep their current settings — they just lose the link to this variant.`)&&this._updateVariants(e,l=>l.filter((c,d)=>d!==i))}}
    ...
    `}_controlStyleUsesGlobal(e,t){const i=e.control_style,o=p._separationOnly(i);return i===void 0||!this._colorOverridesOn.has(t)&&o!==void 0&&Object.keys(i).length===Object.keys(o).length}static _fscsDefs(e){const t=e?"btn":"sel";return[{key:"fscs:container",label:"Field Container",hint:"Border, radius, font sizes",icon:"mdi:card-outline",paths:A("control_style",p._containerPathsForField(t))},{key:"fscs:active",label:"Active State",hint:"Colors when the option is active",icon:"mdi:circle-slice-8",paths:A("control_style",le["sub:active"][t])},{key:"fscs:inactive",label:"Inactive State",hint:"Colors when the option is inactive",icon:"mdi:circle-outline",paths:A("control_style",le["sub:inactive"][t])}]}_fieldSecControlStyle(e,t,i,o=!1){const s=this._updFor(e,t,o),a=this._idFor(e,t,o),n=i.control_style,l=u=>s({control_style:{...i.control_style,...u}}),c=p._separationOnly(n),d=this._controlStyleUsesGlobal(i,a),h=i.type==="button_group"||i.type==="button";return r`
      <div class="ec-section">
        ...
        ${i.control_box!==void 0?this._boxRows(`${a}-ctlbox`,i.control_box,u=>s({control_box:{...i.control_box,...u}}),Ct):_}
...
This overwrites those values on the popover defaults, and is a one-off — the two do not stay linked.`))return;const s={};for(const a of t)s[a]=e[a];this._updateExtDefaults({card:{...this._config?.extended_card_defaults?.card,...s}}),this._showUndoToast(`${o} value${o===1?"":"s"} copied from Mosaic Card Defaults`)}}>⧉ Copy styling from Mosaic Card Defaults</button>
    ...
    `:r`<p class="ec-hint">Nothing to copy — <b>Mosaic Card Defaults</b> has no box styling set.</p>`}_popoverDimmingRows(){const e=this._config?.defaults??{},t=mt(e,Je);return r`
      ...
      ${this._row("Dimming",r`
        <select class="ec-select"
          @change=${i=>this._setPopupDimming(i.target.value,Je)}
        >
          ${t===void 0?r`<option value="" selected>Custom</option>`:_}
    ...
    `}_extFieldHeader(e,t,i){const o=s=>this._updateExtField(e,t,s);return r`
        ...
        ${this._row("Type",r`<select class="ec-select"
            .value=${i.type==="graph"?"svg":i.type}
            @change=${s=>{const a=s.target.value;if(J(a)){const n=gt(a);if(n&&!this._confirmVariantOptionLoss(i,a,n)){s.target.value=i.type==="graph"?"svg":i.type;return}o(this._typeChangePatch(i,a,n?Se(a,n):{}))}else{if(!this._confirmTypeOptionLoss(i,a)){s.target.value=i.type==="graph"?"svg":i.type;return}o(this._typeChangePatch(i,a)),a==="svg"&&this._openGGPicker(e,t,!0)}}}
          >
            ${St.map(s=>r`<option value=${s} .selected=${(i.type==="graph"?"svg":i.type)===s}>${ge[s]}</option>`)}
          </select>`)}
    ...
    `}_renderTemplatesRibbonPanel(){const e=this._navPath;return e.length===0?this._navMenu(p._TEMPLATE_SECTIONS):e[0].key==="sec:import"?this._templatesSecImport():e[0].key==="sec:varexport"?this._templatesSecVariantExport():e[0].key==="sec:varimport"?this._templatesSecVariantImport():e[0].key==="sec:export"?this._templatesSecExport():(console.warn(`[mosaic-canvas-card] Templates panel: unknown section key "${e[0].key}"`),this._navDeadEnd("This editor screen is unavailable — press Back to recover."))}_templatesSecVariantExport(){const e=this._config?.defaults?.control_variants??{},t=Object.values(e).reduce((i,o)=>i+(o?.length??0),0);return r`
      <div class="ec-section">
        ...
        ${t===0?r`<p class="ec-empty">No custom variants to export.</p>`:r`
            ...
            <button class="ec-btn-add" style="width:100%;"
              @click=${()=>Ai(Mi(e,this._templateName||"Mosaic Control Variants"))}
    ...
    `}_templatesSecVariantImport(){return this._config?r`
      <div class="ec-section">
        ...
        <input type="file" accept=".json,application/json" style="display:none" id="ec-variant-import"
          @change=${e=>{const t=e.target.files?.[0];if(e.target.value="",!t||!this._config)return;const i=new FileReader;i.onload=o=>{const{pack:s,error:a}=Fi(o.target?.result);if(a||!s){this._variantImportError=a??"Unknown error.";return}const n=this._config?.defaults?.control_variants??{},{merged:l,added:c,renamed:d}=Ni(n,s);if(c===0){this._variantImportError="That file contained no control variants.";return}const h=d>0?`Import ${c} variant(s) from "${s.name}"?
    ...
    `:r``}_templatesSecExport(){return this._config?r`
      <div class="ec-section">
          ...
          <button class="ec-btn-add" style="width:100%;margin-bottom:12px;"
            @click=${()=>{if(!this._config)return;const e=zi(this._config,this._templateName||"Mosaic Canvas Template",{includeEntities:this._templateIncludeEntities});Ri(e)}}
    ...
    `:r``}_templatesSecImport(){return this._config?r`
      <div class="ec-section">
          ...
          <input type="file" accept=".json,application/json"
            ...
            @change=${e=>{const t=e.target.files?.[0];if(!t||!this._config)return;const i=new FileReader;i.onload=o=>{const s=o.target?.result,{template:a,error:n}=Pi(s);if(n||!a){this._templateError=n??"Unknown error.";return}window.confirm(`Import "${a.name}"?

This will replace your entire card configuration.`)&&(this._templateError="",this._emit(Ii(a,this._config.type)))},i.readAsText(t),e.target.value=""}}
          />
          <button class="ec-btn-add" style="width:100%;"
    ...
    `}_zoneScope(e){return{root:this._zones()[e],apply:t=>this._updateZone(e,t)}}_renderZonesRibbonPanel(){const e=this._navPath,t=this._zones();if(e.length===0)return r`
        ...
        ${t.length===0?this._emptyAdd("No clickable zones yet — add one",()=>this._addZone()):t.map((a,n)=>this._itemCard({dragKey:`zone:${n}`,icon:"mdi:gesture-tap-box",label:a.name??a.id,sub:`${a.width}×${a.height}px`,selected:n===this._selZone,onClick:()=>{this._selZone=n,this._navPush(`zone:${a.id}`,a.name??a.id)},actions:r`
                ...
                <button class="ec-btn-remove"
                  ...
                  title="Remove">✕</button>
              `}))}
      `;const i=this._crumbIndex(e[0].key,t);this._selZone=i;const o=t[i];if(!o)return this._navDeadEnd();if(e.length===1)return this._navMenu(p._ZONE_SECTIONS,this._zoneScope(i));const s=this._clearOverridesBtn(p._findDef(p._ZONE_SECTIONS,e[1].key),this._zoneScope(i));return e[1].key==="sec:actions"?r`${s}${this._zoneSecActions(i,o)}`:r`${s}${this._zoneSecDefaults(i,o)}`}_zoneSecDefaults(e,t){const{totalW:i,totalH:o}=te(this._config);return r`
      <div class="ec-section">
              ${this._row("Name",r`<input class="ec-input" type="text" .value=${t.name??""}
    ...
    `}_embSecPos(e,t){const{totalW:i,totalH:o}=te(this._config);return r`
      <div class="ec-section">
        ${this._row("X (px)",r`${this._numWrap(r`<input class="ec-input ec-input-num" type="number"
            .value=${String(Math.round(t.position.x*i))}
    ...
    `}_colorPicker(e,t,i,o){const s=t??"",a=this._cpOpenId===e,{base:n,alpha:l}=ao(s),c=/^#[0-9a-fA-F]{6}$/.test(n)?n:n?no(n,this):"#000000",d=s||"transparent",h=o?.clearable!==!1&&t!=null,u=["#ff0000","#ff4500","#ff8800","#ffff00","#00ff00","#00ff7f","#00ffff","#0000ff","#9400d3","#ff00ff","#ffffff","#00d4ff","#22c55e","#888888","#333333","#000000"],g=parseInt(c.slice(1,3),16),v=parseInt(c.slice(3,5),16),m=parseInt(c.slice(5,7),16),z=(k,C,F)=>`#${[k,C,F].map(Y=>Math.max(0,Math.min(255,Y)).toString(16).padStart(2,"0")).join("")}`,R=n!==""&&!/^#[0-9a-fA-F]{6}$/.test(n)&&!/^rgb/i.test(n),$=(k,C)=>{if(C>=1){i(k);return}const F=parseInt(k.slice(1,3),16),Y=parseInt(k.slice(3,5),16),Z=parseInt(k.slice(5,7),16);i(`rgba(${F},${Y},${Z},${Number(C.toFixed(3))})`)},x=k=>{R?i(Rt(n,k)):$(c,k)};return r`
      <div class="ec-cp-wrap" @keydown=${k=>{k.key!=="Escape"||this._cpOpenId!==e||(k.preventDefault(),k.stopPropagation(),this._cpOrigValue!==t&&i(this._cpOrigValue),this._cpOpenId=null)}}
        @click=${k=>{this._cpOpenId===e&&k.preventDefault()}}>
        <div class="ec-color-row">
          <button class="ec-color-swatch-btn" title="Open color picker"
            style="--mce-swatch:${d}"
            @click=${k=>{if(k.stopPropagation(),!a){const C=k.currentTarget.getBoundingClientRect(),F=document.createElement("div");F.style.cssText="position:fixed;inset:0;pointer-events:none;visibility:hidden;",k.currentTarget.parentElement.appendChild(F);const Y=F.getBoundingClientRect();F.remove();const Z=Math.max(12,Math.min(C.left,window.innerWidth-254))-Y.left;this._cpPos=window.innerHeight-C.bottom<340?{left:Z,bottom:Y.bottom-C.top+4}:{left:Z,top:C.bottom+4-Y.top},this._cpOrigValue=t}this._cpOpenId=a?null:e}}
          ></button>
          <input type="text" class="ec-color-text"
            .value=${s}
            placeholder="#rrggbb · rgb() · name"
            @change=${k=>{const C=k.target.value.trim();i(C||void 0)}}
          />
          ...
          ${o?.gradient?r`<label class="ec-cp-grad-toggle"
            ...
            <input type="checkbox" .checked=${o.gradient.on}
              @change=${k=>o.gradient.onToggle(k.target.checked)} />
            Gradient
          </label>`:_}
        </div>
        ${a?r`
          ...
          <div class="ec-cp-popup"
            ...
            @click=${k=>{k.preventDefault(),k.stopPropagation()}}>
            ...
            <hex-color-picker
              .color=${c}
              @color-changed=${k=>$(k.detail.value,l)}
              @dblclick=${()=>{this._cpOpenId=null}}
            ></hex-color-picker>
            <div class="ec-cp-rgb">
              ${["R","G","B"].map((k,C)=>{const F=[g,v,m][C];return r`<label class="ec-cp-rgb-label">${k}
                  <input type="number" class="ec-cp-rgb-input" min="0" max="255"
                    .value=${String(F)}
                    @change=${Y=>{const Z=Number(Y.target.value);$(z(C===0?Z:g,C===1?Z:v,C===2?Z:m),l)}}
                  />
                </label>`})}
            </div>
            <div class="ec-cp-presets">
              ${u.map(k=>r`
                <button class="ec-cp-preset" style="background:${k}" title="${k}"
            ...
            <div class="ec-cp-alpha">
              ...
              <div class="ec-opacity-row">
                <input type="range" min="0" max="1" step="0.01"
                  .value=${String(l)}
                  @input=${k=>x(parseFloat(k.target.value))}
                />
    ...
    `}_renderCpVars(e,t=1){const i=this._config?.defaults?.custom_colors??[],o=s=>{e(Rt(s,t)),this._cpOpenId=null};return r`
...
--md-*/--mdc-* it maps to
    ...
    `];y([ri({attribute:!1})],p.prototype,"hass",2);y([w()],p.prototype,"_config",2);y([w()],p.prototype,"_selCard",2);y([w()],p.prototype,"_selField",2);y([w()],p.prototype,"_selCards",2);y([w()],p.prototype,"_selEmbCards",2);y([w()],p.prototype,"_groupColGap",2);y([w()],p.prototype,"_groupRowGap",2);y([w()],p.prototype,"_selFlow",2);y([w()],p.prototype,"_showAddFlowInput",2);y([w()],p.prototype,"_newFlowName",2);y([w()],p.prototype,"_pendingFlowIdx",2);y([w()],p.prototype,"_showFlowCompleteModal",2);y([w()],p.prototype,"_selPoint",2);y([w()],p.prototype,"_selSeries",2);y([w()],p.prototype,"_selOption",2);y([w()],p.prototype,"_selBgRule",2);y([w()],p.prototype,"_selCanvasBgRule",2);y([w()],p.prototype,"_pickerTarget",2);y([w()],p.prototype,"_pickerLib",2);y([w()],p.prototype,"_pickerFolder",2);y([w()],p.prototype,"_pickerTrail",2);y([w()],p.prototype,"_pickerErr",2);y([w()],p.prototype,"_selExtOption",2);y([w()],p.prototype,"_selExtSeries",2);y([w()],p.prototype,"_selVirtual",2);y([w()],p.prototype,"_selVirtualInput",2);y([w()],p.prototype,"_selTrigger",2);y([w()],p.prototype,"_selZone",2);y([w()],p.prototype,"_selExtCard",2);y([w()],p.prototype,"_selExtField",2);y([w()],p.prototype,"_templateName",2);y([w()],p.prototype,"_templateIncludeEntities",2);y([w()],p.prototype,"_templateError",2);y([w()],p.prototype,"_previewBoxes",2);y([w()],p.prototype,"_previewExpanded",2);y([w()],p.prototype,"_barAtTop",2);y([w()],p.prototype,"_copiedFields",2);y([w()],p.prototype,"_copySourceId",2);y([w()],p.prototype,"_virtualClipboard",2);y([w()],p.prototype,"_copiedField",2);y([w()],p.prototype,"_copiedFieldSrc",2);y([w()],p.prototype,"_copiedOption",2);y([w()],p.prototype,"_dragSrc",2);y([w()],p.prototype,"_cpOpenId",2);y([w()],p.prototype,"_cpPos",2);y([w()],p.prototype,"_ggOpen",2);y([w()],p.prototype,"_wizStep",2);y([w()],p.prototype,"_wiz",2);y([w()],p.prototype,"_bgSelected",2);y([w()],p.prototype,"_selEmbCard",2);y([w()],p.prototype,"_embEditorOpen",2);y([w()],p.prototype,"_embEditorYaml",2);y([w()],p.prototype,"_embEditorYamlError",2);y([w()],p.prototype,"_embNativeEditor",2);y([w()],p.prototype,"_embPickerOpen",2);y([w()],p.prototype,"_embPickerSearch",2);y([w()],p.prototype,"_variantOpen",2);y([w()],p.prototype,"_variantError",2);y([w()],p.prototype,"_saveVariantFor",2);y([w()],p.prototype,"_saveVariantLabel",2);y([w()],p.prototype,"_variantImportError",2);y([w()],p.prototype,"_navTab",2);y([w()],p.prototype,"_navPanel",2);y([w()],p.prototype,"_navPath",2);y([w()],p.prototype,"_listFilter",2);y([w()],p.prototype,"_toastMsg",2);y([w()],p.prototype,"_tutorialStep",2);y([w()],p.prototype,"_dropKey",2);y([w()],p.prototype,"_dropBefore",2);y([w()],p.prototype,"_searchQuery",2);y([w()],p.prototype,"_searchActive",2);y([w()],p.prototype,"_healthShowIgnored",2);y([w()],p.prototype,"_cpMode",2);p=y([li(ci)],p);export{p as MosaicCanvasEditor};
